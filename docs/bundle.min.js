...
a;n=new b(h,g);c.getMap({mapPath:"assets/map.jpg",mapMinPath:"assets/map-min.jpg",markersBase:"assets/map/",attributions:'<a href="http://mrane.com/" target="_blank">Prof. Mandar Rane</a>',map_id:"map",marker_id:"marker",user_marker_id:"user-marker"},h,function(a){d(a)},function(){document.querySelector(".loading-fader").style.display="none";document.querySelectorAll(".hide-till-load").forEach(function(a){a.classList.remove("hide-till-load")});document.body.style.background="#666"})});e=document.querySelector("#infobox, #infobox *");
var f=document.querySelector("#infobox");e=new a.Manager(e);a=new a.Swipe;e.add(a);e.on("swipe",function(a){a=a.offsetDirection;8===a?f.classList.add("expanded"):16==a&&f.classList.remove("expanded")});document.getElementById("locfab").addEventListener("click",function(){c.getGPS()})},{"autocomplete.js":2,"fuse.js":20,hammerjs:21,instimapweb:28}],2:[function(a,e,k){e.exports=a("./src/standalone/")},{"./src/standalone/":17}],3:[function(a,e,k){a=a("../common/utils.js");k={wrapper:{position:"relative",
display:"inline-block"},hint:{position:"absolute",top:"0",left:"0",borderColor:"transparent",boxShadow:"none",opacity:"1"},input:{position:"relative",verticalAlign:"top",backgroundColor:"transparent"},inputWithNoHint:{position:"relative",verticalAlign:"top"},dropdown:{position:"absolute",top:"100%",left:"0",zIndex:"100",display:"none"},suggestions:{display:"block"},suggestion:{whiteSpace:"nowrap",cursor:"pointer"},suggestionChild:{whiteSpace:"normal"},ltr:{left:"0",right:"auto"},rtl:{left:"auto",
right:"0"},defaultClasses:{root:"algolia-autocomplete",prefix:"aa",noPrefix:!1,dropdownMenu:"dropdown-menu",input:"input",hint:"hint",suggestions:"suggestions",suggestion:"suggestion",cursor:"cursor",dataset:"dataset",empty:"empty"},appendTo:{wrapper:{position:"absolute",zIndex:"100",display:"none"},input:{},inputWithNoHint:{},dropdown:{display:"block"}}};a.isMsie()&&a.mixin(k.input,{backgroundImage:"url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)"});a.isMsie()&&
7>=a.isMsie()&&a.mixin(k.input,{marginTop:"-1px"});e.exports=k},{"../common/utils.js":13}],4:[function(a,e,k){function d(a){a=a||{};a.templates=a.templates||{};a.source||h.error("missing source");a.name&&!/^[_a-zA-Z0-9-]+$/.test(a.name)&&h.error("invalid dataset name: "+a.name);this.query=null;this._isEmpty=!0;this.highlight=!!a.highlight;this.name="undefined"===typeof a.name||null===a.name?h.getUniqueId():a.name;this.source=a.source;this.displayFn=c(a.display||a.displayKey);this.debounce=a.debounce;
this.cache=!1!==a.cache;this.templates=b(a.templates,this.displayFn);this.css=h.mixin({},f,a.appendTo?f.appendTo:{});this.cssClasses=a.cssClasses=h.mixin({},f.defaultClasses,a.cssClasses||{});this.cssClasses.prefix=a.cssClasses.formattedPrefix||h.formatPrefix(this.cssClasses.prefix,this.cssClasses.noPrefix);var l=h.className(this.cssClasses.prefix,this.cssClasses.dataset);this.$el=a.$menu&&0<a.$menu.find(l+"-"+this.name).length?n.element(a.$menu.find(l+"-"+this.name)[0]):n.element(g.dataset.replace("%CLASS%",
this.name).replace("%PREFIX%",this.cssClasses.prefix).replace("%DATASET%",this.cssClasses.dataset));this.$menu=a.$menu;this.clearCachedSuggestions()}function c(a){function f(f){return f[a]}a=a||"value";return h.isFunction(a)?a:f}function b(a,f){function b(a){return"<p>"+f(a)+"</p>"}return{empty:a.empty&&h.templatify(a.empty),header:a.header&&h.templatify(a.header),footer:a.footer&&h.templatify(a.footer),suggestion:a.suggestion||b}}var h=a("../common/utils.js"),n=a("../common/dom.js"),g=a("./html.js"),
f=a("./css.js");a=a("./event_emitter.js");d.extractDatasetName=function(a){return n.element(a).data("aaDataset")};d.extractValue=function(a){return n.element(a).data("aaValue")};d.extractDatum=function(a){a=n.element(a).data("aaDatum");"string"===typeof a&&(a=JSON.parse(a));return a};h.mixin(d.prototype,a,{_render:function(a,f){function b(){var f=[].slice.call(arguments,0);f=[{query:a,isEmpty:!0}].concat(f);return d.templates.empty.apply(this,f)}function p(){var a=[].slice.call(arguments,0),b=this;
var p=g.suggestions.replace("%PREFIX%",this.cssClasses.prefix).replace("%SUGGESTIONS%",this.cssClasses.suggestions);p=n.element(p).css(this.css.suggestions);var l=h.map(f,function(f){var p=g.suggestion.replace("%PREFIX%",b.cssClasses.prefix).replace("%SUGGESTION%",b.cssClasses.suggestion);p=n.element(p).attr({role:"option",id:["option",Math.floor(1E8*Math.random())].join("-")}).append(d.templates.suggestion.apply(this,[f].concat(a)));p.data("aaDataset",d.name);p.data("aaValue",d.displayFn(f)||void 0);
p.data("aaDatum",JSON.stringify(f));p.children().each(function(){n.element(this).css(b.css.suggestionChild)});return p});p.append.apply(p,l);return p}function l(){var f=[].slice.call(arguments,0);f=[{query:a,isEmpty:!q}].concat(f);return d.templates.header.apply(this,f)}function c(){var f=[].slice.call(arguments,0);f=[{query:a,isEmpty:!q}].concat(f);return d.templates.footer.apply(this,f)}if(this.$el){var d=this,e=[].slice.call(arguments,2);this.$el.empty();var q=f&&f.length;this._isEmpty=!q;if(!q&&
this.templates.empty)this.$el.html(b.apply(this,e)).prepend(d.templates.header?l.apply(this,e):null).append(d.templates.footer?c.apply(this,e):null);else if(q)this.$el.html(p.apply(this,e)).prepend(d.templates.header?l.apply(this,e):null).append(d.templates.footer?c.apply(this,e):null);else if(f&&!Array.isArray(f))throw new TypeError("suggestions must be an array");this.$menu&&this.$menu.addClass(this.cssClasses.prefix+(q?"with":"without")+"-"+this.name).removeClass(this.cssClasses.prefix+(q?"without":
"with")+"-"+this.name);this.trigger("rendered",a)}},getRoot:function(){return this.$el},update:function(a){function f(f){if(!this.canceled&&a===this.query){var b=[].slice.call(arguments,1);this.cacheSuggestions(a,f,b);this._render.apply(this,[a,f].concat(b))}}this.query=a;this.canceled=!1;if(this.shouldFetchFromCache(a))f.apply(this,[this.cachedSuggestions].concat(this.cachedRenderExtraArgs));else{var b=this,g=function(){b.canceled||b.source(a,f.bind(b))};this.debounce?(clearTimeout(this.debounceTimeout),
this.debounceTimeout=setTimeout(function(){b.debounceTimeout=null;g()},this.debounce)):g()}},cacheSuggestions:function(a,f,b){this.cachedQuery=a;this.cachedSuggestions=f;this.cachedRenderExtraArgs=b},shouldFetchFromCache:function(a){return this.cache&&this.cachedQuery===a&&this.cachedSuggestions&&this.cachedSuggestions.length},clearCachedSuggestions:function(){delete this.cachedQuery;delete this.cachedSuggestions;delete this.cachedRenderExtraArgs},cancel:function(){this.canceled=!0},clear:function(){this.cancel();
this.$el.empty();this.trigger("rendered","")},isEmpty:function(){return this._isEmpty},destroy:function(){this.clearCachedSuggestions();this.$el=null}});e.exports=d},{"../common/dom.js":11,"../common/utils.js":13,"./css.js":3,"./event_emitter.js":7,"./html.js":8}],5:[function(a,e,k){function d(a){var f=this;a=a||{};a.menu||c.error("menu is required");c.isArray(a.datasets)||c.isObject(a.datasets)||c.error("1 or more datasets required");a.datasets||c.error("datasets is required");this.isOpen=!1;this.isEmpty=
!0;this.minLength=a.minLength||0;this.templates={};this.appendTo=a.appendTo||!1;this.css=c.mixin({},n,a.appendTo?n.appendTo:{});this.cssClasses=a.cssClasses=c.mixin({},n.defaultClasses,a.cssClasses||{});this.cssClasses.prefix=a.cssClasses.formattedPrefix||c.formatPrefix(this.cssClasses.prefix,this.cssClasses.noPrefix);var g=c.bind(this._onSuggestionClick,this);var h=c.bind(this._onSuggestionMouseEnter,this);var m=c.bind(this._onSuggestionMouseLeave,this);var p=c.className(this.cssClasses.prefix,this.cssClasses.suggestion);
this.$menu=b.element(a.menu).on("mouseenter.aa",p,h).on("mouseleave.aa",p,m).on("click.aa",p,g);this.$container=a.appendTo?a.wrapper:this.$menu;a.templates&&a.templates.header&&(this.templates.header=c.templatify(a.templates.header),this.$menu.prepend(this.templates.header()));a.templates&&a.templates.empty&&(this.templates.empty=c.templatify(a.templates.empty),this.$empty=b.element('<div class="'+c.className(this.cssClasses.prefix,this.cssClasses.empty,!0)+'"></div>'),this.$menu.append(this.$empty),
this.$empty.hide());this.datasets=c.map(a.datasets,function(b){return new d.Dataset(c.mixin({$menu:f.$menu,cssClasses:a.cssClasses},b))});c.each(this.datasets,function(a){var b=a.getRoot();b&&0===b.parent().length&&f.$menu.append(b);a.onSync("rendered",f._onRendered,f)});a.templates&&a.templates.footer&&(this.templates.footer=c.templatify(a.templates.footer),this.$menu.append(this.templates.footer()));var e=this;b.element(window).resize(function(){e._redraw()})}var c=a("../common/utils.js"),b=a("../common/dom.js");
k=a("./event_emitter.js");var h=a("./dataset.js"),n=a("./css.js");c.mixin(d.prototype,k,{_onSuggestionClick:function(a){this.trigger("suggestionClicked",b.element(a.currentTarget))},_onSuggestionMouseEnter:function(a){var f=b.element(a.currentTarget);if(!f.hasClass(c.className(this.cssClasses.prefix,this.cssClasses.cursor,!0))){this._removeCursor();var g=this;setTimeout(function(){g._setCursor(f,!1)},0)}},_onSuggestionMouseLeave:function(a){a.relatedTarget&&0<b.element(a.relatedTarget).closest("."+
c.className(this.cssClasses.prefix,this.cssClasses.cursor,!0)).length||(this._removeCursor(),this.trigger("cursorRemoved"))},_onRendered:function(a,f){function b(a){return a.templates&&a.templates.empty}(this.isEmpty=c.every(this.datasets,function(a){return a.isEmpty()}))?(f.length>=this.minLength&&this.trigger("empty"),this.$empty?f.length<this.minLength?this._hide():(a=this.templates.empty({query:this.datasets[0]&&this.datasets[0].query}),this.$empty.html(a),this.$empty.show(),this._show()):c.any(this.datasets,
b)?f.length<this.minLength?this._hide():this._show():this._hide()):this.isOpen&&(this.$empty&&(this.$empty.empty(),this.$empty.hide()),f.length>=this.minLength?this._show():this._hide());this.trigger("datasetRendered")},_hide:function(){this.$container.hide()},_show:function(){this.$container.css("display","block");this._redraw();this.trigger("shown")},_redraw:function(){this.isOpen&&this.appendTo&&this.trigger("redrawn")},_getSuggestions:function(){return this.$menu.find(c.className(this.cssClasses.prefix,
this.cssClasses.suggestion))},_getCursor:function(){return this.$menu.find(c.className(this.cssClasses.prefix,this.cssClasses.cursor)).first()},_setCursor:function(a,f){a.first().addClass(c.className(this.cssClasses.prefix,this.cssClasses.cursor,!0)).attr("aria-selected","true");this.trigger("cursorMoved",f)},_removeCursor:function(){this._getCursor().removeClass(c.className(this.cssClasses.prefix,this.cssClasses.cursor,!0)).removeAttr("aria-selected")},_moveCursor:function(a){if(this.isOpen){var f=
this._getCursor();var b=this._getSuggestions();this._removeCursor();a=b.index(f)+a;a=(a+1)%(b.length+1)-1;-1===a?this.trigger("cursorRemoved"):(-1>a&&(a=b.length-1),this._setCursor(b=b.eq(a),!0),this._ensureVisible(b))}},_ensureVisible:function(a){var f=a.position().top;a=f+a.height()+parseInt(a.css("margin-top"),10)+parseInt(a.css("margin-bottom"),10);var b=this.$menu.scrollTop();var g=this.$menu.height()+parseInt(this.$menu.css("padding-top"),10)+parseInt(this.$menu.css("padding-bottom"),10);0>
f?this.$menu.scrollTop(b+f):g<a&&this.$menu.scrollTop(b+(a-g))},close:function(){this.isOpen&&(this.isOpen=!1,this._removeCursor(),this._hide(),this.trigger("closed"))},open:function(){this.isOpen||(this.isOpen=!0,this.isEmpty||this._show(),this.trigger("opened"))},setLanguageDirection:function(a){this.$menu.css("ltr"===a?this.css.ltr:this.css.rtl)},moveCursorUp:function(){this._moveCursor(-1)},moveCursorDown:function(){this._moveCursor(1)},getDatumForSuggestion:function(a){var f=null;a.length&&(f=
{raw:h.extractDatum(a),value:h.extractValue(a),datasetName:h.extractDatasetName(a)});return f},getCurrentCursor:function(){return this._getCursor().first()},getDatumForCursor:function(){return this.getDatumForSuggestion(this._getCursor().first())},getDatumForTopSuggestion:function(){return this.getDatumForSuggestion(this._getSuggestions().first())},cursorTopSuggestion:function(){this._setCursor(this._getSuggestions().first(),!1)},update:function(a){c.each(this.datasets,function(f){f.update(a)})},
empty:function(){c.each(this.datasets,function(a){a.clear()});this.isEmpty=!0},isVisible:function(){return this.isOpen&&!this.isEmpty},destroy:function(){this.$menu.off(".aa");this.$menu=null;c.each(this.datasets,function(a){a.destroy()})}});d.Dataset=h;e.exports=d},{"../common/dom.js":11,"../common/utils.js":13,"./css.js":3,"./dataset.js":4,"./event_emitter.js":7}],6:[function(a,e,k){function d(a){a&&a.el||c.error("EventBus initialized without el");this.$el=b.element(a.el)}var c=a("../common/utils.js"),
b=a("../common/dom.js");c.mixin(d.prototype,{trigger:function(a,b,g,f){a=c.Event("autocomplete:"+a);this.$el.trigger(a,[b,g,f]);return a}});e.exports=d},{"../common/dom.js":11,"../common/utils.js":13}],7:[function(a,e,k){function d(a,f,c,d){if(!c)return this;f=f.split(n);c=d?b(c,d):c;for(this._callbacks=this._callbacks||{};d=f.shift();)this._callbacks[d]=this._callbacks[d]||{sync:[],async:[]},this._callbacks[d][a].push(c);return this}function c(a,f,b){return function(){for(var g,c=0,p=a.length;!g&&
c<p;c+=1)g=!1===a[c].apply(f,b);return!g}}function b(a,f){return a.bind?a.bind(f):function(){a.apply(f,[].slice.call(arguments,0))}}var h=a("immediate"),n=/\s+/;e.exports={onSync:function(a,f,b){return d.call(this,"sync",a,f,b)},onAsync:function(a,f,b){return d.call(this,"async",a,f,b)},off:function(a){var f;if(!this._callbacks)return this;for(a=a.split(n);f=a.shift();)delete this._callbacks[f];return this},trigger:function(a){var f,b,g;if(!this._callbacks)return this;a=a.split(n);for(g=[].slice.call(arguments,
1);(f=a.shift())&&(b=this._callbacks[f]);){var d=c(b.sync,this,[f].concat(g));var p=c(b.async,this,[f].concat(g));d()&&h(p)}return this}}},{immediate:22}],8:[function(a,e,k){e.exports={wrapper:'<span class="%ROOT%"></span>',dropdown:'<span class="%PREFIX%%DROPDOWN_MENU%"></span>',dataset:'<div class="%PREFIX%%DATASET%-%CLASS%"></div>',suggestions:'<span class="%PREFIX%%SUGGESTIONS%"></span>',suggestion:'<div class="%PREFIX%%SUGGESTION%"></div>'}},{}],9:[function(a,e,k){function d(a){var b=this;a=
a||{};a.input||n.error("input is missing");var f=n.bind(this._onBlur,this);var d=n.bind(this._onFocus,this);var p=n.bind(this._onKeydown,this);var e=n.bind(this._onInput,this);this.$hint=g.element(a.hint);this.$input=g.element(a.input).on("blur.aa",f).on("focus.aa",d).on("keydown.aa",p);0===this.$hint.length&&(this.setHint=this.getHint=this.clearHint=this.clearHintIfInvalid=n.noop);if(n.isMsie())this.$input.on("keydown.aa keypress.aa cut.aa paste.aa",function(a){h[a.which||a.keyCode]||n.defer(n.bind(b._onInput,
b,a))});else this.$input.on("input.aa",e);this.query=this.$input.val();this.$overflowHelper=c(this.$input)}function c(a){return g.element('<pre aria-hidden="true"></pre>').css({position:"absolute",visibility:"hidden",whiteSpace:"pre",fontFamily:a.css("font-family"),fontSize:a.css("font-size"),fontStyle:a.css("font-style"),fontVariant:a.css("font-variant"),fontWeight:a.css("font-weight"),wordSpacing:a.css("word-spacing"),letterSpacing:a.css("letter-spacing"),textIndent:a.css("text-indent"),textRendering:a.css("text-rendering"),
...
_onKeydown:function(a){var b=h[a.which||a.keyCode];this._managePreventDefault(b,a);b&&this._shouldTrigger(b,a)&&this.trigger(b+"Keyed",a)},_onInput:function(){this._checkInputValue()},_managePreventDefault:function(a,c){switch(a){case "tab":a=this.getHint();var f=this.getInputValue();a=a&&a!==f&&!b(c);break;case "up":case "down":a=!b(c);break;default:a=!1}a&&c.preventDefault()},_shouldTrigger:function(a,c){switch(a){case "tab":a=!b(c);break;default:a=!0}return a},_checkInputValue:function(){var a=
this.getInputValue();var b=this.query;var c=(b=d.normalizeQuery(a)===d.normalizeQuery(b))&&this.query?this.query.length!==a.length:!1;this.query=a;b?c&&this.trigger("whitespaceChanged",this.query):this.trigger("queryChanged",this.query)},focus:function(){this.$input.focus()},blur:function(){this.$input.blur()},getQuery:function(){return this.query},setQuery:function(a){this.query=a},getInputValue:function(){return this.$input.val()},setInputValue:function(a,b){"undefined"===typeof a&&(a=this.query);
this.$input.val(a);b?this.clearHint():this._checkInputValue()},expand:function(){this.$input.attr("aria-expanded","true")},collapse:function(){this.$input.attr("aria-expanded","false")},setActiveDescendant:function(a){this.$input.attr("aria-activedescendant",a)},removeActiveDescendant:function(){this.$input.removeAttr("aria-activedescendant")},resetInputValue:function(){this.setInputValue(this.query,!0)},getHint:function(){return this.$hint.val()},setHint:function(a){this.$hint.val(a)},clearHint:function(){this.setHint("")},
clearHintIfInvalid:function(){var a=this.getInputValue();var b=this.getHint();b=a!==b&&0===b.indexOf(a);""!==a&&b&&!this.hasOverflow()||this.clearHint()},getLanguageDirection:function(){return(this.$input.css("direction")||"ltr").toLowerCase()},hasOverflow:function(){var a=this.$input.width()-2;this.$overflowHelper.text(this.getInputValue());return this.$overflowHelper.width()>=a},isCursorAtEnd:function(){var a=this.$input.val().length;var b=this.$input[0].selectionStart;return n.isNumber(b)?b===
a:document.selection?(b=document.selection.createRange(),b.moveStart("character",-a),a===b.text.length):!0},destroy:function(){this.$hint.off(".aa");this.$input.off(".aa");this.$hint=this.$input=this.$overflowHelper=null}});e.exports=d},{"../common/dom.js":11,"../common/utils.js":13,"./event_emitter.js":7}],10:[function(a,e,k){function d(a){a=a||{};a.input||n.error("missing input");this.isActivated=!1;this.debug=!!a.debug;this.autoselect=!!a.autoselect;this.autoselectOnBlur=!!a.autoselectOnBlur;this.openOnFocus=
!!a.openOnFocus;this.minLength=n.isNumber(a.minLength)?a.minLength:1;this.autoWidth=void 0===a.autoWidth?!0:!!a.autoWidth;this.clearOnSelected=!!a.clearOnSelected;this.tabAutocomplete=void 0===a.tabAutocomplete?!0:!!a.tabAutocomplete;a.hint=!!a.hint;if(a.hint&&a.appendTo)throw Error("[autocomplete.js] hint and appendTo options can't be used at the same time");this.css=a.css=n.mixin({},m,a.appendTo?m.appendTo:{});this.cssClasses=a.cssClasses=n.mixin({},m.defaultClasses,a.cssClasses||{});this.cssClasses.prefix=
a.cssClasses.formattedPrefix=n.formatPrefix(this.cssClasses.prefix,this.cssClasses.noPrefix);this.listboxId=a.listboxId=[this.cssClasses.root,"listbox",n.getUniqueId()].join("-");var b=c(a);this.$node=b.wrapper;var p=this.$input=b.input;var h=b.menu;b=b.hint;a.dropdownMenuContainer&&g.element(a.dropdownMenuContainer).css("position","relative").append(h.css("top","0"));p.on("blur.aa",function(a){var b=document.activeElement;n.isMsie()&&(h[0]===b||h[0].contains(b))&&(a.preventDefault(),a.stopImmediatePropagation(),
n.defer(function(){p.focus()}))});h.on("mousedown.aa",function(a){a.preventDefault()});this.eventBus=a.eventBus||new f({el:p});this.dropdown=(new d.Dropdown({appendTo:a.appendTo,wrapper:this.$node,menu:h,datasets:a.datasets,templates:a.templates,cssClasses:a.cssClasses,minLength:this.minLength})).onSync("suggestionClicked",this._onSuggestionClicked,this).onSync("cursorMoved",this._onCursorMoved,this).onSync("cursorRemoved",this._onCursorRemoved,this).onSync("opened",this._onOpened,this).onSync("closed",
this._onClosed,this).onSync("shown",this._onShown,this).onSync("empty",this._onEmpty,this).onSync("redrawn",this._onRedrawn,this).onAsync("datasetRendered",this._onDatasetRendered,this);this.input=(new d.Input({input:p,hint:b})).onSync("focused",this._onFocused,this).onSync("blurred",this._onBlurred,this).onSync("enterKeyed",this._onEnterKeyed,this).onSync("tabKeyed",this._onTabKeyed,this).onSync("escKeyed",this._onEscKeyed,this).onSync("upKeyed",this._onUpKeyed,this).onSync("downKeyed",this._onDownKeyed,
...
a.cssClasses.prefix).replace("%DROPDOWN_MENU%",a.cssClasses.dropdownMenu);p=g.element(p).css(a.css.dropdown).attr({role:"listbox",id:a.listboxId});a.templates&&a.templates.dropdownMenu&&p.html(n.templatify(a.templates.dropdownMenu)());var d=f.clone().css(a.css.hint).css(b(f));d.val("").addClass(n.className(a.cssClasses.prefix,a.cssClasses.hint,!0)).removeAttr("id name placeholder required").prop("readonly",!0).attr({"aria-hidden":"true",autocomplete:"off",spellcheck:"false",tabindex:-1});d.removeData&&
d.removeData();f.data("aaAttrs",{"aria-autocomplete":f.attr("aria-autocomplete"),"aria-expanded":f.attr("aria-expanded"),"aria-owns":f.attr("aria-owns"),autocomplete:f.attr("autocomplete"),dir:f.attr("dir"),role:f.attr("role"),spellcheck:f.attr("spellcheck"),style:f.attr("style"),type:f.attr("type")});f.addClass(n.className(a.cssClasses.prefix,a.cssClasses.input,!0)).attr({autocomplete:"off",spellcheck:!1,role:"combobox","aria-autocomplete":a.datasets&&a.datasets[0]&&a.datasets[0].displayKey?"both":
"list","aria-expanded":"false","aria-label":a.ariaLabel,"aria-owns":a.listboxId}).css(a.hint?a.css.input:a.css.inputWithNoHint);try{f.attr("dir")||f.attr("dir","auto")}catch(w){}c=a.appendTo?c.appendTo(g.element(a.appendTo).eq(0)).eq(0):f.wrap(c).parent();c.prepend(a.hint?d:null).append(p);return{wrapper:c,input:f,hint:d,menu:p}}function b(a){return{backgroundAttachment:a.css("background-attachment"),backgroundClip:a.css("background-clip"),backgroundColor:a.css("background-color"),backgroundImage:a.css("background-image"),
backgroundOrigin:a.css("background-origin"),backgroundPosition:a.css("background-position"),backgroundRepeat:a.css("background-repeat"),backgroundSize:a.css("background-size")}}function h(a,b){var f=a.find(n.className(b.prefix,b.input));n.each(f.data("aaAttrs"),function(a,b){void 0===a?f.removeAttr(b):f.attr(b,a)});f.detach().removeClass(n.className(b.prefix,b.input,!0)).insertAfter(a);f.removeData&&f.removeData("aaAttrs");a.remove()}var n=a("../common/utils.js"),g=a("../common/dom.js"),f=a("./event_bus.js"),
l=a("./input.js");k=a("./dropdown.js");var q=a("./html.js"),m=a("./css.js");n.mixin(d.prototype,{_bindKeyboardShortcuts:function(a){if(a.keyboardShortcuts){var b=this.$input,f=[];n.each(a.keyboardShortcuts,function(a){"string"===typeof a&&(a=a.toUpperCase().charCodeAt(0));f.push(a)});g.element(document).keydown(function(a){var c=a.target||a.srcElement,g=c.tagName;c.isContentEditable||"INPUT"===g||"SELECT"===g||"TEXTAREA"===g||-1===f.indexOf(a.which||a.keyCode)||(b.focus(),a.stopPropagation(),a.preventDefault())})}},
_onSuggestionClicked:function(a,b){var f;a={selectionMethod:"click"};(f=this.dropdown.getDatumForSuggestion(b))&&this._select(f,a)},_onCursorMoved:function(a,b){a=this.dropdown.getDatumForCursor();var f=this.dropdown.getCurrentCursor().attr("id");this.input.setActiveDescendant(f);a&&(b&&this.input.setInputValue(a.value,!0),this.eventBus.trigger("cursorchanged",a.raw,a.datasetName))},_onCursorRemoved:function(){this.input.resetInputValue();this._updateHint();this.eventBus.trigger("cursorremoved")},
_onDatasetRendered:function(){this._updateHint();this.eventBus.trigger("updated")},_onOpened:function(){this._updateHint();this.input.expand();this.eventBus.trigger("opened")},_onEmpty:function(){this.eventBus.trigger("empty")},_onRedrawn:function(){this.$node.css("top","0px");this.$node.css("left","0px");var a=this.$input[0].getBoundingClientRect();this.autoWidth&&this.$node.css("width",a.width+"px");var b=this.$node[0].getBoundingClientRect();this.$node.css("top",a.bottom-b.top+"px");this.$node.css("left",
a.left-b.left+"px");this.eventBus.trigger("redrawn")},_onShown:function(){this.eventBus.trigger("shown");this.autoselect&&this.dropdown.cursorTopSuggestion()},_onClosed:function(){this.input.clearHint();this.input.removeActiveDescendant();this.input.collapse();this.eventBus.trigger("closed")},_onFocused:function(){this.isActivated=!0;if(this.openOnFocus){var a=this.input.getQuery();a.length>=this.minLength?this.dropdown.update(a):this.dropdown.empty();this.dropdown.open()}},_onBlurred:function(){var a=
this.dropdown.getDatumForCursor();var b=this.dropdown.getDatumForTopSuggestion();var f={selectionMethod:"blur"};this.debug||(this.autoselectOnBlur&&a?this._select(a,f):this.autoselectOnBlur&&b?this._select(b,f):(this.isActivated=!1,this.dropdown.empty(),this.dropdown.close()))},_onEnterKeyed:function(a,b){a=this.dropdown.getDatumForCursor();var f=this.dropdown.getDatumForTopSuggestion();var c={selectionMethod:"enterKey"};a?(this._select(a,c),b.preventDefault()):this.autoselect&&f&&(this._select(f,
c),b.preventDefault())},_onTabKeyed:function(a,b){if(this.tabAutocomplete){var f={selectionMethod:"tabKey"};(a=this.dropdown.getDatumForCursor())?(this._select(a,f),b.preventDefault()):this._autocomplete(!0)}else this.dropdown.close()},_onEscKeyed:function(){this.dropdown.close();this.input.resetInputValue()},_onUpKeyed:function(){var a=this.input.getQuery();this.dropdown.isEmpty&&a.length>=this.minLength?this.dropdown.update(a):this.dropdown.moveCursorUp();this.dropdown.open()},_onDownKeyed:function(){var a=
this.input.getQuery();this.dropdown.isEmpty&&a.length>=this.minLength?this.dropdown.update(a):this.dropdown.moveCursorDown();this.dropdown.open()},_onLeftKeyed:function(){"rtl"===this.dir&&this._autocomplete()},_onRightKeyed:function(){"ltr"===this.dir&&this._autocomplete()},_onQueryChanged:function(a,b){this.input.clearHintIfInvalid();b.length>=this.minLength?this.dropdown.update(b):this.dropdown.empty();this.dropdown.open();this._setLanguageDirection()},_onWhitespaceChanged:function(){this._updateHint();
