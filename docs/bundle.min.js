...
(function(){function a(e,k,d){function c(h,g){if(!k[h]){if(!e[h]){var f="function"==typeof require&&require;if(!g&&f)return f(h,!0);if(b)return b(h,!0);g=Error("Cannot find module '"+h+"'");throw g.code="MODULE_NOT_FOUND",g;}g=k[h]={exports:{}};e[h][0].call(g.exports,function(a){return c(e[h][1][a]||a)},g,g.exports,a,e,k,d)}return k[h].exports}for(var b="function"==typeof require&&require,h=0;h<d.length;h++)c(d[h]);return c}return a})()({1:[function(a,e,k){function d(a){void 0==a?(document.getElementById("infobox").style.opacity=
0,document.getElementById("locfab").classList.remove("translate"),setTimeout(function(){document.getElementById("infobox").style.display="none";document.getElementById("locname").innerText="";document.getElementById("locdesc").innerText=""},300)):(document.getElementById("infobox").style.display="block",document.getElementById("locfab").classList.add("translate"),setTimeout(function(){document.getElementById("infobox").style.opacity=1},100),document.getElementById("locname").innerText=a.name,document.getElementById("locdesc").innerText=
a.description)}var c=a("instimapweb");e=a("autocomplete.js");var b=a("fuse.js");a=a("hammerjs");var h=[],n,g={shouldSort:!0,threshold:.3,tokenize:!0,location:0,distance:7,maxPatternLength:10,minMatchCharLength:1,keys:["name","short_name"]};e("#search",{hint:!0},[{source:function(a,f){f(n.search(a).slice(0,10))},displayKey:"short_name",templates:{suggestion:function(a){return a.short_name}}}]).on("autocomplete:selected",function(a,f,b,g){c.moveToLocation(f);d(f)});fetch("https://api.insti.app/api/locations").then(function(a){return a.json()}).then(function(a){h=
a;n=new b(h,g);c.getMap({mapPath:"assets/map.jpg",mapMinPath:"assets/map-min.jpg",markersBase:"assets/map/",attributions:'<a href="http://mrane.com/" target="_blank">Prof. Mandar Rane</a>',map_id:"map",marker_id:"marker",user_marker_id:"user-marker"},h,function(a){d(a)},function(){document.querySelector(".loading-fader").style.display="none";document.querySelectorAll(".hide-till-load").forEach(function(a){a.classList.remove("hide-till-load")});document.body.style.background="#666";var a=decodeURIComponent(window.location.search.replace(new RegExp("^(?:.*[&\\?]"+
encodeURIComponent("location").replace(/[\.\+\*]/g,"\\$&")+"(?:\\=([^&]*))?)?.*$","i"),"$1"));if(null!=a&&void 0!=a)for(var f=0;f<h.length;f++)if(h[f].short_name.toLowerCase().replace(" ","-").replace(/^A-Za-z0-9\\-/,"")==a){c.moveToLocation(h[f]);d(h[f]);break}})});e=document.querySelector("#infobox, #infobox *");var f=document.querySelector("#infobox");e=new a.Manager(e);a=new a.Swipe;e.add(a);e.on("swipe",function(a){a=a.offsetDirection;8===a?f.classList.add("expanded"):16==a&&f.classList.remove("expanded")});
document.getElementById("locfab").addEventListener("click",function(){c.getGPS()})},{"autocomplete.js":2,"fuse.js":20,hammerjs:21,instimapweb:28}],2:[function(a,e,k){e.exports=a("./src/standalone/")},{"./src/standalone/":17}],3:[function(a,e,k){a=a("../common/utils.js");k={wrapper:{position:"relative",display:"inline-block"},hint:{position:"absolute",top:"0",left:"0",borderColor:"transparent",boxShadow:"none",opacity:"1"},input:{position:"relative",verticalAlign:"top",backgroundColor:"transparent"},
...
window:{})},{}],27:[function(a,e,k){k.test=function(){return!0};k.install=function(a){return function(){setTimeout(a,0)}}},{}],28:[function(a,e,k){function d(a){c(a.pixel_x,a.pixel_y,!0)}function c(a,b,f,c){void 0===f&&(f=!0);void 0===c&&(c=M.marker_id);a=[Number(a),3575-Number(b)];c=document.getElementById(c);c=new p.default({position:a,positioning:"bottom-center",element:c,stopEvent:!1,offset:[0,0]});H.addOverlay(c);f&&(J.animate({center:a}),J.animate({zoom:4.5}))}function b(){var a=new t.default({url:M.mapPath,
attributions:Q,projection:G,imageExtent:R}),b=new Image;b.src=M.mapPath;b.onload=function(){T.setSource(a)}}function h(){return navigator.geolocation?!0:!1}function n(a){null!=F&&c(F.pixel_x,F.pixel_y,a,M.user_marker_id)}function g(a){var b=1E3*(a.coords.latitude-19.133691);a=1E3*(a.coords.longitude-72.916984);var f=O,c=Math.round(4189+f[0]+f[1]*b+f[2]*a+f[3]*b*b+f[4]*b*b*a+f[5]*b*b*a*a+f[6]*a*a+f[7]*b*a*a+f[8]*b*a);f=K;return{pixel_x:c,pixel_y:Math.round(1655+f[0]+f[1]*b+f[2]*a+f[3]*b*b+f[4]*b*b*
a+f[5]*b*b*a*a+f[6]*a*a+f[7]*b*a*a+f[8]*b*a)}}e=this&&this.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(k,"__esModule",{value:!0});var f=e(a("ol/map")),l=e(a("ol/layer/image")),q=e(a("ol/view")),m=e(a("ol/extent")),p=e(a("ol/overlay")),r=e(a("ol/layer/vector")),t=e(a("ol/source/imagestatic")),u=e(a("ol/source/vector")),y=e(a("ol/proj/projection")),w=e(a("ol/feature")),v=e(a("ol/geom/point")),A=e(a("ol/geom/polygon")),B=e(a("ol/style/style")),x=e(a("ol/style/icon")),
z=e(a("ol/style/text")),C=e(a("ol/style/stroke")),S=e(a("ol/style/fill")),I=e(a("ol/interaction")),M,H,J,D,T,R,G,Q,da=!1,aa,F,N=!1,O=[-7.769917472065843,159.26978694839946,244.46989575495544,-6.003894110679995,-.28864271213341297,.010398324019718075,4.215508849724247,-.6078830146963545,-7.0400449629241395],K=[14.199431377059842,-158.80601990819815,68.9630034040724,5.796703402034644,1.1348242200568706,.11891051684489184,-.2930832938484276,.1448231125788526,-5.282895700923075];k.getMap=function(a,g,
e,h){M=a;for(var p=[],n=0;n<g.length;n++){var k=g[n],F=[k.pixel_x,3575-k.pixel_y];null===k.parent&&(k=new w.default({geometry:new v.default(F),loc:k}),p.push(k))}g=new u.default({features:p});D=new r.default({source:g,style:function(a){var b=H.getView().getZoom(),f=a.get("loc");if(3!==f.group_id||N)return a=f.name,"0"!==f.short_name&&(a=f.short_name),f=1===f.group_id||4===f.group_id||12===f.group_id?"blue":3===f.group_id?"green":2===f.group_id?"yellow":"gray",a=new z.default({offsetY:20,padding:[20,
20,20,20],font:3*b+"px Roboto",text:a,fill:new S.default({color:"#ffffff"}),stroke:new C.default({color:"#444",width:3})}),f=new x.default({src:M.markersBase+"marker_dot_"+f+".png",scale:.2}),[new B.default({image:3<=b?f:void 0,text:4<=b?a:void 0})]}});R=[0,0,5430,3575];G=new y.default({code:"instiMAP",units:"pixels",extent:R});a=new t.default({url:a.mapMinPath,attributions:Q,projection:G,imageExtent:R,imageLoadFunction:function(a,f){a=a.getImage();a.src=f;a.onload=function(){b();h()}}});T=new l.default({source:a});
a=I.default.defaults({altShiftDragRotate:!1,pinchRotate:!1});J=new q.default({projection:G,center:m.default.getCenter(R),zoom:3.4,minZoom:2,maxZoom:5.5,extent:[300,300,5E3,3E3]});H=new f.default({interactions:a,layers:[T,D],target:M.map_id,view:J,controls:[]});H.on("click",function(a){var b=a.pixel;a=[b[0]+30,b[1]-30];b=H.getCoordinateFromPixel([b[0]-30,b[1]+30]);a=H.getCoordinateFromPixel(a).concat(b);a=new w.default(new A.default([[[a[0],a[1]],[a[0],a[3]],[a[2],a[3]],[a[2],a[1]],[a[0],a[1]]]]));
(a=D.getSource().forEachFeatureIntersectingExtent(a.getGeometry().getExtent(),function(a){return a}))?(a=a.get("loc"),d(a),e(a)):(c(-50,-50,!1),e())});H.on("pointermove",function(a){a=H.getEventPixel(a.originalEvent);a=H.hasFeatureAtPixel(a);var b=document.getElementById(M.map_id);null!=b&&(b.style.cursor=a?"pointer":"move")});H.on("pointerdrag",function(){da=!1});return H};k.moveToLocation=d;k.moveMarker=c;k.setResidencesVisible=function(a){N=a;D.getSource().changed()};k.hasGeolocation=h;k.getGPS=
function(a){h()?(da=!0,null!=aa?n(!0):aa=navigator.geolocation.watchPosition(function(a){var b=da||null==F;a=g(a);0<a.pixel_x&&0<a.pixel_y&&5430>a.pixel_x&&5375>a.pixel_y&&(F=a,n(b))},function(){},{enableHighAccuracy:!0})):a&&a()};k.getMapXY=g;k.isFollowingUser=function(){return da};k.getGeolocationLast=function(){return F};k.cleanup=function(){null!=aa&&void 0!=aa&&navigator.geolocation.clearWatch(aa)}},{"ol/extent":54,"ol/feature":57,"ol/geom/point":81,"ol/geom/polygon":82,"ol/interaction":90,"ol/layer/image":107,
"ol/layer/vector":110,"ol/map":115,"ol/overlay":128,"ol/proj/projection":145,"ol/source/imagestatic":210,"ol/source/vector":213,"ol/style/fill":225,"ol/style/icon":226,"ol/style/stroke":233,"ol/style/style":234,"ol/style/text":235,"ol/view":245}],29:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={binarySearch:function(a,b,e){for(var c,g=e||d.numberSafeCompareFunction,f=0,l=a.length,h=!1;f<l;)e=f+(l-f>>1),c=+g(a[e],b),0>c?f=e+1:(l=e,h=!c);return h?f:~f},numberSafeCompareFunction:function(a,
b){return a>b?1:a<b?-1:0},includes:function(a,b){return 0<=a.indexOf(b)},linearFindNearest:function(a,b,d){var c=a.length;if(a[0]<=b)return 0;if(!(b<=a[c-1]))if(0<d)for(d=1;d<c;++d){if(a[d]<b)return d-1}else if(0>d)for(d=1;d<c;++d){if(a[d]<=b)return d}else for(d=1;d<c;++d){if(a[d]==b)return d;if(a[d]<b)return a[d-1]-b<b-a[d]?d-1:d}return c-1},reverseSubArray:function(a,b,d){for(;b<d;){var c=a[b];a[b]=a[d];a[d]=c;++b;--d}},extend:function(a,b){var c=Array.isArray(b)?b:[b],d=c.length;for(b=0;b<d;b++)a[a.length]=
c[b]},remove:function(a,b){b=a.indexOf(b);var c=-1<b;c&&a.splice(b,1);return c},find:function(a,b){for(var c=a.length>>>0,d,g=0;g<c;g++)if(d=a[g],b(d,g,a))return d;return null},equals:function(a,b){var c=a.length;if(c!==b.length)return!1;for(var d=0;d<c;d++)if(a[d]!==b[d])return!1;return!0},stableSort:function(a,b){var c=a.length,d=Array(a.length),g;for(g=0;g<c;g++)d[g]={index:g,value:a[g]};d.sort(function(a,c){return b(a.value,c.value)||a.index-c.index});for(g=0;g<a.length;g++)a[g]=d[g].value},findIndex:function(a,
b){var c;return a.every(function(d,g){c=g;return!b(d,g,a)})?-1:c},isSorted:function(a,b,e){var c=b||d.numberSafeCompareFunction;return a.every(function(b,f){if(0===f)return!0;b=c(a[f-1],b);return!(0<b||e&&0===b)})}};k.default=d},{}],30:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./index.js"))&&a.__esModule?a:{default:a};a=function(a){this.message="Assertion failed. See https://openlayers.org/en/"+(d.default.VERSION?d.default.VERSION.split("-")[0]:"latest")+"/doc/errors/#"+
a+" for details.";this.code=a;this.name="AssertionError"};d.default.inherits(a,Error);k.default=a},{"./index.js":89}],31:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./assertionerror.js"))&&a.__esModule?a:{default:a};k.default={assert:function(a,b){if(!a)throw new d.default(b);}}},{"./assertionerror.js":30}],32:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./tilerange.js");var c=d(e);e=a("./math.js");
var b=d(e);a=a("./tilegrid.js");var h=d(a);a=function(a){this.html_=a.html;this.tileRanges_=a.tileRanges?a.tileRanges:null};a.prototype.getHTML=function(){return this.html_};a.prototype.intersectsAnyTileRange=function(a,g,f){if(!this.tileRanges_)return!0;var d,e;for(e in a)if(e in this.tileRanges_){var m=a[e];var p=0;for(d=this.tileRanges_[e].length;p<d;++p){var n=this.tileRanges_[e][p];if(n.intersects(m))return!0;var t=g.getTileRangeForExtentAndZ(h.default.extentFromProjection(f),parseInt(e,10)),
u=t.getWidth();if(m.minX<t.minX||m.maxX>t.maxX)if(n.intersects(new c.default(b.default.modulo(m.minX,u),b.default.modulo(m.maxX,u),m.minY,m.maxY))||m.getWidth()>u&&n.intersects(t))return!0}}return!1};k.default=a},{"./math.js":123,"./tilegrid.js":238,"./tilerange.js":241}],33:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./math.js"))&&a.__esModule?a:{default:a};k.default={createExtent:function(a){return function(b){if(b)return[d.default.clamp(b[0],a[0],a[2]),d.default.clamp(b[1],
a[1],a[3])]}},none:function(a){return a}}},{"./math.js":123}],34:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./assertionerror.js"),b=d(c);c=a("./collectioneventtype.js");var h=d(c);c=a("./object.js");var n=d(c);a=a("./events/event.js");var g=d(a),f=function(a,b){n.default.call(this);this.unique_=!!(b||{}).unique;this.array_=a?a:[];if(this.unique_)for(a=0,b=this.array_.length;a<b;++a)this.assertUnique_(this.array_[a],
a);this.updateLength_()};e.default.inherits(f,n.default);f.prototype.clear=function(){for(;0<this.getLength();)this.pop()};f.prototype.extend=function(a){var b;var f=0;for(b=a.length;f<b;++f)this.push(a[f]);return this};f.prototype.forEach=function(a,b){a=b?a.bind(b):a;b=this.array_;for(var f=0,c=b.length;f<c;++f)a(b[f],f,b)};f.prototype.getArray=function(){return this.array_};f.prototype.item=function(a){return this.array_[a]};f.prototype.getLength=function(){return this.get(f.Property_.LENGTH)};
...
c=this.getElement(),d=this.getRect(c,[f.default.outerWidth(c),f.default.outerHeight(c)]);c=this.autoPanMargin;if(!q.default.containsExtent(b,d)){var e=d[0]-b[0],g=b[2]-d[2],h=d[1]-b[1];d=b[3]-d[3];b=[0,0];0>e?b[0]=e-c:0>g&&(b[0]=Math.abs(g)+c);0>h?b[1]=h-c:0>d&&(b[1]=Math.abs(d)+c);if(0!==b[0]||0!==b[1])c=a.getView().getCenter(),c=a.getPixelFromCoordinate(c),c=[c[0]+b[0],c[1]+b[1]],a.getView().animate({center:a.getCoordinateFromPixel(c),duration:this.autoPanAnimation.duration,easing:this.autoPanAnimation.easing})}}};
