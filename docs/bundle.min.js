...
0)}}},{}],28:[function(a,e,k){function d(a){c(a.pixel_x,a.pixel_y,!0)}function c(a,b,f,c){void 0===f&&(f=!0);void 0===c&&(c=M.marker_id);a=[Number(a),3575-Number(b)];c=document.getElementById(c);c=new p.default({position:a,positioning:"bottom-center",element:c,stopEvent:!1,offset:[0,0]});H.addOverlay(c);f&&(J.animate({center:a}),J.animate({zoom:4.5}))}function b(){var a=new t.default({url:M.mapPath,attributions:Q,projection:G,imageExtent:R}),b=new Image;b.src=M.mapPath;b.onload=function(){T.setSource(a)}}
function h(){return navigator.geolocation?!0:!1}function n(a){null!=F&&c(F.pixel_x,F.pixel_y,a,M.user_marker_id)}function g(a){var b=1E3*(a.coords.latitude-19.133691);a=1E3*(a.coords.longitude-72.916984);var f=O,c=Math.round(4189+f[0]+f[1]*b+f[2]*a+f[3]*b*b+f[4]*b*b*a+f[5]*b*b*a*a+f[6]*a*a+f[7]*b*a*a+f[8]*b*a);f=K;return{pixel_x:c,pixel_y:Math.round(1655+f[0]+f[1]*b+f[2]*a+f[3]*b*b+f[4]*b*b*a+f[5]*b*b*a*a+f[6]*a*a+f[7]*b*a*a+f[8]*b*a)}}e=this&&this.__importDefault||function(a){return a&&a.__esModule?
a:{default:a}};Object.defineProperty(k,"__esModule",{value:!0});var f=e(a("ol/map")),l=e(a("ol/layer/image")),q=e(a("ol/view")),m=e(a("ol/extent")),p=e(a("ol/overlay")),r=e(a("ol/layer/vector")),t=e(a("ol/source/imagestatic")),u=e(a("ol/source/vector")),y=e(a("ol/proj/projection")),w=e(a("ol/feature")),v=e(a("ol/geom/point")),A=e(a("ol/geom/polygon")),B=e(a("ol/style/style")),x=e(a("ol/style/icon")),z=e(a("ol/style/text")),C=e(a("ol/style/stroke")),S=e(a("ol/style/fill")),I=e(a("ol/interaction")),
M,H,J,D,T,R,G,Q,da=!1,aa,F,N=!1,O=[-7.769917472065843,159.26978694839946,244.46989575495544,-6.003894110679995,-.28864271213341297,.010398324019718075,4.215508849724247,-.6078830146963545,-7.0400449629241395],K=[14.199431377059842,-158.80601990819815,68.9630034040724,5.796703402034644,1.1348242200568706,.11891051684489184,-.2930832938484276,.1448231125788526,-5.282895700923075];k.getMap=function(a,g,e,h){M=a;for(var p=[],n=0;n<g.length;n++){var k=g[n],F=[k.pixel_x,3575-k.pixel_y];null===k.parent&&
(k=new w.default({geometry:new v.default(F),loc:k}),p.push(k))}g=new u.default({features:p});D=new r.default({source:g,style:function(a){var b=H.getView().getZoom(),f=a.get("loc");if(3!==f.group_id||N)return a=f.name,"0"!==f.short_name&&(a=f.short_name),f=1===f.group_id||4===f.group_id||12===f.group_id?"blue":3===f.group_id?"green":2===f.group_id?"yellow":"gray",a=new z.default({offsetY:20,padding:[20,20,20,20],font:3*b+"px Roboto",text:a,fill:new S.default({color:"#ffffff"}),stroke:new C.default({color:"#444",
width:3})}),f=new x.default({src:M.markersBase+"marker_dot_"+f+".png",scale:.2}),[new B.default({image:3<=b?f:void 0,text:4<=b?a:void 0})]}});R=[0,0,5430,3575];G=new y.default({code:"instiMAP",units:"pixels",extent:R});a=new t.default({url:a.mapMinPath,attributions:Q,projection:G,imageExtent:R,imageLoadFunction:function(a,f){a=a.getImage();a.src=f;a.onload=function(){b();h()}}});T=new l.default({source:a});a=I.default.defaults({altShiftDragRotate:!1,pinchRotate:!1});J=new q.default({projection:G,
center:m.default.getCenter(R),zoom:3.4,minZoom:2,maxZoom:5.5,extent:[300,300,5E3,3E3]});H=new f.default({interactions:a,layers:[T,D],target:M.map_id,view:J,controls:[]});H.on("click",function(a){var b=a.pixel;a=[b[0]+30,b[1]-30];b=H.getCoordinateFromPixel([b[0]-30,b[1]+30]);a=H.getCoordinateFromPixel(a).concat(b);a=new w.default(new A.default([[[a[0],a[1]],[a[0],a[3]],[a[2],a[3]],[a[2],a[1]],[a[0],a[1]]]]));(a=D.getSource().forEachFeatureIntersectingExtent(a.getGeometry().getExtent(),function(a){return a}))?
(a=a.get("loc"),d(a),e(a)):(c(-50,-50,!1),e())});H.on("pointermove",function(a){a=H.getEventPixel(a.originalEvent);a=H.hasFeatureAtPixel(a);var b=document.getElementById(M.map_id);null!=b&&(b.style.cursor=a?"pointer":"move")});H.on("pointerdrag",function(){da=!1});return H};k.moveToLocation=d;k.moveMarker=c;k.setResidencesVisible=function(a){N=a;D.getSource().changed()};k.hasGeolocation=h;k.getGPS=function(a){h()?(da=!0,null!=aa?n(!0):aa=navigator.geolocation.watchPosition(function(a){var b=da||null==
F;a=g(a);0<a.pixel_x&&0<a.pixel_y&&5430>a.pixel_x&&5375>a.pixel_y&&(F=a,n(b))},function(){},{enableHighAccuracy:!0})):a&&a()};k.getMapXY=g;k.isFollowingUser=function(){return da};k.getGeolocationLast=function(){return F};k.cleanup=function(){null!=aa&&void 0!=aa&&navigator.geolocation.clearWatch(aa)}},{"ol/extent":54,"ol/feature":57,"ol/geom/point":81,"ol/geom/polygon":82,"ol/interaction":90,"ol/layer/image":107,"ol/layer/vector":110,"ol/map":115,"ol/overlay":128,"ol/proj/projection":145,"ol/source/imagestatic":210,
"ol/source/vector":213,"ol/style/fill":225,"ol/style/icon":226,"ol/style/stroke":233,"ol/style/style":234,"ol/style/text":235,"ol/view":245}],29:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={binarySearch:function(a,b,e){for(var c,g=e||d.numberSafeCompareFunction,f=0,l=a.length,h=!1;f<l;)e=f+(l-f>>1),c=+g(a[e],b),0>c?f=e+1:(l=e,h=!c);return h?f:~f},numberSafeCompareFunction:function(a,b){return a>b?1:a<b?-1:0},includes:function(a,b){return 0<=a.indexOf(b)},linearFindNearest:function(a,
b,d){var c=a.length;if(a[0]<=b)return 0;if(!(b<=a[c-1]))if(0<d)for(d=1;d<c;++d){if(a[d]<b)return d-1}else if(0>d)for(d=1;d<c;++d){if(a[d]<=b)return d}else for(d=1;d<c;++d){if(a[d]==b)return d;if(a[d]<b)return a[d-1]-b<b-a[d]?d-1:d}return c-1},reverseSubArray:function(a,b,d){for(;b<d;){var c=a[b];a[b]=a[d];a[d]=c;++b;--d}},extend:function(a,b){var c=Array.isArray(b)?b:[b],d=c.length;for(b=0;b<d;b++)a[a.length]=c[b]},remove:function(a,b){b=a.indexOf(b);var c=-1<b;c&&a.splice(b,1);return c},find:function(a,
b){for(var c=a.length>>>0,d,g=0;g<c;g++)if(d=a[g],b(d,g,a))return d;return null},equals:function(a,b){var c=a.length;if(c!==b.length)return!1;for(var d=0;d<c;d++)if(a[d]!==b[d])return!1;return!0},stableSort:function(a,b){var c=a.length,d=Array(a.length),g;for(g=0;g<c;g++)d[g]={index:g,value:a[g]};d.sort(function(a,c){return b(a.value,c.value)||a.index-c.index});for(g=0;g<a.length;g++)a[g]=d[g].value},findIndex:function(a,b){var c;return a.every(function(d,g){c=g;return!b(d,g,a)})?-1:c},isSorted:function(a,
b,e){var c=b||d.numberSafeCompareFunction;return a.every(function(b,f){if(0===f)return!0;b=c(a[f-1],b);return!(0<b||e&&0===b)})}};k.default=d},{}],30:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./index.js"))&&a.__esModule?a:{default:a};a=function(a){this.message="Assertion failed. See https://openlayers.org/en/"+(d.default.VERSION?d.default.VERSION.split("-")[0]:"latest")+"/doc/errors/#"+a+" for details.";this.code=a;this.name="AssertionError"};d.default.inherits(a,
Error);k.default=a},{"./index.js":89}],31:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./assertionerror.js"))&&a.__esModule?a:{default:a};k.default={assert:function(a,b){if(!a)throw new d.default(b);}}},{"./assertionerror.js":30}],32:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./tilerange.js");var c=d(e);e=a("./math.js");var b=d(e);a=a("./tilegrid.js");var h=d(a);a=function(a){this.html_=
a.html;this.tileRanges_=a.tileRanges?a.tileRanges:null};a.prototype.getHTML=function(){return this.html_};a.prototype.intersectsAnyTileRange=function(a,g,f){if(!this.tileRanges_)return!0;var d,e;for(e in a)if(e in this.tileRanges_){var m=a[e];var p=0;for(d=this.tileRanges_[e].length;p<d;++p){var n=this.tileRanges_[e][p];if(n.intersects(m))return!0;var t=g.getTileRangeForExtentAndZ(h.default.extentFromProjection(f),parseInt(e,10)),u=t.getWidth();if(m.minX<t.minX||m.maxX>t.maxX)if(n.intersects(new c.default(b.default.modulo(m.minX,
u),b.default.modulo(m.maxX,u),m.minY,m.maxY))||m.getWidth()>u&&n.intersects(t))return!0}}return!1};k.default=a},{"./math.js":123,"./tilegrid.js":238,"./tilerange.js":241}],33:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./math.js"))&&a.__esModule?a:{default:a};k.default={createExtent:function(a){return function(b){if(b)return[d.default.clamp(b[0],a[0],a[2]),d.default.clamp(b[1],a[1],a[3])]}},none:function(a){return a}}},{"./math.js":123}],34:[function(a,e,k){function d(a){return a&&
a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./assertionerror.js"),b=d(c);c=a("./collectioneventtype.js");var h=d(c);c=a("./object.js");var n=d(c);a=a("./events/event.js");var g=d(a),f=function(a,b){n.default.call(this);this.unique_=!!(b||{}).unique;this.array_=a?a:[];if(this.unique_)for(a=0,b=this.array_.length;a<b;++a)this.assertUnique_(this.array_[a],a);this.updateLength_()};e.default.inherits(f,n.default);f.prototype.clear=function(){for(;0<
this.getLength();)this.pop()};f.prototype.extend=function(a){var b;var f=0;for(b=a.length;f<b;++f)this.push(a[f]);return this};f.prototype.forEach=function(a,b){a=b?a.bind(b):a;b=this.array_;for(var f=0,c=b.length;f<c;++f)a(b[f],f,b)};f.prototype.getArray=function(){return this.array_};f.prototype.item=function(a){return this.array_[a]};f.prototype.getLength=function(){return this.get(f.Property_.LENGTH)};f.prototype.insertAt=function(a,b){this.unique_&&this.assertUnique_(b);this.array_.splice(a,
...
b));return b};f.prototype.setAt=function(a,b){var c=this.getLength();if(a<c)this.unique_&&this.assertUnique_(b,a),c=this.array_[a],this.array_[a]=b,this.dispatchEvent(new f.Event(h.default.REMOVE,c)),this.dispatchEvent(new f.Event(h.default.ADD,b));else{for(;c<a;++c)this.insertAt(c,void 0);this.insertAt(a,b)}};f.prototype.updateLength_=function(){this.set(f.Property_.LENGTH,this.array_.length)};f.prototype.assertUnique_=function(a,f){for(var c=0,g=this.array_.length;c<g;++c)if(this.array_[c]===a&&
c!==f)throw new b.default(58);};f.Property_={LENGTH:"length"};f.Event=function(a,b){g.default.call(this,a);this.element=b};e.default.inherits(f.Event,g.default);k.default=f},{"./assertionerror.js":30,"./collectioneventtype.js":35,"./events/event.js":50,"./index.js":89,"./object.js":125}],35:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={ADD:"add",REMOVE:"remove"}},{}],36:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(e=a("./asserts.js"))&&e.__esModule?
e:{default:e},c=(a=a("./math.js"))&&a.__esModule?a:{default:a},b={HEX_COLOR_RE_:/^#(?:[0-9a-f]{3,4}){1,2}$/i,NAMED_COLOR_RE_:/^([a-z]*)$/i,asArray:function(a){return Array.isArray(a)?a:b.fromString(a)},asString:function(a){return"string"===typeof a?a:b.toString(a)},fromNamed:function(a){var b=document.createElement("div");b.style.color=a;document.body.appendChild(b);a=getComputedStyle(b).color;document.body.removeChild(b);return a}};b.fromString=function(){var a={},c=0;return function(g){if(a.hasOwnProperty(g))var f=
...
a.indexOf("rgba(")?(a=a.slice(5,-1).split(",").map(Number),g=b.normalize(a)):0==a.indexOf("rgb(")?(a=a.slice(4,-1).split(",").map(Number),a.push(1),g=b.normalize(a)):d.default.assert(!1,14);return g};b.normalize=function(a,b){b=b||[];b[0]=c.default.clamp(a[0]+.5|0,0,255);b[1]=c.default.clamp(a[1]+.5|0,0,255);b[2]=c.default.clamp(a[2]+.5|0,0,255);b[3]=c.default.clamp(a[3],0,1);return b};b.toString=function(a){var b=a[0];b!=(b|0)&&(b=b+.5|0);var c=a[1];c!=(c|0)&&(c=c+.5|0);var f=a[2];f!=(f|0)&&(f=f+
.5|0);return"rgba("+b+","+c+","+f+","+(void 0===a[3]?1:a[3])+")"};k.default=b},{"./asserts.js":31,"./math.js":123}],37:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./color.js"))&&a.__esModule?a:{default:a},c={asColorLike:function(a){return c.isColorLike(a)?a:d.default.asString(a)},isColorLike:function(a){return"string"===typeof a||a instanceof CanvasPattern||a instanceof CanvasGradient}};k.default=c},{"./color.js":36}],38:[function(a,e,k){function d(a){return a&&a.__esModule?
a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./collection.js");var c=d(e);e=a("./control/attribution.js");var b=d(e);e=a("./control/rotate.js");var h=d(e);a=a("./control/zoom.js");var n=d(a);k.default={defaults:function(a){a=a?a:{};var f=new c.default;(void 0!==a.zoom?a.zoom:1)&&f.push(new n.default(a.zoomOptions));(void 0!==a.rotate?a.rotate:1)&&f.push(new h.default(a.rotateOptions));(void 0!==a.attribution?a.attribution:1)&&f.push(new b.default(a.attributionOptions));return f}}},
{"./collection.js":34,"./control/attribution.js":39,"./control/rotate.js":41,"./control/zoom.js":42}],39:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../array.js"),b=d(c);c=a("../control/control.js");var h=d(c);c=a("../css.js");var n=d(c);c=a("../dom.js");var g=d(c);c=a("../events.js");var f=d(c);c=a("../events/eventtype.js");var l=d(c);c=a("../layer/layer.js");var q=d(c);a=a("../obj.js");var m=
d(a),p=function(a){a=a?a:{};this.ulElement_=document.createElement("UL");this.logoLi_=document.createElement("LI");this.ulElement_.appendChild(this.logoLi_);this.logoLi_.style.display="none";this.collapsed_=void 0!==a.collapsed?a.collapsed:!0;this.collapsible_=void 0!==a.collapsible?a.collapsible:!0;this.collapsible_||(this.collapsed_=!1);var b=void 0!==a.className?a.className:"ol-attribution",c=void 0!==a.tipLabel?a.tipLabel:"Attributions",g=void 0!==a.collapseLabel?a.collapseLabel:"\u00bb";"string"===
typeof g?(this.collapseLabel_=document.createElement("span"),this.collapseLabel_.textContent=g):this.collapseLabel_=g;g=void 0!==a.label?a.label:"i";"string"===typeof g?(this.label_=document.createElement("span"),this.label_.textContent=g):this.label_=g;var d=this.collapsible_&&!this.collapsed_?this.collapseLabel_:this.label_;g=document.createElement("button");g.setAttribute("type","button");g.title=c;g.appendChild(d);f.default.listen(g,l.default.CLICK,this.handleClick_,this);b=b+" "+n.default.CLASS_UNSELECTABLE+
" "+n.default.CLASS_CONTROL+(this.collapsed_&&this.collapsible_?" ol-collapsed":"")+(this.collapsible_?"":" ol-uncollapsible");c=document.createElement("div");c.className=b;c.appendChild(this.ulElement_);c.appendChild(g);h.default.call(this,{element:c,render:a.render?a.render:p.render,target:a.target});this.renderedAttributions_=[];this.renderedVisible_=!0;this.logoElements_={}};e.default.inherits(p,h.default);p.prototype.getSourceAttributions_=function(a){for(var b={},f=[],c=a.layerStatesArray,g=
a.viewState.resolution,d=0,e=c.length;d<e;++d){var l=c[d];if(q.default.visibleAtResolution(l,g)&&(l=l.layer.getSource())&&(l=l.getAttributions2())&&(l=l(a)))if(Array.isArray(l))for(var m=0,p=l.length;m<p;++m)l[m]in b||(f.push(l[m]),b[l[m]]=!0);else l in b||(f.push(l),b[l]=!0)}return f};p.render=function(a){this.updateElement_(a.frameState)};p.prototype.updateElement_=function(a){if(a){var f=this.getSourceAttributions_(a);if(!b.default.equals(f,this.renderedAttributions_)){for(;this.ulElement_.lastChild!==
this.logoLi_;)this.ulElement_.removeChild(this.ulElement_.lastChild);for(var c=0,g=f.length;c<g;++c){var d=document.createElement("LI");d.innerHTML=f[c];this.ulElement_.appendChild(d)}0===f.length&&0<this.renderedAttributions_.length?this.element.classList.add("ol-logo-only"):0===this.renderedAttributions_.length&&0<f.length&&this.element.classList.remove("ol-logo-only");c=0<f.length||!m.default.isEmpty(a.logos);this.renderedVisible_!=c&&(this.element.style.display=c?"":"none",this.renderedVisible_=
c);this.renderedAttributions_=f;this.insertLogos_(a)}}else this.renderedVisible_&&(this.element.style.display="none",this.renderedVisible_=!1)};p.prototype.insertLogos_=function(a){a=a.logos;var b=this.logoElements_;for(d in b)d in a||(g.default.removeNode(b[d]),delete b[d]);var f;for(f in a){var c=a[f];c instanceof HTMLElement&&(this.logoLi_.appendChild(c),b[f]=c);if(!(f in b)){var d=new Image;d.src=f;if(""===c)var e=d;else e=document.createElement("a"),e.href=c,e.appendChild(d);this.logoLi_.appendChild(e);
b[f]=e}}this.logoLi_.style.display=m.default.isEmpty(a)?"none":""};p.prototype.handleClick_=function(a){a.preventDefault();this.handleToggle_()};p.prototype.handleToggle_=function(){this.element.classList.toggle("ol-collapsed");this.collapsed_?g.default.replaceNode(this.collapseLabel_,this.label_):g.default.replaceNode(this.label_,this.collapseLabel_);this.collapsed_=!this.collapsed_};p.prototype.getCollapsible=function(){return this.collapsible_};p.prototype.setCollapsible=function(a){this.collapsible_!==
a&&(this.collapsible_=a,this.element.classList.toggle("ol-uncollapsible"),!a&&this.collapsed_&&this.handleToggle_())};p.prototype.setCollapsed=function(a){this.collapsible_&&this.collapsed_!==a&&this.handleToggle_()};p.prototype.getCollapsed=function(){return this.collapsed_};k.default=p},{"../array.js":29,"../control/control.js":40,"../css.js":44,"../dom.js":46,"../events.js":48,"../events/eventtype.js":52,"../index.js":89,"../layer/layer.js":108,"../obj.js":124}],40:[function(a,e,k){function d(a){return a&&
a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");var c=d(e);e=a("../mapeventtype.js");var b=d(e);e=a("../object.js");var h=d(e);e=a("../dom.js");var n=d(e);a=a("../events.js");var g=d(a);a=function(a){h.default.call(this);this.element=a.element?a.element:null;this.map_=this.target_=null;this.listenerKeys=[];this.render=a.render?a.render:c.default.nullFunction;a.target&&this.setTarget(a.target)};c.default.inherits(a,h.default);a.prototype.disposeInternal=
function(){n.default.removeNode(this.element);h.default.prototype.disposeInternal.call(this)};a.prototype.getMap=function(){return this.map_};a.prototype.setMap=function(a){this.map_&&n.default.removeNode(this.element);for(var f=0,d=this.listenerKeys.length;f<d;++f)g.default.unlistenByKey(this.listenerKeys[f]);this.listenerKeys.length=0;if(this.map_=a)(this.target_?this.target_:a.getOverlayContainerStopEvent()).appendChild(this.element),this.render!==c.default.nullFunction&&this.listenerKeys.push(g.default.listen(a,
b.default.POSTRENDER,this.render,this)),a.render()};a.prototype.setTarget=function(a){this.target_="string"===typeof a?document.getElementById(a):a};k.default=a},{"../dom.js":46,"../events.js":48,"../index.js":89,"../mapeventtype.js":121,"../object.js":125}],41:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../events.js");var c=d(e);e=a("../events/eventtype.js");var b=d(e);e=a("../index.js");e=d(e);var h=a("../control/control.js"),
n=d(h);h=a("../css.js");var g=d(h);a=a("../easing.js");var f=d(a),l=function(a){a=a?a:{};var f=void 0!==a.className?a.className:"ol-rotate",d=void 0!==a.label?a.label:"\u21e7";this.label_=null;"string"===typeof d?(this.label_=document.createElement("span"),this.label_.className="ol-compass",this.label_.textContent=d):(this.label_=d,this.label_.classList.add("ol-compass"));var e=a.tipLabel?a.tipLabel:"Reset rotation";d=document.createElement("button");d.className=f+"-reset";d.setAttribute("type","button");
d.title=e;d.appendChild(this.label_);c.default.listen(d,b.default.CLICK,l.prototype.handleClick_,this);e=f+" "+g.default.CLASS_UNSELECTABLE+" "+g.default.CLASS_CONTROL;f=document.createElement("div");f.className=e;f.appendChild(d);d=a.render?a.render:l.render;this.callResetNorth_=a.resetNorth?a.resetNorth:void 0;n.default.call(this,{element:f,render:d,target:a.target});this.duration_=void 0!==a.duration?a.duration:250;this.autoHide_=void 0!==a.autoHide?a.autoHide:!0;this.rotation_=void 0;this.autoHide_&&
this.element.classList.add(g.default.CLASS_HIDDEN)};e.default.inherits(l,n.default);l.prototype.handleClick_=function(a){a.preventDefault();void 0!==this.callResetNorth_?this.callResetNorth_():this.resetNorth_()};l.prototype.resetNorth_=function(){var a=this.getMap().getView();a&&void 0!==a.getRotation()&&(0<this.duration_?a.animate({rotation:0,duration:this.duration_,easing:f.default.easeOut}):a.setRotation(0))};l.render=function(a){if(a=a.frameState){a=a.viewState.rotation;if(a!=this.rotation_){var b=
"rotate("+a+"rad)";if(this.autoHide_){var f=this.element.classList.contains(g.default.CLASS_HIDDEN);f||0!==a?f&&0!==a&&this.element.classList.remove(g.default.CLASS_HIDDEN):this.element.classList.add(g.default.CLASS_HIDDEN)}this.label_.style.msTransform=b;this.label_.style.webkitTransform=b;this.label_.style.transform=b}this.rotation_=a}};k.default=l},{"../control/control.js":40,"../css.js":44,"../easing.js":47,"../events.js":48,"../events/eventtype.js":52,"../index.js":89}],42:[function(a,e,k){function d(a){return a&&
a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../events.js"),b=d(c);c=a("../events/eventtype.js");var h=d(c);c=a("../control/control.js");var n=d(c);c=a("../css.js");var g=d(c);a=a("../easing.js");var f=d(a),l=function(a){a=a?a:{};var f=void 0!==a.className?a.className:"ol-zoom",c=void 0!==a.delta?a.delta:1,d=void 0!==a.zoomInLabel?a.zoomInLabel:"+",e=void 0!==a.zoomOutLabel?a.zoomOutLabel:"\u2212",q=void 0!==a.zoomInTipLabel?a.zoomInTipLabel:
"Zoom in",y=void 0!==a.zoomOutTipLabel?a.zoomOutTipLabel:"Zoom out",w=document.createElement("button");w.className=f+"-in";w.setAttribute("type","button");w.title=q;w.appendChild("string"===typeof d?document.createTextNode(d):d);b.default.listen(w,h.default.CLICK,l.prototype.handleClick_.bind(this,c));d=document.createElement("button");d.className=f+"-out";d.setAttribute("type","button");d.title=y;d.appendChild("string"===typeof e?document.createTextNode(e):e);b.default.listen(d,h.default.CLICK,l.prototype.handleClick_.bind(this,
-c));f=f+" "+g.default.CLASS_UNSELECTABLE+" "+g.default.CLASS_CONTROL;c=document.createElement("div");c.className=f;c.appendChild(w);c.appendChild(d);n.default.call(this,{element:c,target:a.target});this.duration_=void 0!==a.duration?a.duration:250};e.default.inherits(l,n.default);l.prototype.handleClick_=function(a,b){b.preventDefault();this.zoomByDelta_(a)};l.prototype.zoomByDelta_=function(a){var b=this.getMap().getView();if(b){var c=b.getResolution();c&&(a=b.constrainResolution(c,a),0<this.duration_?
(b.getAnimating()&&b.cancelAnimations(),b.animate({resolution:a,duration:this.duration_,easing:f.default.easeOut})):b.setResolution(a))}};k.default=l},{"../control/control.js":40,"../css.js":44,"../easing.js":47,"../events.js":48,"../events/eventtype.js":52,"../index.js":89}],43:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(e=a("./math.js"))&&e.__esModule?e:{default:e},c=(a=a("./string.js"))&&a.__esModule?a:{default:a},b={add:function(a,b){a[0]+=b[0];a[1]+=b[1];return a},
closestOnCircle:function(a,b){var c=b.getRadius(),f=b.getCenter();b=f[0];f=f[1];var d=a[0]-b;a=a[1]-f;0===d&&0===a&&(d=1);var e=Math.sqrt(d*d+a*a);return[b+c*d/e,f+c*a/e]},closestOnSegment:function(a,b){var c=a[0];a=a[1];var f=b[0],d=b[1];b=f[0];f=f[1];var e=d[0];d=d[1];var m=e-b,p=d-f;c=0===m&&0===p?0:(m*(c-b)+p*(a-f))/(m*m+p*p||0);0>=c?(a=b,c=f):1<=c?(a=e,c=d):(a=b+c*m,c=f+c*p);return[a,c]},createStringXY:function(a){return function(c){return b.toStringXY(c,a)}},degreesToStringHDMS:function(a,b,
g){b=d.default.modulo(b+180,360)-180;var f=Math.abs(3600*b);g=g||0;var e=Math.pow(10,g),h=Math.floor(f/3600),m=Math.floor((f-3600*h)/60);f=Math.ceil((f-3600*h-60*m)*e)/e;60<=f&&(f=0,m+=1);60<=m&&(m=0,h+=1);return h+"\u00b0 "+c.default.padNumber(m,2)+"\u2032 "+c.default.padNumber(f,2,g)+"\u2033"+(0==b?"":" "+a.charAt(0>b?1:0))},format:function(a,b,c){return a?b.replace("{x}",a[0].toFixed(c)).replace("{y}",a[1].toFixed(c)):""},equals:function(a,b){for(var c=!0,f=a.length-1;0<=f;--f)if(a[f]!=b[f]){c=
!1;break}return c},rotate:function(a,b){var c=Math.cos(b);b=Math.sin(b);var f=a[1]*c+a[0]*b;a[0]=a[0]*c-a[1]*b;a[1]=f;return a},scale:function(a,b){a[0]*=b;a[1]*=b;return a},sub:function(a,b){a[0]-=b[0];a[1]-=b[1];return a},squaredDistance:function(a,b){var c=a[0]-b[0];a=a[1]-b[1];return c*c+a*a},distance:function(a,c){return Math.sqrt(b.squaredDistance(a,c))},squaredDistanceToSegment:function(a,c){return b.squaredDistance(a,b.closestOnSegment(a,c))},toStringHDMS:function(a,c){return a?b.degreesToStringHDMS("NS",
a[1],c)+" "+b.degreesToStringHDMS("EW",a[0],c):""},toStringXY:function(a,c){return b.format(a,"{x}, {y}",c)}};k.default=b},{"./math.js":123,"./string.js":216}],44:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});a={CLASS_HIDDEN:"ol-hidden",CLASS_SELECTABLE:"ol-selectable",CLASS_UNSELECTABLE:"ol-unselectable",CLASS_UNSUPPORTED:"ol-unsupported",CLASS_CONTROL:"ol-control"};a.getFontFamilies=function(){var a,c={};return function(b){a||(a=document.createElement("div").style);if(!(b in
c)){a.font=b;var d=a.fontFamily;a.font="";if(!d)return null;c[b]=d.split(/,\s?/)}return c[b]}}();k.default=a},{}],45:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});a=(a=a("./index.js"))&&a.__esModule?a:{default:a};e=function(){};e.prototype.disposed_=!1;e.prototype.dispose=function(){this.disposed_||(this.disposed_=!0,this.disposeInternal())};e.prototype.disposeInternal=a.default.nullFunction;k.default=e},{"./index.js":89}],46:[function(a,e,k){Object.defineProperty(k,"__esModule",
{value:!0});k.default={createCanvasContext2D:function(a,c){var b=document.createElement("CANVAS");a&&(b.width=a);c&&(b.height=c);return b.getContext("2d")},outerWidth:function(a){var c=a.offsetWidth;a=getComputedStyle(a);return c+=parseInt(a.marginLeft,10)+parseInt(a.marginRight,10)},outerHeight:function(a){var c=a.offsetHeight;a=getComputedStyle(a);return c+=parseInt(a.marginTop,10)+parseInt(a.marginBottom,10)},replaceNode:function(a,c){var b=c.parentNode;b&&b.replaceChild(a,c)},removeNode:function(a){return a&&
