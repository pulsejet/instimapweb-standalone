...
this.cssClasses.dataset);this.$el=a.$menu&&0<a.$menu.find(l+"-"+this.name).length?n.element(a.$menu.find(l+"-"+this.name)[0]):n.element(g.dataset.replace("%CLASS%",this.name).replace("%PREFIX%",this.cssClasses.prefix).replace("%DATASET%",this.cssClasses.dataset));this.$menu=a.$menu;this.clearCachedSuggestions()}function c(a){function f(f){return f[a]}a=a||"value";return h.isFunction(a)?a:f}function b(a,f){function b(a){return"<p>"+f(a)+"</p>"}return{empty:a.empty&&h.templatify(a.empty),header:a.header&&
h.templatify(a.header),footer:a.footer&&h.templatify(a.footer),suggestion:a.suggestion||b}}var h=a("../common/utils.js"),n=a("../common/dom.js"),g=a("./html.js"),f=a("./css.js");a=a("./event_emitter.js");d.extractDatasetName=function(a){return n.element(a).data("aaDataset")};d.extractValue=function(a){return n.element(a).data("aaValue")};d.extractDatum=function(a){a=n.element(a).data("aaDatum");"string"===typeof a&&(a=JSON.parse(a));return a};h.mixin(d.prototype,a,{_render:function(a,f){function b(){var f=
[].slice.call(arguments,0);f=[{query:a,isEmpty:!0}].concat(f);return d.templates.empty.apply(this,f)}function p(){var a=[].slice.call(arguments,0),b=this;var p=g.suggestions.replace("%PREFIX%",this.cssClasses.prefix).replace("%SUGGESTIONS%",this.cssClasses.suggestions);p=n.element(p).css(this.css.suggestions);var l=h.map(f,function(f){var p=g.suggestion.replace("%PREFIX%",b.cssClasses.prefix).replace("%SUGGESTION%",b.cssClasses.suggestion);p=n.element(p).attr({role:"option",id:["option",Math.floor(1E8*
Math.random())].join("-")}).append(d.templates.suggestion.apply(this,[f].concat(a)));p.data("aaDataset",d.name);p.data("aaValue",d.displayFn(f)||void 0);p.data("aaDatum",JSON.stringify(f));p.children().each(function(){n.element(this).css(b.css.suggestionChild)});return p});p.append.apply(p,l);return p}function l(){var f=[].slice.call(arguments,0);f=[{query:a,isEmpty:!q}].concat(f);return d.templates.header.apply(this,f)}function c(){var f=[].slice.call(arguments,0);f=[{query:a,isEmpty:!q}].concat(f);
return d.templates.footer.apply(this,f)}if(this.$el){var d=this,e=[].slice.call(arguments,2);this.$el.empty();var q=f&&f.length;this._isEmpty=!q;if(!q&&this.templates.empty)this.$el.html(b.apply(this,e)).prepend(d.templates.header?l.apply(this,e):null).append(d.templates.footer?c.apply(this,e):null);else if(q)this.$el.html(p.apply(this,e)).prepend(d.templates.header?l.apply(this,e):null).append(d.templates.footer?c.apply(this,e):null);else if(f&&!Array.isArray(f))throw new TypeError("suggestions must be an array");
this.$menu&&this.$menu.addClass(this.cssClasses.prefix+(q?"with":"without")+"-"+this.name).removeClass(this.cssClasses.prefix+(q?"without":"with")+"-"+this.name);this.trigger("rendered",a)}},getRoot:function(){return this.$el},update:function(a){function f(f){if(!this.canceled&&a===this.query){var b=[].slice.call(arguments,1);this.cacheSuggestions(a,f,b);this._render.apply(this,[a,f].concat(b))}}this.query=a;this.canceled=!1;if(this.shouldFetchFromCache(a))f.apply(this,[this.cachedSuggestions].concat(this.cachedRenderExtraArgs));
else{var b=this,g=function(){b.canceled||b.source(a,f.bind(b))};this.debounce?(clearTimeout(this.debounceTimeout),this.debounceTimeout=setTimeout(function(){b.debounceTimeout=null;g()},this.debounce)):g()}},cacheSuggestions:function(a,f,b){this.cachedQuery=a;this.cachedSuggestions=f;this.cachedRenderExtraArgs=b},shouldFetchFromCache:function(a){return this.cache&&this.cachedQuery===a&&this.cachedSuggestions&&this.cachedSuggestions.length},clearCachedSuggestions:function(){delete this.cachedQuery;
delete this.cachedSuggestions;delete this.cachedRenderExtraArgs},cancel:function(){this.canceled=!0},clear:function(){this.cancel();this.$el.empty();this.trigger("rendered","")},isEmpty:function(){return this._isEmpty},destroy:function(){this.clearCachedSuggestions();this.$el=null}});e.exports=d},{"../common/dom.js":11,"../common/utils.js":13,"./css.js":3,"./event_emitter.js":7,"./html.js":8}],5:[function(a,e,k){function d(a){var f=this;a=a||{};a.menu||c.error("menu is required");c.isArray(a.datasets)||
c.isObject(a.datasets)||c.error("1 or more datasets required");a.datasets||c.error("datasets is required");this.isOpen=!1;this.isEmpty=!0;this.minLength=a.minLength||0;this.templates={};this.appendTo=a.appendTo||!1;this.css=c.mixin({},n,a.appendTo?n.appendTo:{});this.cssClasses=a.cssClasses=c.mixin({},n.defaultClasses,a.cssClasses||{});this.cssClasses.prefix=a.cssClasses.formattedPrefix||c.formatPrefix(this.cssClasses.prefix,this.cssClasses.noPrefix);var g=c.bind(this._onSuggestionClick,this);var h=
c.bind(this._onSuggestionMouseEnter,this);var m=c.bind(this._onSuggestionMouseLeave,this);var p=c.className(this.cssClasses.prefix,this.cssClasses.suggestion);this.$menu=b.element(a.menu).on("mouseenter.aa",p,h).on("mouseleave.aa",p,m).on("click.aa",p,g);this.$container=a.appendTo?a.wrapper:this.$menu;a.templates&&a.templates.header&&(this.templates.header=c.templatify(a.templates.header),this.$menu.prepend(this.templates.header()));a.templates&&a.templates.empty&&(this.templates.empty=c.templatify(a.templates.empty),
this.$empty=b.element('<div class="'+c.className(this.cssClasses.prefix,this.cssClasses.empty,!0)+'"></div>'),this.$menu.append(this.$empty),this.$empty.hide());this.datasets=c.map(a.datasets,function(b){return new d.Dataset(c.mixin({$menu:f.$menu,cssClasses:a.cssClasses},b))});c.each(this.datasets,function(a){var b=a.getRoot();b&&0===b.parent().length&&f.$menu.append(b);a.onSync("rendered",f._onRendered,f)});a.templates&&a.templates.footer&&(this.templates.footer=c.templatify(a.templates.footer),
this.$menu.append(this.templates.footer()));var e=this;b.element(window).resize(function(){e._redraw()})}var c=a("../common/utils.js"),b=a("../common/dom.js");k=a("./event_emitter.js");var h=a("./dataset.js"),n=a("./css.js");c.mixin(d.prototype,k,{_onSuggestionClick:function(a){this.trigger("suggestionClicked",b.element(a.currentTarget))},_onSuggestionMouseEnter:function(a){var f=b.element(a.currentTarget);if(!f.hasClass(c.className(this.cssClasses.prefix,this.cssClasses.cursor,!0))){this._removeCursor();
var g=this;setTimeout(function(){g._setCursor(f,!1)},0)}},_onSuggestionMouseLeave:function(a){a.relatedTarget&&0<b.element(a.relatedTarget).closest("."+c.className(this.cssClasses.prefix,this.cssClasses.cursor,!0)).length||(this._removeCursor(),this.trigger("cursorRemoved"))},_onRendered:function(a,f){function b(a){return a.templates&&a.templates.empty}(this.isEmpty=c.every(this.datasets,function(a){return a.isEmpty()}))?(f.length>=this.minLength&&this.trigger("empty"),this.$empty?f.length<this.minLength?
this._hide():(a=this.templates.empty({query:this.datasets[0]&&this.datasets[0].query}),this.$empty.html(a),this.$empty.show(),this._show()):c.any(this.datasets,b)?f.length<this.minLength?this._hide():this._show():this._hide()):this.isOpen&&(this.$empty&&(this.$empty.empty(),this.$empty.hide()),f.length>=this.minLength?this._show():this._hide());this.trigger("datasetRendered")},_hide:function(){this.$container.hide()},_show:function(){this.$container.css("display","block");this._redraw();this.trigger("shown")},
_redraw:function(){this.isOpen&&this.appendTo&&this.trigger("redrawn")},_getSuggestions:function(){return this.$menu.find(c.className(this.cssClasses.prefix,this.cssClasses.suggestion))},_getCursor:function(){return this.$menu.find(c.className(this.cssClasses.prefix,this.cssClasses.cursor)).first()},_setCursor:function(a,f){a.first().addClass(c.className(this.cssClasses.prefix,this.cssClasses.cursor,!0)).attr("aria-selected","true");this.trigger("cursorMoved",f)},_removeCursor:function(){this._getCursor().removeClass(c.className(this.cssClasses.prefix,
this.cssClasses.cursor,!0)).removeAttr("aria-selected")},_moveCursor:function(a){if(this.isOpen){var f=this._getCursor();var b=this._getSuggestions();this._removeCursor();a=b.index(f)+a;a=(a+1)%(b.length+1)-1;-1===a?this.trigger("cursorRemoved"):(-1>a&&(a=b.length-1),this._setCursor(b=b.eq(a),!0),this._ensureVisible(b))}},_ensureVisible:function(a){var f=a.position().top;a=f+a.height()+parseInt(a.css("margin-top"),10)+parseInt(a.css("margin-bottom"),10);var b=this.$menu.scrollTop();var g=this.$menu.height()+
...
getDatumForSuggestion:function(a){var f=null;a.length&&(f={raw:h.extractDatum(a),value:h.extractValue(a),datasetName:h.extractDatasetName(a)});return f},getCurrentCursor:function(){return this._getCursor().first()},getDatumForCursor:function(){return this.getDatumForSuggestion(this._getCursor().first())},getDatumForTopSuggestion:function(){return this.getDatumForSuggestion(this._getSuggestions().first())},cursorTopSuggestion:function(){this._setCursor(this._getSuggestions().first(),!1)},update:function(a){c.each(this.datasets,
function(f){f.update(a)})},empty:function(){c.each(this.datasets,function(a){a.clear()});this.isEmpty=!0},isVisible:function(){return this.isOpen&&!this.isEmpty},destroy:function(){this.$menu.off(".aa");this.$menu=null;c.each(this.datasets,function(a){a.destroy()})}});d.Dataset=h;e.exports=d},{"../common/dom.js":11,"../common/utils.js":13,"./css.js":3,"./dataset.js":4,"./event_emitter.js":7}],6:[function(a,e,k){function d(a){a&&a.el||c.error("EventBus initialized without el");this.$el=b.element(a.el)}
var c=a("../common/utils.js"),b=a("../common/dom.js");c.mixin(d.prototype,{trigger:function(a,b,g,f){a=c.Event("autocomplete:"+a);this.$el.trigger(a,[b,g,f]);return a}});e.exports=d},{"../common/dom.js":11,"../common/utils.js":13}],7:[function(a,e,k){function d(a,f,c,d){if(!c)return this;f=f.split(n);c=d?b(c,d):c;for(this._callbacks=this._callbacks||{};d=f.shift();)this._callbacks[d]=this._callbacks[d]||{sync:[],async:[]},this._callbacks[d][a].push(c);return this}function c(a,f,b){return function(){for(var g,
c=0,p=a.length;!g&&c<p;c+=1)g=!1===a[c].apply(f,b);return!g}}function b(a,f){return a.bind?a.bind(f):function(){a.apply(f,[].slice.call(arguments,0))}}var h=a("immediate"),n=/\s+/;e.exports={onSync:function(a,f,b){return d.call(this,"sync",a,f,b)},onAsync:function(a,f,b){return d.call(this,"async",a,f,b)},off:function(a){var f;if(!this._callbacks)return this;for(a=a.split(n);f=a.shift();)delete this._callbacks[f];return this},trigger:function(a){var f,b,g;if(!this._callbacks)return this;a=a.split(n);
for(g=[].slice.call(arguments,1);(f=a.shift())&&(b=this._callbacks[f]);){var d=c(b.sync,this,[f].concat(g));var p=c(b.async,this,[f].concat(g));d()&&h(p)}return this}}},{immediate:22}],8:[function(a,e,k){e.exports={wrapper:'<span class="%ROOT%"></span>',dropdown:'<span class="%PREFIX%%DROPDOWN_MENU%"></span>',dataset:'<div class="%PREFIX%%DATASET%-%CLASS%"></div>',suggestions:'<span class="%PREFIX%%SUGGESTIONS%"></span>',suggestion:'<div class="%PREFIX%%SUGGESTION%"></div>'}},{}],9:[function(a,e,
k){function d(a){var f=this;a=a||{};a.input||n.error("input is missing");var b=n.bind(this._onBlur,this);var d=n.bind(this._onFocus,this);var p=n.bind(this._onKeydown,this);var e=n.bind(this._onInput,this);this.$hint=g.element(a.hint);this.$input=g.element(a.input).on("blur.aa",b).on("focus.aa",d).on("keydown.aa",p);0===this.$hint.length&&(this.setHint=this.getHint=this.clearHint=this.clearHintIfInvalid=n.noop);if(n.isMsie())this.$input.on("keydown.aa keypress.aa cut.aa paste.aa",function(a){h[a.which||
a.keyCode]||n.defer(n.bind(f._onInput,f,a))});else this.$input.on("input.aa",e);this.query=this.$input.val();this.$overflowHelper=c(this.$input)}function c(a){return g.element('<pre aria-hidden="true"></pre>').css({position:"absolute",visibility:"hidden",whiteSpace:"pre",fontFamily:a.css("font-family"),fontSize:a.css("font-size"),fontStyle:a.css("font-style"),fontVariant:a.css("font-variant"),fontWeight:a.css("font-weight"),wordSpacing:a.css("word-spacing"),letterSpacing:a.css("letter-spacing"),textIndent:a.css("text-indent"),
...
"$1_$2").replace(/([a-z\d])([A-Z])/g,"$1_$2").replace(/_/g,"-").toLowerCase()}function p(a){return a in R?R[a]:R[a]=new RegExp("(^|\\s)"+a+"(\\s|$)")}function r(a,b){return"number"!=typeof b||G[m(a)]?b:b+"px"}function t(a){return"children"in a?J.call(a.children):E.map(a.childNodes,function(a){if(1==a.nodeType)return a})}function u(a,b){var f,c=a?a.length:0;for(f=0;f<c;f++)this[f]=a[f];this.length=c;this.selector=b||""}function y(a,b,c){for(C in b)c&&(f(b[C])||W(b[C]))?(f(b[C])&&!f(a[C])&&(a[C]={}),
W(b[C])&&!W(a[C])&&(a[C]=[]),y(a[C],b[C],c)):b[C]!==z&&(a[C]=b[C])}function w(a,b){return null==b?E(a):E(a).filter(b)}function v(a,b,f,g){return c(b)?b.call(a,f,g):b}function A(a,b){var f=a.className||"",c=f&&f.baseVal!==z;if(b===z)return c?f.baseVal:f;c?f.baseVal=b:a.className=b}function B(a){try{return a?"true"==a||("false"==a?!1:"null"==a?null:+a+""==a?+a:/^[\[\{]/.test(a)?E.parseJSON(a):a):a}catch(ia){return a}}function x(a,b){b(a);for(var f=0,c=a.childNodes.length;f<c;f++)x(a.childNodes[f],b)}
var z,C,S,k=[],M=k.concat,H=k.filter,J=k.slice,D=a.document,T={},R={},G={"column-count":1,columns:1,"font-weight":1,"line-height":1,opacity:1,"z-index":1,zoom:1},Q=/^\s*<(\w+|!)[^>]*>/,da=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,aa=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,F=/^(?:body|html)$/i,N=/([A-Z])/g,O="val css html text data width height offset".split(" "),K=D.createElement("table"),U=D.createElement("tr"),Z={tr:D.createElement("tbody"),tbody:K,thead:K,tfoot:K,td:U,th:U,
...
a.matches||a.webkitMatchesSelector||a.mozMatchesSelector||a.oMatchesSelector||a.matchesSelector;if(f)return f.call(a,b);var c=a.parentNode;(f=!c)&&(c=P).appendChild(a);b=~L.qsa(c,b).indexOf(a);f&&P.removeChild(a);return b};var ca=function(a){return a.replace(/-+(.)?/g,function(a,b){return b?b.toUpperCase():""})};var fa=function(a){return H.call(a,function(b,f){return a.indexOf(b)==f})};L.fragment=function(a,b,c){var g;da.test(a)&&(g=E(D.createElement(RegExp.$1)));if(!g){a.replace&&(a=a.replace(aa,
"<$1></$2>"));b===z&&(b=Q.test(a)&&RegExp.$1);b in Z||(b="*");var d=Z[b];d.innerHTML=""+a;g=E.each(J.call(d.childNodes),function(){d.removeChild(this)})}if(f(c)){var l=E(g);E.each(c,function(a,b){if(-1<O.indexOf(a))l[a](b);else l.attr(a,b)})}return g};L.Z=function(a,b){return new u(a,b)};L.isZ=function(a){return a instanceof L.Z};L.init=function(a,b){if(a)if("string"==typeof a)if(a=a.trim(),"<"==a[0]&&Q.test(a))b=L.fragment(a,RegExp.$1,b),a=null;else{if(b!==z)return E(b).find(a);b=L.qsa(D,a)}else{if(c(a))return E(D).ready(a);
if(L.isZ(a))return a;if(W(a))b=e(a);else if(g(a))b=[a],a=null;else if(Q.test(a))b=L.fragment(a.trim(),RegExp.$1,b),a=null;else{if(b!==z)return E(b).find(a);b=L.qsa(D,a)}}else return L.Z();return L.Z(b,a)};var E=function(a,b){return L.init(a,b)};E.extend=function(a){var b=J.call(arguments,1);if("boolean"==typeof a){var f=a;a=b.shift()}b.forEach(function(b){y(a,b,f)});return a};L.qsa=function(a,b){var f,c="#"==b[0],g=!c&&"."==b[0],d=c||g?b.slice(1):b,l=X.test(d);return a.getElementById&&l&&c?(f=a.getElementById(d))?
[f]:[]:1!==a.nodeType&&9!==a.nodeType&&11!==a.nodeType?[]:J.call(l&&!c&&a.getElementsByClassName?g?a.getElementsByClassName(d):a.getElementsByTagName(b):a.querySelectorAll(b))};E.contains=D.documentElement.contains?function(a,b){return a!==b&&a.contains(b)}:function(a,b){for(;b&&(b=b.parentNode);)if(b===a)return!0;return!1};E.type=b;E.isFunction=c;E.isWindow=d;E.isArray=W;E.isPlainObject=f;E.isEmptyObject=function(a){for(var b in a)return!1;return!0};E.isNumeric=function(a){var b=Number(a),f=typeof a;
...
this.nodeType&&a.split(" ").forEach(function(a){this.removeAttribute(a)},this)})},prop:function(a,b){a=ea[a]||a;return 1 in arguments?this.each(function(f){this[a]=v(this,b,f,this[a])}):this[0]&&this[0][a]},removeProp:function(a){a=ea[a]||a;return this.each(function(){delete this[a]})},data:function(a,b){var f="data-"+a.replace(N,"-$1").toLowerCase();f=1 in arguments?this.attr(f,b):this.attr(f);return null!==f?B(f):z},val:function(a){return 0 in arguments?(null==a&&(a=""),this.each(function(b){this.value=
...
function(a){return a[0].toUpperCase()});E.fn[a]=function(f){var c,g=this[0];return f===z?d(g)?g["inner"+b]:null!=g&&g.nodeType==g.DOCUMENT_NODE?g.documentElement["scroll"+b]:(c=this.offset())&&c[a]:this.each(function(b){g=E(this);g.css(a,v(this,f,b,g[a]()))})}});["after","prepend","before","append"].forEach(function(f,c){var g=c%2;E.fn[f]=function(){var f,d=E.map(arguments,function(a){var c=[];f=b(a);return"array"==f?(a.forEach(function(a){if(a.nodeType!==z)return c.push(a);if(E.zepto.isZ(a))return c=
c.concat(a.get());c=c.concat(L.fragment(a))}),c):"object"==f||null==a?a:L.fragment(a)}),l,m=1<this.length;return 1>d.length?this:this.each(function(b,f){l=g?f:f.parentNode;f=0==c?f.nextSibling:1==c?f.firstChild:2==c?f:null;var p=E.contains(D.documentElement,l);d.forEach(function(b){if(m)b=b.cloneNode(!0);else if(!l)return E(b).remove();l.insertBefore(b,f);p&&x(b,function(b){if(!(null==b.nodeName||"SCRIPT"!==b.nodeName.toUpperCase()||b.type&&"text/javascript"!==b.type||b.src)){var f=b.ownerDocument?
b.ownerDocument.defaultView:a;f.eval.call(f,b.innerHTML)}})})})};E.fn[g?f+"To":"insert"+(c?"Before":"After")]=function(a){E(a)[f](this);return this}});L.Z.prototype=u.prototype=E.fn;L.uniq=fa;L.deserializeValue=B;E.zepto=L;return E}();(function(b){function c(a){return a._zid||(a._zid=r++)}function d(a,b,f,d){b=g(b);if(b.ns)var l=new RegExp("(?:^| )"+b.ns.replace(" "," .* ?")+"(?: |$)");return(v[c(a)]||[]).filter(function(a){return a&&(!b.e||a.e==b.e)&&(!b.ns||l.test(a.ns))&&(!f||c(a.fn)===c(f))&&
(!d||a.sel==d)})}function g(a){a=(""+a).split(".");return{e:a[0],ns:a.slice(1).sort().join(" ")}}function f(a){return z[a]||B&&x[a]||a}function l(a,d,l,p,e,h,q){var n=c(a),r=v[n]||(v[n]=[]);d.split(/\s/).forEach(function(c){if("ready"==c)return b(document).ready(l);var d=g(c);d.fn=l;d.sel=e;d.e in z&&(l=function(a){var f=a.relatedTarget;if(!f||f!==this&&!b.contains(this,f))return d.fn.apply(this,arguments)});var n=(d.del=h)||l;d.proxy=function(b){b=m(b);if(!b.isImmediatePropagationStopped()){try{var f=
Object.getOwnPropertyDescriptor(b,"data");if(!f||f.writable)b.data=p}catch(Z){}f=n.apply(a,b._args==t?[b]:[b].concat(b._args));!1===f&&(b.preventDefault(),b.stopPropagation());return f}};d.i=r.length;r.push(d);"addEventListener"in a&&a.addEventListener(f(d.e),d.proxy,d.del&&!B&&d.e in x||!!q)})}function e(a,b,g,l,p){var m=c(a);(b||"").split(/\s/).forEach(function(b){d(a,b,g,l).forEach(function(b){delete v[m][b.i];"removeEventListener"in a&&a.removeEventListener(f(b.e),b.proxy,b.del&&!B&&b.e in x||
!!p)})})}function m(a,f){if(f||!a.isDefaultPrevented)if(f||(f=a),b.each(M,function(b,c){var g=f[b];a[b]=function(){this[c]=C;return g&&g.apply(f,arguments)};a[c]=k}),a.timeStamp||(a.timeStamp=Date.now()),f.defaultPrevented!==t?f.defaultPrevented:"returnValue"in f?!1===f.returnValue:f.getPreventDefault&&f.getPreventDefault())a.isDefaultPrevented=C;return a}function p(a){var b,f={originalEvent:a};for(b in a)I.test(b)||a[b]===t||(f[b]=a[b]);return m(f,a)}var r=1,t,u=Array.prototype.slice,y=b.isFunction,
w=function(a){return"string"==typeof a},v={},A={},B="onfocusin"in a,x={focus:"focusin",blur:"focusout"},z={mouseenter:"mouseover",mouseleave:"mouseout"};A.click=A.mousedown=A.mouseup=A.mousemove="MouseEvents";b.event={add:l,remove:e};b.proxy=function(a,f){var g=2 in arguments&&u.call(arguments,2);if(y(a)){var d=function(){return a.apply(f,g?g.concat(u.call(arguments)):arguments)};d._zid=c(a);return d}if(w(f))return g?(g.unshift(a[f],a),b.proxy.apply(null,g)):b.proxy(a[f],a);throw new TypeError("expected function");
...
f)};b.fn.live=function(a,f){b(document.body).delegate(this.selector,a,f);return this};b.fn.die=function(a,f){b(document.body).undelegate(this.selector,a,f);return this};b.fn.on=function(a,f,c,g,d){var m,h,q=this;if(a&&!w(a))return b.each(a,function(a,b){q.on(a,f,c,b,d)}),q;w(f)||y(g)||!1===g||(g=c,c=f,f=t);if(g===t||!1===c)g=c,c=t;!1===g&&(g=k);return q.each(function(q,n){d&&(m=function(a){e(n,a.type,g);return g.apply(this,arguments)});f&&(h=function(a){var c=b(a.target).closest(f,n).get(0);if(c&&
c!==n){var d=b.extend(p(a),{currentTarget:c,liveFired:n});return(m||g).apply(c,[d].concat(u.call(arguments,1)))}});l(n,a,g,c,f,h||m)})};b.fn.off=function(a,f,c){var g=this;if(a&&!w(a))return b.each(a,function(a,b){g.off(a,f,b)}),g;w(f)||y(c)||!1===c||(c=f,f=t);!1===c&&(c=k);return g.each(function(){e(this,a,c,f)})};b.fn.trigger=function(a,f){a=w(a)||b.isPlainObject(a)?b.Event(a):m(a);a._args=f;return this.each(function(){if(a.type in x&&"function"==typeof this[a.type])this[a.type]();else"dispatchEvent"in
...
e=b("./src/bitap/bitap_matched_indices.js");a.exports=function(a,b,c,h){var f=h.location,g=h.distance;g=void 0===g?100:g;var l=h.threshold,q=h.findAllMatches;q=void 0===q?!1:q;h=h.minMatchCharLength;h=void 0===h?1:h;f=void 0===f?0:f;var n=a.length;l=void 0===l?.6:l;for(var y=a.indexOf(b,f),w=b.length,v=[],A=0;A<n;A+=1)v[A]=0;-1!==y&&(y=d(b,{errors:0,currentLocation:y,expectedLocation:f,distance:g}),l=Math.min(y,l),y=a.lastIndexOf(b,f+w),-1!==y&&(y=d(b,{errors:0,currentLocation:y,expectedLocation:f,
distance:g}),l=Math.min(y,l)));y=-1;A=[];for(var B=1,x=w+n,z=1<<w-1,C=0;C<w;C+=1){for(var k=0,I=x;k<I;)d(b,{errors:C,currentLocation:f+I,expectedLocation:f,distance:g})<=l?k=I:x=I,I=Math.floor((x-k)/2+k);x=I;k=Math.max(1,f-I+1);var M=q?n:Math.min(f+I,n)+w;I=Array(M+2);for(I[M+1]=(1<<C)-1;M>=k;--M){var H=M-1,J=c[a.charAt(H)];J&&(v[H]=1);I[M]=(I[M+1]<<1|1)&J;0!==C&&(I[M]=I[M]|(A[M+1]|A[M])<<1|1|A[M+1]);if(I[M]&z&&(B=d(b,{errors:C,currentLocation:H,expectedLocation:f,distance:g}),B<=l)){l=B;y=H;if(y<=
f)break;k=Math.max(1,2*f-y)}}if(d(b,{errors:C+1,currentLocation:f,expectedLocation:f,distance:g})>l)break;A=I}return{isMatch:0<=y,score:0===B?.001:B,matchedIndices:e(v,h)}}},"./src/bitap/index.js":function(a,c,b){function d(a,b){for(var f=0;f<b.length;f++){var c=b[f];c.enumerable=c.enumerable||!1;c.configurable=!0;"value"in c&&(c.writable=!0);Object.defineProperty(a,c.key,c)}}function e(a,b,f){b&&d(a.prototype,b);f&&d(a,f);return a}var g=b("./src/bitap/bitap_regex_search.js"),f=b("./src/bitap/bitap_search.js"),
...
void 0===d?.6:d;var e=f.maxPatternLength;e=void 0===e?32:e;var m=f.caseSensitive;m=void 0===m?!1:m;var p=f.tokenSeparator;p=void 0===p?/ +/g:p;var h=f.findAllMatches;h=void 0===h?!1:h;var q=f.minMatchCharLength;q=void 0===q?1:q;var n=f.id;n=void 0===n?null:n;var r=f.keys;r=void 0===r?[]:r;var k=f.shouldSort;k=void 0===k?!0:k;var I=f.getFn;I=void 0===I?l:I;var M=f.sortFn;M=void 0===M?function(a,b){return a.score-b.score}:M;var H=f.tokenize;H=void 0===H?!1:H;var J=f.matchAllTokens;J=void 0===J?!1:J;
var D=f.includeMatches;D=void 0===D?!1:D;var T=f.includeScore;T=void 0===T?!1:T;f=f.verbose;f=void 0===f?!1:f;if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.options={location:c,distance:g,threshold:d,maxPatternLength:e,isCaseSensitive:m,tokenSeparator:p,findAllMatches:h,minMatchCharLength:q,id:n,keys:r,includeMatches:D,includeScore:T,shouldSort:k,getFn:I,sortFn:M,verbose:f,tokenize:H,matchAllTokens:J};this.setCollection(b)}g(a,[{key:"setCollection",value:function(a){return this.list=
...
for(var r=[],k=0;k<l.length;k+=1){var M=l[k];this._log('\nPattern: "'.concat(M.pattern,'"'));for(var H=!1,J=0;J<p.length;J+=1){var D=p[J],T=M.search(D),R={};T.isMatch?(R[D]=T.score,H=h=!0,r.push(T.score)):(R[D]=1,this.options.matchAllTokens||r.push(1));this._log('Token: "'.concat(D,'", score: ').concat(R[D]))}H&&(n+=1)}p=r[0];k=r.length;for(M=1;M<k;M+=1)p+=r[M];p/=k;this._log("Token score average:",p)}r=m.score;-1<p&&(r=(r+p)/2);this._log("Score average:",r);l=this.options.tokenize&&this.options.matchAllTokens?
n>=l.length:!0;this._log("\nCheck Matches: ".concat(l));(h||m.isMatch)&&l&&((l=e[a])?l.output.push({key:f,arrayIndex:g,value:c,score:r,matchedIndices:m.matchedIndices}):(e[a]={item:d,output:[{key:f,arrayIndex:g,value:c,score:r,matchedIndices:m.matchedIndices}]},b.push(e[a])))}else if(q(c))for(g=0,h=c.length;g<h;g+=1)this._analyze({key:f,arrayIndex:g,value:c[g],record:d,index:a},{resultMap:e,results:b,tokenSearchers:l,fullSearcher:m})}}},{key:"_computeScore",value:function(a,b){this._log("\n\nComputing score:\n");
...
b,f){b=b.prototype;var c=a.prototype=Object.create(b);c.constructor=a;c._super=b;f&&la(c,f)}function m(a,b){return function(){return a.apply(b,arguments)}}function p(a,b){return"function"==typeof a?a.apply(b?b[0]||h:h,b):a}function r(a,b,c){f(y(b),function(b){a.addEventListener(b,c,!1)})}function t(a,b,c){f(y(b),function(b){a.removeEventListener(b,c,!1)})}function u(a,b){for(;a;){if(a==b)return!0;a=a.parentNode}return!1}function y(a){return a.trim().split(/\s+/g)}function w(a,b,f){if(a.indexOf&&!f)return a.indexOf(b);
for(var c=0;c<a.length;){if(f&&a[c][f]==b||!f&&a[c]===b)return c;c++}return-1}function v(a){return Array.prototype.slice.call(a,0)}function k(a,b,f){for(var c=[],g=[],d=0;d<a.length;){var l=b?a[d][b]:a[d];0>w(g,l)&&c.push(a[d]);g[d]=l;d++}f&&(c=b?c.sort(function(a,f){return a[b]>f[b]}):c.sort());return c}function B(a,b){for(var f,c=b[0].toUpperCase()+b.slice(1),g=0;g<ia.length;){f=(f=ia[g])?f+c:b;if(f in a)return f;g++}return h}function x(b){b=b.ownerDocument||b;return b.defaultView||b.parentWindow||
a}function z(a,b){var f=this;this.manager=a;this.callback=b;this.element=a.element;this.target=a.options.inputTarget;this.domHandler=function(b){p(a.options.enable,[a])&&f.handler(b)};this.init()}function C(a){var b=a.options.inputClass;return new (b?b:Aa?R:Ba?Q:ra?aa:T)(a,S)}function S(a,b,f){var c=f.pointers.length,g=f.changedPointers.length;var d=b&1&&0===c-g;f.isFirst=!!d;f.isFinal=!!(b&12&&0===c-g);d&&(a.session={});f.eventType=b;b=a.session;c=f.pointers;g=c.length;b.firstInput||(b.firstInput=
I(f));1<g&&!b.firstMultiple?b.firstMultiple=I(f):1===g&&(b.firstMultiple=!1);d=b.firstInput;var l=(g=b.firstMultiple)?g.center:d.center;var e=f.center=M(c);f.timeStamp=pa();f.deltaTime=f.timeStamp-d.timeStamp;f.angle=D(l,e);f.distance=J(l,e);d=f.center;l=b.offsetDelta||{};e=b.prevDelta||{};var m=b.prevInput||{};if(1===f.eventType||4===m.eventType)e=b.prevDelta={x:m.deltaX||0,y:m.deltaY||0},l=b.offsetDelta={x:d.x,y:d.y};f.deltaX=e.x+(d.x-l.x);f.deltaY=e.y+(d.y-l.y);f.offsetDirection=H(f.deltaX,f.deltaY);
...
deltaY:a.deltaY}}function M(a){var b=a.length;if(1===b)return{x:ka(a[0].clientX),y:ka(a[0].clientY)};for(var f=0,c=0,g=0;g<b;)f+=a[g].clientX,c+=a[g].clientY,g++;return{x:ka(f/b),y:ka(c/b)}}function H(a,b){return a===b?1:ja(a)>=ja(b)?0>a?2:4:0>b?8:16}function J(a,b,f){f||(f=sa);var c=b[f[0]]-a[f[0]];a=b[f[1]]-a[f[1]];return Math.sqrt(c*c+a*a)}function D(a,b,f){f||(f=sa);return 180*Math.atan2(b[f[1]]-a[f[1]],b[f[0]]-a[f[0]])/Math.PI}function T(){this.evEl=Ca;this.evWin=Da;this.pressed=!1;z.apply(this,
arguments)}function R(){this.evEl=ta;this.evWin=ua;z.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function G(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;z.apply(this,arguments)}function Q(){this.evTarget=Ea;this.targetIds={};z.apply(this,arguments)}function da(a,b){var f=v(a.touches),c=this.targetIds;if(b&3&&1===f.length)return c[f[0].identifier]=!0,[f,f];a=v(a.changedTouches);var g=[],d=this.target;var l=f.filter(function(a){return u(a.target,
d)});if(1===b)for(f=0;f<l.length;)c[l[f].identifier]=!0,f++;for(f=0;f<a.length;)c[a[f].identifier]&&g.push(a[f]),b&12&&delete c[a[f].identifier],f++;if(g.length)return[k(l.concat(g),"identifier",!0),g]}function aa(){z.apply(this,arguments);var a=m(this.handler,this);this.touch=new Q(this.manager,a);this.mouse=new T(this.manager,a);this.primaryTouch=null;this.lastTouches=[]}function F(a){a=a.changedPointers[0];if(a.identifier===this.primaryTouch){var b={x:a.clientX,y:a.clientY};this.lastTouches.push(b);
...
za=/mobile|tablet|ip(ad|hone|od)|android/i,ra="ontouchstart"in a,Aa=B(a,"PointerEvent")!==h,Ba=ra&&za.test(navigator.userAgent),sa=["x","y"],na=["clientX","clientY"];z.prototype={handler:function(){},init:function(){this.evEl&&r(this.element,this.evEl,this.domHandler);this.evTarget&&r(this.target,this.evTarget,this.domHandler);this.evWin&&r(x(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&t(this.element,this.evEl,this.domHandler);this.evTarget&&t(this.target,this.evTarget,
this.domHandler);this.evWin&&t(x(this.element),this.evWin,this.domHandler)}};var Fa={mousedown:1,mousemove:2,mouseup:4},Ca="mousedown",Da="mousemove mouseup";q(T,z,{handler:function(a){var b=Fa[a.type];b&1&&0===a.button&&(this.pressed=!0);b&2&&1!==a.which&&(b=4);this.pressed&&(b&4&&(this.pressed=!1),this.callback(this.manager,b,{pointers:[a],changedPointers:[a],pointerType:"mouse",srcEvent:a}))}});var Ga={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},Ha={2:"touch",3:"pen",
4:"mouse",5:"kinect"},ta="pointerdown",ua="pointermove pointerup pointercancel";a.MSPointerEvent&&!a.PointerEvent&&(ta="MSPointerDown",ua="MSPointerMove MSPointerUp MSPointerCancel");q(R,z,{handler:function(a){var b=this.store,f=!1,c=a.type.toLowerCase().replace("ms","");c=Ga[c];var g=Ha[a.pointerType]||a.pointerType,d="touch"==g,l=w(b,a.pointerId,"pointerId");c&1&&(0===a.button||d)?0>l&&(b.push(a),l=b.length-1):c&12&&(f=!0);0>l||(b[l]=a,this.callback(this.manager,c,{pointers:b,changedPointers:[a],
...
enable:!0,inputTarget:null,inputClass:null,preset:[[P,{enable:!1}],[Y,{enable:!1},["rotate"]],[ea,{direction:6}],[V,{direction:6},["swipe"]],[W],[W,{event:"doubletap",taps:2},["tap"]],[L]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};fa.prototype={set:function(a){la(this.options,a);a.touchAction&&this.touchAction.update();a.inputTarget&&(this.input.destroy(),this.input.target=a.inputTarget,this.input.init());
...
window:{})},{}],27:[function(a,e,k){k.test=function(){return!0};k.install=function(a){return function(){setTimeout(a,0)}}},{}],28:[function(a,e,k){function d(a){c(a.pixel_x,a.pixel_y,!0)}function c(a,b,f,c){void 0===f&&(f=!0);void 0===c&&(c=M.marker_id);a=[Number(a),3575-Number(b)];b=H.getOverlayById(c);null!==b?b.setPosition(a):(b=document.getElementById(c),c=new p.default({id:c,position:a,positioning:"bottom-center",element:b,stopEvent:!1,offset:[0,0]}),H.addOverlay(c));f&&(J.animate({center:a}),
J.animate({zoom:4.5}))}function b(){var a=new t.default({url:M.mapPath,attributions:Q,projection:G,imageExtent:R}),b=new Image;b.src=M.mapPath;b.onload=function(){T.setSource(a)}}function h(){return navigator.geolocation?!0:!1}function n(a){null!=F&&c(F.pixel_x,F.pixel_y,a,M.user_marker_id)}function g(a){var b=1E3*(a.coords.latitude-19.133691);a=1E3*(a.coords.longitude-72.916984);var f=O,c=Math.round(4189+f[0]+f[1]*b+f[2]*a+f[3]*b*b+f[4]*b*b*a+f[5]*b*b*a*a+f[6]*a*a+f[7]*b*a*a+f[8]*b*a);f=K;return{pixel_x:c,
pixel_y:Math.round(1655+f[0]+f[1]*b+f[2]*a+f[3]*b*b+f[4]*b*b*a+f[5]*b*b*a*a+f[6]*a*a+f[7]*b*a*a+f[8]*b*a)}}e=this&&this.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(k,"__esModule",{value:!0});var f=e(a("ol/map")),l=e(a("ol/layer/image")),q=e(a("ol/view")),m=e(a("ol/extent")),p=e(a("ol/overlay")),r=e(a("ol/layer/vector")),t=e(a("ol/source/imagestatic")),u=e(a("ol/source/vector")),y=e(a("ol/proj/projection")),w=e(a("ol/feature")),v=e(a("ol/geom/point")),A=
e(a("ol/geom/polygon")),B=e(a("ol/style/style")),x=e(a("ol/style/icon")),z=e(a("ol/style/text")),C=e(a("ol/style/stroke")),S=e(a("ol/style/fill")),I=e(a("ol/interaction")),M,H,J,D,T,R,G,Q,da=!1,aa,F,N=!1,O=[-7.769917472065843,159.26978694839946,244.46989575495544,-6.003894110679995,-.28864271213341297,.010398324019718075,4.215508849724247,-.6078830146963545,-7.0400449629241395],K=[14.199431377059842,-158.80601990819815,68.9630034040724,5.796703402034644,1.1348242200568706,.11891051684489184,-.2930832938484276,
.1448231125788526,-5.282895700923075];k.getMap=function(a,g,e,h){M=a;for(var p=[],n=0;n<g.length;n++){var k=g[n],F=[k.pixel_x,3575-k.pixel_y];null===k.parent&&(k=new w.default({geometry:new v.default(F),loc:k}),p.push(k))}g=new u.default({features:p});D=new r.default({source:g,style:function(a){var b=H.getView().getZoom(),f=a.get("loc");if(3!==f.group_id||N)return a=f.name,"0"!==f.short_name&&(a=f.short_name),f=1===f.group_id||4===f.group_id||12===f.group_id?"blue":3===f.group_id?"green":2===f.group_id?
"yellow":"gray",a=new z.default({offsetY:20,padding:[20,20,20,20],font:3*b+"px Roboto",text:a,fill:new S.default({color:"#ffffff"}),stroke:new C.default({color:"#444",width:3})}),f=new x.default({src:M.markersBase+"marker_dot_"+f+".png",scale:.2}),[new B.default({image:3<=b?f:void 0,text:4<=b?a:void 0})]}});R=[0,0,5430,3575];G=new y.default({code:"instiMAP",units:"pixels",extent:R});a=new t.default({url:a.mapMinPath,attributions:Q,projection:G,imageExtent:R,imageLoadFunction:function(a,f){a=a.getImage();
a.src=f;a.onload=function(){b();h()}}});T=new l.default({source:a});a=I.default.defaults({altShiftDragRotate:!1,pinchRotate:!1});J=new q.default({projection:G,center:m.default.getCenter(R),zoom:3.4,minZoom:2,maxZoom:5.5,extent:[300,300,5E3,3E3]});H=new f.default({interactions:a,layers:[T,D],target:M.map_id,view:J,controls:[]});H.on("click",function(a){var b=a.pixel;a=[b[0]+30,b[1]-30];b=H.getCoordinateFromPixel([b[0]-30,b[1]+30]);a=H.getCoordinateFromPixel(a).concat(b);a=new w.default(new A.default([[[a[0],
a[1]],[a[0],a[3]],[a[2],a[3]],[a[2],a[1]],[a[0],a[1]]]]));(a=D.getSource().forEachFeatureIntersectingExtent(a.getGeometry().getExtent(),function(a){return a}))?(a=a.get("loc"),d(a),e(a)):(c(-50,-50,!1),e())});H.on("pointermove",function(a){a=H.getEventPixel(a.originalEvent);a=H.hasFeatureAtPixel(a);var b=document.getElementById(M.map_id);null!=b&&(b.style.cursor=a?"pointer":"move")});H.on("pointerdrag",function(){da=!1});return H};k.moveToLocation=d;k.moveMarker=c;k.setResidencesVisible=function(a){N=
a;D.getSource().changed()};k.hasGeolocation=h;k.getGPS=function(a){h()?(da=!0,null!=aa?n(!0):aa=navigator.geolocation.watchPosition(function(a){var b=da||null==F;a=g(a);0<a.pixel_x&&0<a.pixel_y&&5430>a.pixel_x&&5375>a.pixel_y&&(F=a,n(b))},function(){},{enableHighAccuracy:!0})):a&&a()};k.getMapXY=g;k.isFollowingUser=function(){return da};k.getGeolocationLast=function(){return F};k.cleanup=function(){null!=aa&&void 0!=aa&&navigator.geolocation.clearWatch(aa)}},{"ol/extent":54,"ol/feature":57,"ol/geom/point":81,
"ol/geom/polygon":82,"ol/interaction":90,"ol/layer/image":107,"ol/layer/vector":110,"ol/map":115,"ol/overlay":128,"ol/proj/projection":145,"ol/source/imagestatic":210,"ol/source/vector":213,"ol/style/fill":225,"ol/style/icon":226,"ol/style/stroke":233,"ol/style/style":234,"ol/style/text":235,"ol/view":245}],29:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={binarySearch:function(a,b,e){for(var c,g=e||d.numberSafeCompareFunction,f=0,l=a.length,h=!1;f<l;)e=f+(l-f>>1),c=+g(a[e],
b),0>c?f=e+1:(l=e,h=!c);return h?f:~f},numberSafeCompareFunction:function(a,b){return a>b?1:a<b?-1:0},includes:function(a,b){return 0<=a.indexOf(b)},linearFindNearest:function(a,b,d){var c=a.length;if(a[0]<=b)return 0;if(!(b<=a[c-1]))if(0<d)for(d=1;d<c;++d){if(a[d]<b)return d-1}else if(0>d)for(d=1;d<c;++d){if(a[d]<=b)return d}else for(d=1;d<c;++d){if(a[d]==b)return d;if(a[d]<b)return a[d-1]-b<b-a[d]?d-1:d}return c-1},reverseSubArray:function(a,b,d){for(;b<d;){var c=a[b];a[b]=a[d];a[d]=c;++b;--d}},
extend:function(a,b){var c=Array.isArray(b)?b:[b],d=c.length;for(b=0;b<d;b++)a[a.length]=c[b]},remove:function(a,b){b=a.indexOf(b);var c=-1<b;c&&a.splice(b,1);return c},find:function(a,b){for(var c=a.length>>>0,d,g=0;g<c;g++)if(d=a[g],b(d,g,a))return d;return null},equals:function(a,b){var c=a.length;if(c!==b.length)return!1;for(var d=0;d<c;d++)if(a[d]!==b[d])return!1;return!0},stableSort:function(a,b){var c=a.length,d=Array(a.length),g;for(g=0;g<c;g++)d[g]={index:g,value:a[g]};d.sort(function(a,
c){return b(a.value,c.value)||a.index-c.index});for(g=0;g<a.length;g++)a[g]=d[g].value},findIndex:function(a,b){var c;return a.every(function(d,g){c=g;return!b(d,g,a)})?-1:c},isSorted:function(a,b,e){var c=b||d.numberSafeCompareFunction;return a.every(function(b,f){if(0===f)return!0;b=c(a[f-1],b);return!(0<b||e&&0===b)})}};k.default=d},{}],30:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./index.js"))&&a.__esModule?a:{default:a};a=function(a){this.message="Assertion failed. See https://openlayers.org/en/"+
(d.default.VERSION?d.default.VERSION.split("-")[0]:"latest")+"/doc/errors/#"+a+" for details.";this.code=a;this.name="AssertionError"};d.default.inherits(a,Error);k.default=a},{"./index.js":89}],31:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./assertionerror.js"))&&a.__esModule?a:{default:a};k.default={assert:function(a,b){if(!a)throw new d.default(b);}}},{"./assertionerror.js":30}],32:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,
"__esModule",{value:!0});e=a("./tilerange.js");var c=d(e);e=a("./math.js");var b=d(e);a=a("./tilegrid.js");var h=d(a);a=function(a){this.html_=a.html;this.tileRanges_=a.tileRanges?a.tileRanges:null};a.prototype.getHTML=function(){return this.html_};a.prototype.intersectsAnyTileRange=function(a,g,f){if(!this.tileRanges_)return!0;var d,e;for(e in a)if(e in this.tileRanges_){var m=a[e];var p=0;for(d=this.tileRanges_[e].length;p<d;++p){var n=this.tileRanges_[e][p];if(n.intersects(m))return!0;var t=g.getTileRangeForExtentAndZ(h.default.extentFromProjection(f),
parseInt(e,10)),u=t.getWidth();if(m.minX<t.minX||m.maxX>t.maxX)if(n.intersects(new c.default(b.default.modulo(m.minX,u),b.default.modulo(m.maxX,u),m.minY,m.maxY))||m.getWidth()>u&&n.intersects(t))return!0}}return!1};k.default=a},{"./math.js":123,"./tilegrid.js":238,"./tilerange.js":241}],33:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./math.js"))&&a.__esModule?a:{default:a};k.default={createExtent:function(a){return function(b){if(b)return[d.default.clamp(b[0],a[0],
a[2]),d.default.clamp(b[1],a[1],a[3])]}},none:function(a){return a}}},{"./math.js":123}],34:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./assertionerror.js"),b=d(c);c=a("./collectioneventtype.js");var h=d(c);c=a("./object.js");var n=d(c);a=a("./events/event.js");var g=d(a),f=function(a,b){n.default.call(this);this.unique_=!!(b||{}).unique;this.array_=a?a:[];if(this.unique_)for(a=0,b=this.array_.length;a<
b;++a)this.assertUnique_(this.array_[a],a);this.updateLength_()};e.default.inherits(f,n.default);f.prototype.clear=function(){for(;0<this.getLength();)this.pop()};f.prototype.extend=function(a){var b;var f=0;for(b=a.length;f<b;++f)this.push(a[f]);return this};f.prototype.forEach=function(a,b){a=b?a.bind(b):a;b=this.array_;for(var f=0,c=b.length;f<c;++f)a(b[f],f,b)};f.prototype.getArray=function(){return this.array_};f.prototype.item=function(a){return this.array_[a]};f.prototype.getLength=function(){return this.get(f.Property_.LENGTH)};
f.prototype.insertAt=function(a,b){this.unique_&&this.assertUnique_(b);this.array_.splice(a,0,b);this.updateLength_();this.dispatchEvent(new f.Event(h.default.ADD,b))};f.prototype.pop=function(){return this.removeAt(this.getLength()-1)};f.prototype.push=function(a){this.unique_&&this.assertUnique_(a);var b=this.getLength();this.insertAt(b,a);return this.getLength()};f.prototype.remove=function(a){var b=this.array_,f;var c=0;for(f=b.length;c<f;++c)if(b[c]===a)return this.removeAt(c)};f.prototype.removeAt=
function(a){var b=this.array_[a];this.array_.splice(a,1);this.updateLength_();this.dispatchEvent(new f.Event(h.default.REMOVE,b));return b};f.prototype.setAt=function(a,b){var c=this.getLength();if(a<c)this.unique_&&this.assertUnique_(b,a),c=this.array_[a],this.array_[a]=b,this.dispatchEvent(new f.Event(h.default.REMOVE,c)),this.dispatchEvent(new f.Event(h.default.ADD,b));else{for(;c<a;++c)this.insertAt(c,void 0);this.insertAt(a,b)}};f.prototype.updateLength_=function(){this.set(f.Property_.LENGTH,
this.array_.length)};f.prototype.assertUnique_=function(a,f){for(var c=0,g=this.array_.length;c<g;++c)if(this.array_[c]===a&&c!==f)throw new b.default(58);};f.Property_={LENGTH:"length"};f.Event=function(a,b){g.default.call(this,a);this.element=b};e.default.inherits(f.Event,g.default);k.default=f},{"./assertionerror.js":30,"./collectioneventtype.js":35,"./events/event.js":50,"./index.js":89,"./object.js":125}],35:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={ADD:"add",
REMOVE:"remove"}},{}],36:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(e=a("./asserts.js"))&&e.__esModule?e:{default:e},c=(a=a("./math.js"))&&a.__esModule?a:{default:a},b={HEX_COLOR_RE_:/^#(?:[0-9a-f]{3,4}){1,2}$/i,NAMED_COLOR_RE_:/^([a-z]*)$/i,asArray:function(a){return Array.isArray(a)?a:b.fromString(a)},asString:function(a){return"string"===typeof a?a:b.toString(a)},fromNamed:function(a){var b=document.createElement("div");b.style.color=a;document.body.appendChild(b);
a=getComputedStyle(b).color;document.body.removeChild(b);return a}};b.fromString=function(){var a={},c=0;return function(g){if(a.hasOwnProperty(g))var f=a[g];else{if(1024<=c){f=0;for(var d in a)0===(f++&3)&&(delete a[d],--c)}f=b.fromStringInternal_(g);a[g]=f;++c}return f}}();b.fromStringInternal_=function(a){b.NAMED_COLOR_RE_.exec(a)&&(a=b.fromNamed(a));if(b.HEX_COLOR_RE_.exec(a)){var c=a.length-1;var g=4>=c?1:2;var f=4===c||8===c;c=parseInt(a.substr(1+0*g,g),16);var e=parseInt(a.substr(1+1*g,g),
16);var h=parseInt(a.substr(1+2*g,g),16);a=f?parseInt(a.substr(1+3*g,g),16):255;1==g&&(c=(c<<4)+c,e=(e<<4)+e,h=(h<<4)+h,f&&(a=(a<<4)+a));g=[c,e,h,a/255]}else 0==a.indexOf("rgba(")?(a=a.slice(5,-1).split(",").map(Number),g=b.normalize(a)):0==a.indexOf("rgb(")?(a=a.slice(4,-1).split(",").map(Number),a.push(1),g=b.normalize(a)):d.default.assert(!1,14);return g};b.normalize=function(a,b){b=b||[];b[0]=c.default.clamp(a[0]+.5|0,0,255);b[1]=c.default.clamp(a[1]+.5|0,0,255);b[2]=c.default.clamp(a[2]+.5|0,
0,255);b[3]=c.default.clamp(a[3],0,1);return b};b.toString=function(a){var b=a[0];b!=(b|0)&&(b=b+.5|0);var c=a[1];c!=(c|0)&&(c=c+.5|0);var f=a[2];f!=(f|0)&&(f=f+.5|0);return"rgba("+b+","+c+","+f+","+(void 0===a[3]?1:a[3])+")"};k.default=b},{"./asserts.js":31,"./math.js":123}],37:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./color.js"))&&a.__esModule?a:{default:a},c={asColorLike:function(a){return c.isColorLike(a)?a:d.default.asString(a)},isColorLike:function(a){return"string"===
typeof a||a instanceof CanvasPattern||a instanceof CanvasGradient}};k.default=c},{"./color.js":36}],38:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./collection.js");var c=d(e);e=a("./control/attribution.js");var b=d(e);e=a("./control/rotate.js");var h=d(e);a=a("./control/zoom.js");var n=d(a);k.default={defaults:function(a){a=a?a:{};var f=new c.default;(void 0!==a.zoom?a.zoom:1)&&f.push(new n.default(a.zoomOptions));(void 0!==
a.rotate?a.rotate:1)&&f.push(new h.default(a.rotateOptions));(void 0!==a.attribution?a.attribution:1)&&f.push(new b.default(a.attributionOptions));return f}}},{"./collection.js":34,"./control/attribution.js":39,"./control/rotate.js":41,"./control/zoom.js":42}],39:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../array.js"),b=d(c);c=a("../control/control.js");var h=d(c);c=a("../css.js");var n=d(c);
c=a("../dom.js");var g=d(c);c=a("../events.js");var f=d(c);c=a("../events/eventtype.js");var l=d(c);c=a("../layer/layer.js");var q=d(c);a=a("../obj.js");var m=d(a),p=function(a){a=a?a:{};this.ulElement_=document.createElement("UL");this.logoLi_=document.createElement("LI");this.ulElement_.appendChild(this.logoLi_);this.logoLi_.style.display="none";this.collapsed_=void 0!==a.collapsed?a.collapsed:!0;this.collapsible_=void 0!==a.collapsible?a.collapsible:!0;this.collapsible_||(this.collapsed_=!1);var b=
void 0!==a.className?a.className:"ol-attribution",c=void 0!==a.tipLabel?a.tipLabel:"Attributions",g=void 0!==a.collapseLabel?a.collapseLabel:"\u00bb";"string"===typeof g?(this.collapseLabel_=document.createElement("span"),this.collapseLabel_.textContent=g):this.collapseLabel_=g;g=void 0!==a.label?a.label:"i";"string"===typeof g?(this.label_=document.createElement("span"),this.label_.textContent=g):this.label_=g;var d=this.collapsible_&&!this.collapsed_?this.collapseLabel_:this.label_;g=document.createElement("button");
g.setAttribute("type","button");g.title=c;g.appendChild(d);f.default.listen(g,l.default.CLICK,this.handleClick_,this);b=b+" "+n.default.CLASS_UNSELECTABLE+" "+n.default.CLASS_CONTROL+(this.collapsed_&&this.collapsible_?" ol-collapsed":"")+(this.collapsible_?"":" ol-uncollapsible");c=document.createElement("div");c.className=b;c.appendChild(this.ulElement_);c.appendChild(g);h.default.call(this,{element:c,render:a.render?a.render:p.render,target:a.target});this.renderedAttributions_=[];this.renderedVisible_=
!0;this.logoElements_={}};e.default.inherits(p,h.default);p.prototype.getSourceAttributions_=function(a){for(var b={},f=[],c=a.layerStatesArray,g=a.viewState.resolution,d=0,e=c.length;d<e;++d){var l=c[d];if(q.default.visibleAtResolution(l,g)&&(l=l.layer.getSource())&&(l=l.getAttributions2())&&(l=l(a)))if(Array.isArray(l))for(var m=0,p=l.length;m<p;++m)l[m]in b||(f.push(l[m]),b[l[m]]=!0);else l in b||(f.push(l),b[l]=!0)}return f};p.render=function(a){this.updateElement_(a.frameState)};p.prototype.updateElement_=
function(a){if(a){var f=this.getSourceAttributions_(a);if(!b.default.equals(f,this.renderedAttributions_)){for(;this.ulElement_.lastChild!==this.logoLi_;)this.ulElement_.removeChild(this.ulElement_.lastChild);for(var c=0,g=f.length;c<g;++c){var d=document.createElement("LI");d.innerHTML=f[c];this.ulElement_.appendChild(d)}0===f.length&&0<this.renderedAttributions_.length?this.element.classList.add("ol-logo-only"):0===this.renderedAttributions_.length&&0<f.length&&this.element.classList.remove("ol-logo-only");
c=0<f.length||!m.default.isEmpty(a.logos);this.renderedVisible_!=c&&(this.element.style.display=c?"":"none",this.renderedVisible_=c);this.renderedAttributions_=f;this.insertLogos_(a)}}else this.renderedVisible_&&(this.element.style.display="none",this.renderedVisible_=!1)};p.prototype.insertLogos_=function(a){a=a.logos;var b=this.logoElements_;for(d in b)d in a||(g.default.removeNode(b[d]),delete b[d]);var f;for(f in a){var c=a[f];c instanceof HTMLElement&&(this.logoLi_.appendChild(c),b[f]=c);if(!(f in
b)){var d=new Image;d.src=f;if(""===c)var e=d;else e=document.createElement("a"),e.href=c,e.appendChild(d);this.logoLi_.appendChild(e);b[f]=e}}this.logoLi_.style.display=m.default.isEmpty(a)?"none":""};p.prototype.handleClick_=function(a){a.preventDefault();this.handleToggle_()};p.prototype.handleToggle_=function(){this.element.classList.toggle("ol-collapsed");this.collapsed_?g.default.replaceNode(this.collapseLabel_,this.label_):g.default.replaceNode(this.label_,this.collapseLabel_);this.collapsed_=
!this.collapsed_};p.prototype.getCollapsible=function(){return this.collapsible_};p.prototype.setCollapsible=function(a){this.collapsible_!==a&&(this.collapsible_=a,this.element.classList.toggle("ol-uncollapsible"),!a&&this.collapsed_&&this.handleToggle_())};p.prototype.setCollapsed=function(a){this.collapsible_&&this.collapsed_!==a&&this.handleToggle_()};p.prototype.getCollapsed=function(){return this.collapsed_};k.default=p},{"../array.js":29,"../control/control.js":40,"../css.js":44,"../dom.js":46,
"../events.js":48,"../events/eventtype.js":52,"../index.js":89,"../layer/layer.js":108,"../obj.js":124}],40:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");var c=d(e);e=a("../mapeventtype.js");var b=d(e);e=a("../object.js");var h=d(e);e=a("../dom.js");var n=d(e);a=a("../events.js");var g=d(a);a=function(a){h.default.call(this);this.element=a.element?a.element:null;this.map_=this.target_=null;this.listenerKeys=
[];this.render=a.render?a.render:c.default.nullFunction;a.target&&this.setTarget(a.target)};c.default.inherits(a,h.default);a.prototype.disposeInternal=function(){n.default.removeNode(this.element);h.default.prototype.disposeInternal.call(this)};a.prototype.getMap=function(){return this.map_};a.prototype.setMap=function(a){this.map_&&n.default.removeNode(this.element);for(var f=0,d=this.listenerKeys.length;f<d;++f)g.default.unlistenByKey(this.listenerKeys[f]);this.listenerKeys.length=0;if(this.map_=
a)(this.target_?this.target_:a.getOverlayContainerStopEvent()).appendChild(this.element),this.render!==c.default.nullFunction&&this.listenerKeys.push(g.default.listen(a,b.default.POSTRENDER,this.render,this)),a.render()};a.prototype.setTarget=function(a){this.target_="string"===typeof a?document.getElementById(a):a};k.default=a},{"../dom.js":46,"../events.js":48,"../index.js":89,"../mapeventtype.js":121,"../object.js":125}],41:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,
"__esModule",{value:!0});e=a("../events.js");var c=d(e);e=a("../events/eventtype.js");var b=d(e);e=a("../index.js");e=d(e);var h=a("../control/control.js"),n=d(h);h=a("../css.js");var g=d(h);a=a("../easing.js");var f=d(a),l=function(a){a=a?a:{};var f=void 0!==a.className?a.className:"ol-rotate",d=void 0!==a.label?a.label:"\u21e7";this.label_=null;"string"===typeof d?(this.label_=document.createElement("span"),this.label_.className="ol-compass",this.label_.textContent=d):(this.label_=d,this.label_.classList.add("ol-compass"));
var e=a.tipLabel?a.tipLabel:"Reset rotation";d=document.createElement("button");d.className=f+"-reset";d.setAttribute("type","button");d.title=e;d.appendChild(this.label_);c.default.listen(d,b.default.CLICK,l.prototype.handleClick_,this);e=f+" "+g.default.CLASS_UNSELECTABLE+" "+g.default.CLASS_CONTROL;f=document.createElement("div");f.className=e;f.appendChild(d);d=a.render?a.render:l.render;this.callResetNorth_=a.resetNorth?a.resetNorth:void 0;n.default.call(this,{element:f,render:d,target:a.target});
this.duration_=void 0!==a.duration?a.duration:250;this.autoHide_=void 0!==a.autoHide?a.autoHide:!0;this.rotation_=void 0;this.autoHide_&&this.element.classList.add(g.default.CLASS_HIDDEN)};e.default.inherits(l,n.default);l.prototype.handleClick_=function(a){a.preventDefault();void 0!==this.callResetNorth_?this.callResetNorth_():this.resetNorth_()};l.prototype.resetNorth_=function(){var a=this.getMap().getView();a&&void 0!==a.getRotation()&&(0<this.duration_?a.animate({rotation:0,duration:this.duration_,
easing:f.default.easeOut}):a.setRotation(0))};l.render=function(a){if(a=a.frameState){a=a.viewState.rotation;if(a!=this.rotation_){var b="rotate("+a+"rad)";if(this.autoHide_){var f=this.element.classList.contains(g.default.CLASS_HIDDEN);f||0!==a?f&&0!==a&&this.element.classList.remove(g.default.CLASS_HIDDEN):this.element.classList.add(g.default.CLASS_HIDDEN)}this.label_.style.msTransform=b;this.label_.style.webkitTransform=b;this.label_.style.transform=b}this.rotation_=a}};k.default=l},{"../control/control.js":40,
"../css.js":44,"../easing.js":47,"../events.js":48,"../events/eventtype.js":52,"../index.js":89}],42:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../events.js"),b=d(c);c=a("../events/eventtype.js");var h=d(c);c=a("../control/control.js");var n=d(c);c=a("../css.js");var g=d(c);a=a("../easing.js");var f=d(a),l=function(a){a=a?a:{};var f=void 0!==a.className?a.className:"ol-zoom",c=void 0!==a.delta?
a.delta:1,d=void 0!==a.zoomInLabel?a.zoomInLabel:"+",e=void 0!==a.zoomOutLabel?a.zoomOutLabel:"\u2212",q=void 0!==a.zoomInTipLabel?a.zoomInTipLabel:"Zoom in",y=void 0!==a.zoomOutTipLabel?a.zoomOutTipLabel:"Zoom out",w=document.createElement("button");w.className=f+"-in";w.setAttribute("type","button");w.title=q;w.appendChild("string"===typeof d?document.createTextNode(d):d);b.default.listen(w,h.default.CLICK,l.prototype.handleClick_.bind(this,c));d=document.createElement("button");d.className=f+"-out";
d.setAttribute("type","button");d.title=y;d.appendChild("string"===typeof e?document.createTextNode(e):e);b.default.listen(d,h.default.CLICK,l.prototype.handleClick_.bind(this,-c));f=f+" "+g.default.CLASS_UNSELECTABLE+" "+g.default.CLASS_CONTROL;c=document.createElement("div");c.className=f;c.appendChild(w);c.appendChild(d);n.default.call(this,{element:c,target:a.target});this.duration_=void 0!==a.duration?a.duration:250};e.default.inherits(l,n.default);l.prototype.handleClick_=function(a,b){b.preventDefault();
this.zoomByDelta_(a)};l.prototype.zoomByDelta_=function(a){var b=this.getMap().getView();if(b){var c=b.getResolution();c&&(a=b.constrainResolution(c,a),0<this.duration_?(b.getAnimating()&&b.cancelAnimations(),b.animate({resolution:a,duration:this.duration_,easing:f.default.easeOut})):b.setResolution(a))}};k.default=l},{"../control/control.js":40,"../css.js":44,"../easing.js":47,"../events.js":48,"../events/eventtype.js":52,"../index.js":89}],43:[function(a,e,k){Object.defineProperty(k,"__esModule",
{value:!0});var d=(e=a("./math.js"))&&e.__esModule?e:{default:e},c=(a=a("./string.js"))&&a.__esModule?a:{default:a},b={add:function(a,b){a[0]+=b[0];a[1]+=b[1];return a},closestOnCircle:function(a,b){var c=b.getRadius(),f=b.getCenter();b=f[0];f=f[1];var d=a[0]-b;a=a[1]-f;0===d&&0===a&&(d=1);var e=Math.sqrt(d*d+a*a);return[b+c*d/e,f+c*a/e]},closestOnSegment:function(a,b){var c=a[0];a=a[1];var f=b[0],d=b[1];b=f[0];f=f[1];var e=d[0];d=d[1];var m=e-b,p=d-f;c=0===m&&0===p?0:(m*(c-b)+p*(a-f))/(m*m+p*p||
0);0>=c?(a=b,c=f):1<=c?(a=e,c=d):(a=b+c*m,c=f+c*p);return[a,c]},createStringXY:function(a){return function(c){return b.toStringXY(c,a)}},degreesToStringHDMS:function(a,b,g){b=d.default.modulo(b+180,360)-180;var f=Math.abs(3600*b);g=g||0;var e=Math.pow(10,g),h=Math.floor(f/3600),m=Math.floor((f-3600*h)/60);f=Math.ceil((f-3600*h-60*m)*e)/e;60<=f&&(f=0,m+=1);60<=m&&(m=0,h+=1);return h+"\u00b0 "+c.default.padNumber(m,2)+"\u2032 "+c.default.padNumber(f,2,g)+"\u2033"+(0==b?"":" "+a.charAt(0>b?1:0))},format:function(a,
b,c){return a?b.replace("{x}",a[0].toFixed(c)).replace("{y}",a[1].toFixed(c)):""},equals:function(a,b){for(var c=!0,f=a.length-1;0<=f;--f)if(a[f]!=b[f]){c=!1;break}return c},rotate:function(a,b){var c=Math.cos(b);b=Math.sin(b);var f=a[1]*c+a[0]*b;a[0]=a[0]*c-a[1]*b;a[1]=f;return a},scale:function(a,b){a[0]*=b;a[1]*=b;return a},sub:function(a,b){a[0]-=b[0];a[1]-=b[1];return a},squaredDistance:function(a,b){var c=a[0]-b[0];a=a[1]-b[1];return c*c+a*a},distance:function(a,c){return Math.sqrt(b.squaredDistance(a,
c))},squaredDistanceToSegment:function(a,c){return b.squaredDistance(a,b.closestOnSegment(a,c))},toStringHDMS:function(a,c){return a?b.degreesToStringHDMS("NS",a[1],c)+" "+b.degreesToStringHDMS("EW",a[0],c):""},toStringXY:function(a,c){return b.format(a,"{x}, {y}",c)}};k.default=b},{"./math.js":123,"./string.js":216}],44:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});a={CLASS_HIDDEN:"ol-hidden",CLASS_SELECTABLE:"ol-selectable",CLASS_UNSELECTABLE:"ol-unselectable",CLASS_UNSUPPORTED:"ol-unsupported",
CLASS_CONTROL:"ol-control"};a.getFontFamilies=function(){var a,c={};return function(b){a||(a=document.createElement("div").style);if(!(b in c)){a.font=b;var d=a.fontFamily;a.font="";if(!d)return null;c[b]=d.split(/,\s?/)}return c[b]}}();k.default=a},{}],45:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});a=(a=a("./index.js"))&&a.__esModule?a:{default:a};e=function(){};e.prototype.disposed_=!1;e.prototype.dispose=function(){this.disposed_||(this.disposed_=!0,this.disposeInternal())};
e.prototype.disposeInternal=a.default.nullFunction;k.default=e},{"./index.js":89}],46:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={createCanvasContext2D:function(a,c){var b=document.createElement("CANVAS");a&&(b.width=a);c&&(b.height=c);return b.getContext("2d")},outerWidth:function(a){var c=a.offsetWidth;a=getComputedStyle(a);return c+=parseInt(a.marginLeft,10)+parseInt(a.marginRight,10)},outerHeight:function(a){var c=a.offsetHeight;a=getComputedStyle(a);return c+=
parseInt(a.marginTop,10)+parseInt(a.marginBottom,10)},replaceNode:function(a,c){var b=c.parentNode;b&&b.replaceChild(a,c)},removeNode:function(a){return a&&a.parentNode?a.parentNode.removeChild(a):null},removeChildren:function(a){for(;a.lastChild;)a.removeChild(a.lastChild)}}},{}],47:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={easeIn:function(a){return Math.pow(a,3)},easeOut:function(a){return 1-d.easeIn(1-a)},inAndOut:function(a){return 3*a*a-2*a*a*a},linear:function(a){return a},
upAndDown:function(a){return.5>a?d.inAndOut(2*a):1-d.inAndOut(2*(a-.5))}};k.default=d},{}],48:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./obj.js"))&&a.__esModule?a:{default:a},c={bindListener_:function(a){var b=function(b){var g=a.listener,f=a.bindTo||a.target;a.callOnce&&c.unlistenByKey(a);return g.call(f,b)};return a.boundListener=b},findListener_:function(a,c,d,g){for(var b,e=0,h=a.length;e<h;++e)if(b=a[e],b.listener===c&&b.bindTo===d)return g&&(b.deleteIndex=
e),b},getListeners:function(a,c){return(a=a.ol_lm)?a[c]:void 0},getListenerMap_:function(a){var b=a.ol_lm;b||(b=a.ol_lm={});return b},removeListeners_:function(a,e){var b=c.getListeners(a,e);if(b){for(var g=0,f=b.length;g<f;++g)a.removeEventListener(e,b[g].boundListener),d.default.clear(b[g]);b.length=0;if(b=a.ol_lm)delete b[e],0===Object.keys(b).length&&delete a.ol_lm}},listen:function(a,d,e,g,f){var b=c.getListenerMap_(a),h=b[d];h||(h=b[d]=[]);(b=c.findListener_(h,e,g,!1))?f||(b.callOnce=!1):(b=
{bindTo:g,callOnce:!!f,listener:e,target:a,type:d},a.addEventListener(d,c.bindListener_(b)),h.push(b));return b},listenOnce:function(a,d,e,g){return c.listen(a,d,e,g,!0)},unlisten:function(a,d,e,g){(a=c.getListeners(a,d))&&(e=c.findListener_(a,e,g,!0))&&c.unlistenByKey(e)},unlistenByKey:function(a){if(a&&a.target){a.target.removeEventListener(a.type,a.boundListener);var b=c.getListeners(a.target,a.type);if(b){var e="deleteIndex"in a?a.deleteIndex:b.indexOf(a);-1!==e&&b.splice(e,1);0===b.length&&c.removeListeners_(a.target,
a.type)}d.default.clear(a)}},unlistenAll:function(a){var b=c.getListenerMap_(a),d;for(d in b)c.removeListeners_(a,d)}};k.default=c},{"./obj.js":124}],49:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../mapbrowsereventtype.js");var c=d(e);e=a("../asserts.js");var b=d(e);e=a("../functions.js");e=d(e);a=a("../has.js");var h=d(a);a={altKeyOnly:function(a){a=a.originalEvent;return a.altKey&&!(a.metaKey||a.ctrlKey)&&!a.shiftKey},
altShiftKeysOnly:function(a){a=a.originalEvent;return a.altKey&&!(a.metaKey||a.ctrlKey)&&a.shiftKey}};a.always=e.default.TRUE;a.click=function(a){return a.type==c.default.CLICK};a.mouseActionButton=function(a){a=a.originalEvent;return 0==a.button&&!(h.default.WEBKIT&&h.default.MAC&&a.ctrlKey)};a.never=e.default.FALSE;a.pointerMove=function(a){return"pointermove"==a.type};a.singleClick=function(a){return a.type==c.default.SINGLECLICK};a.doubleClick=function(a){return a.type==c.default.DBLCLICK};a.noModifierKeys=
function(a){a=a.originalEvent;return!a.altKey&&!(a.metaKey||a.ctrlKey)&&!a.shiftKey};a.platformModifierKeyOnly=function(a){a=a.originalEvent;return!a.altKey&&(h.default.MAC?a.metaKey:a.ctrlKey)&&!a.shiftKey};a.shiftKeyOnly=function(a){a=a.originalEvent;return!a.altKey&&!(a.metaKey||a.ctrlKey)&&a.shiftKey};a.targetNotEditable=function(a){a=a.originalEvent.target.tagName;return"INPUT"!==a&&"SELECT"!==a&&"TEXTAREA"!==a};a.mouseOnly=function(a){b.default.assert(a.pointerEvent,56);return"mouse"==a.pointerEvent.pointerType};
a.primaryAction=function(a){a=a.pointerEvent;return a.isPrimary&&0===a.button};k.default=a},{"../asserts.js":31,"../functions.js":60,"../has.js":84,"../mapbrowsereventtype.js":118}],50:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});a=function(a){this.propagationStopped;this.type=a;this.target=null};a.prototype.preventDefault=a.prototype.stopPropagation=function(){this.propagationStopped=!0};a.stopPropagation=function(a){a.stopPropagation()};a.preventDefault=function(a){a.preventDefault()};
k.default=a},{}],51:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");var c=d(e);e=a("../disposable.js");var b=d(e);e=a("../events.js");var h=d(e);a=a("../events/event.js");var n=d(a);a=function(){b.default.call(this);this.pendingRemovals_={};this.dispatching_={};this.listeners_={}};c.default.inherits(a,b.default);a.prototype.addEventListener=function(a,b){var f=this.listeners_[a];f||(f=this.listeners_[a]=[]);-1===
f.indexOf(b)&&f.push(b)};a.prototype.dispatchEvent=function(a){var b="string"===typeof a?new n.default(a):a;a=b.type;b.target=this;var d=this.listeners_[a];if(d){a in this.dispatching_||(this.dispatching_[a]=0,this.pendingRemovals_[a]=0);++this.dispatching_[a];for(var g=0,e=d.length;g<e;++g)if(!1===d[g].call(this,b)||b.propagationStopped){var p=!1;break}--this.dispatching_[a];if(0===this.dispatching_[a]){b=this.pendingRemovals_[a];for(delete this.pendingRemovals_[a];b--;)this.removeEventListener(a,
c.default.nullFunction);delete this.dispatching_[a]}return p}};a.prototype.disposeInternal=function(){h.default.unlistenAll(this)};a.prototype.getListeners=function(a){return this.listeners_[a]};a.prototype.hasListener=function(a){return a?a in this.listeners_:0<Object.keys(this.listeners_).length};a.prototype.removeEventListener=function(a,b){var f=this.listeners_[a];f&&(b=f.indexOf(b),a in this.pendingRemovals_?(f[b]=c.default.nullFunction,++this.pendingRemovals_[a]):(f.splice(b,1),0===f.length&&
delete this.listeners_[a]))};k.default=a},{"../disposable.js":45,"../events.js":48,"../events/event.js":50,"../index.js":89}],52:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={CHANGE:"change",CLEAR:"clear",CLICK:"click",DBLCLICK:"dblclick",DRAGENTER:"dragenter",DRAGOVER:"dragover",DROP:"drop",ERROR:"error",KEYDOWN:"keydown",KEYPRESS:"keypress",LOAD:"load",MOUSEDOWN:"mousedown",MOUSEMOVE:"mousemove",MOUSEOUT:"mouseout",MOUSEUP:"mouseup",MOUSEWHEEL:"mousewheel",MSPOINTERDOWN:"MSPointerDown",
RESIZE:"resize",TOUCHSTART:"touchstart",TOUCHMOVE:"touchmove",TOUCHEND:"touchend",WHEEL:"wheel"}},{}],53:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={LEFT:37,UP:38,RIGHT:39,DOWN:40}},{}],54:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./asserts.js");var c=d(e);e=a("./extent/corner.js");var b=d(e);a=a("./extent/relationship.js");var h=d(a),n={boundingExtent:function(a){for(var b=n.createEmpty(),
c=0,d=a.length;c<d;++c)n.extendCoordinate(b,a[c]);return b},boundingExtentXYs_:function(a,b,c){var f=Math.min.apply(null,a),d=Math.min.apply(null,b);a=Math.max.apply(null,a);b=Math.max.apply(null,b);return n.createOrUpdate(f,d,a,b,c)},buffer:function(a,b,c){return c?(c[0]=a[0]-b,c[1]=a[1]-b,c[2]=a[2]+b,c[3]=a[3]+b,c):[a[0]-b,a[1]-b,a[2]+b,a[3]+b]},clone:function(a,b){return b?(b[0]=a[0],b[1]=a[1],b[2]=a[2],b[3]=a[3],b):a.slice()},closestSquaredDistanceXY:function(a,b,c){b=b<a[0]?a[0]-b:a[2]<b?b-a[2]:
0;a=c<a[1]?a[1]-c:a[3]<c?c-a[3]:0;return b*b+a*a},containsCoordinate:function(a,b){return n.containsXY(a,b[0],b[1])},containsExtent:function(a,b){return a[0]<=b[0]&&b[2]<=a[2]&&a[1]<=b[1]&&b[3]<=a[3]},containsXY:function(a,b,c){return a[0]<=b&&b<=a[2]&&a[1]<=c&&c<=a[3]},coordinateRelationship:function(a,b){var f=a[1],c=a[2],d=a[3],g=b[0];b=b[1];var e=h.default.UNKNOWN;g<a[0]?e|=h.default.LEFT:g>c&&(e|=h.default.RIGHT);b<f?e|=h.default.BELOW:b>d&&(e|=h.default.ABOVE);e===h.default.UNKNOWN&&(e=h.default.INTERSECTING);
return e},createEmpty:function(){return[Infinity,Infinity,-Infinity,-Infinity]},createOrUpdate:function(a,b,c,d,e){return e?(e[0]=a,e[1]=b,e[2]=c,e[3]=d,e):[a,b,c,d]},createOrUpdateEmpty:function(a){return n.createOrUpdate(Infinity,Infinity,-Infinity,-Infinity,a)},createOrUpdateFromCoordinate:function(a,b){var f=a[0];a=a[1];return n.createOrUpdate(f,a,f,a,b)},createOrUpdateFromCoordinates:function(a,b){b=n.createOrUpdateEmpty(b);return n.extendCoordinates(b,a)},createOrUpdateFromFlatCoordinates:function(a,
b,c,d,e){e=n.createOrUpdateEmpty(e);return n.extendFlatCoordinates(e,a,b,c,d)},createOrUpdateFromRings:function(a,b){b=n.createOrUpdateEmpty(b);return n.extendRings(b,a)},equals:function(a,b){return a[0]==b[0]&&a[2]==b[2]&&a[1]==b[1]&&a[3]==b[3]},extend:function(a,b){b[0]<a[0]&&(a[0]=b[0]);b[2]>a[2]&&(a[2]=b[2]);b[1]<a[1]&&(a[1]=b[1]);b[3]>a[3]&&(a[3]=b[3]);return a},extendCoordinate:function(a,b){b[0]<a[0]&&(a[0]=b[0]);b[0]>a[2]&&(a[2]=b[0]);b[1]<a[1]&&(a[1]=b[1]);b[1]>a[3]&&(a[3]=b[1])},extendCoordinates:function(a,
b){var f;var c=0;for(f=b.length;c<f;++c)n.extendCoordinate(a,b[c]);return a},extendFlatCoordinates:function(a,b,c,d,e){for(;c<d;c+=e)n.extendXY(a,b[c],b[c+1]);return a},extendRings:function(a,b){var f;var c=0;for(f=b.length;c<f;++c)n.extendCoordinates(a,b[c]);return a},extendXY:function(a,b,c){a[0]=Math.min(a[0],b);a[1]=Math.min(a[1],c);a[2]=Math.max(a[2],b);a[3]=Math.max(a[3],c)},forEachCorner:function(a,b,c){var f;return(f=b.call(c,n.getBottomLeft(a)))||(f=b.call(c,n.getBottomRight(a)))||(f=b.call(c,
n.getTopRight(a)))?f:(f=b.call(c,n.getTopLeft(a)))?f:!1},getArea:function(a){var b=0;n.isEmpty(a)||(b=n.getWidth(a)*n.getHeight(a));return b},getBottomLeft:function(a){return[a[0],a[1]]},getBottomRight:function(a){return[a[2],a[1]]},getCenter:function(a){return[(a[0]+a[2])/2,(a[1]+a[3])/2]},getCorner:function(a,f){var d;f===b.default.BOTTOM_LEFT?d=n.getBottomLeft(a):f===b.default.BOTTOM_RIGHT?d=n.getBottomRight(a):f===b.default.TOP_LEFT?d=n.getTopLeft(a):f===b.default.TOP_RIGHT?d=n.getTopRight(a):
c.default.assert(!1,13);return d},getEnlargedArea:function(a,b){return(Math.max(a[2],b[2])-Math.min(a[0],b[0]))*(Math.max(a[3],b[3])-Math.min(a[1],b[1]))},getForViewAndSize:function(a,b,c,d,e){var f=b*d[0]/2;d=b*d[1]/2;b=Math.cos(c);var g=Math.sin(c);c=f*b;f*=g;b*=d;var l=d*g,m=a[0],h=a[1];a=m-c+l;d=m-c-l;g=m+c-l;c=m+c+l;l=h-f-b;m=h-f+b;var q=h+f+b;f=h+f-b;return n.createOrUpdate(Math.min(a,d,g,c),Math.min(l,m,q,f),Math.max(a,d,g,c),Math.max(l,m,q,f),e)},getHeight:function(a){return a[3]-a[1]},getIntersectionArea:function(a,
b){a=n.getIntersection(a,b);return n.getArea(a)},getIntersection:function(a,b,c){c=c?c:n.createEmpty();n.intersects(a,b)&&(c[0]=a[0]>b[0]?a[0]:b[0],c[1]=a[1]>b[1]?a[1]:b[1],c[2]=a[2]<b[2]?a[2]:b[2],c[3]=a[3]<b[3]?a[3]:b[3]);return c},getMargin:function(a){return n.getWidth(a)+n.getHeight(a)},getSize:function(a){return[a[2]-a[0],a[3]-a[1]]},getTopLeft:function(a){return[a[0],a[3]]},getTopRight:function(a){return[a[2],a[3]]},getWidth:function(a){return a[2]-a[0]},intersects:function(a,b){return a[0]<=
b[2]&&a[2]>=b[0]&&a[1]<=b[3]&&a[3]>=b[1]},isEmpty:function(a){return a[2]<a[0]||a[3]<a[1]},returnOrUpdate:function(a,b){return b?(b[0]=a[0],b[1]=a[1],b[2]=a[2],b[3]=a[3],b):a},scaleFromCenter:function(a,b){var f=(a[2]-a[0])/2*(b-1);b=(a[3]-a[1])/2*(b-1);a[0]-=f;a[2]+=f;a[1]-=b;a[3]+=b},intersectsSegment:function(a,b,c){var f=!1,d=n.coordinateRelationship(a,b),e=n.coordinateRelationship(a,c);if(d===h.default.INTERSECTING||e===h.default.INTERSECTING)f=!0;else{var g=a[0],l=a[1],u=a[2];a=a[3];var y=c[0];
c=c[1];b=(c-b[1])/(y-b[0]);e&h.default.ABOVE&&!(d&h.default.ABOVE)&&(f=y-(c-a)/b,f=f>=g&&f<=u);f||!(e&h.default.RIGHT)||d&h.default.RIGHT||(f=c-(y-u)*b,f=f>=l&&f<=a);f||!(e&h.default.BELOW)||d&h.default.BELOW||(f=y-(c-l)/b,f=f>=g&&f<=u);f||!(e&h.default.LEFT)||d&h.default.LEFT||(f=c-(y-g)*b,f=f>=l&&f<=a)}return f},applyTransform:function(a,b,c){a=[a[0],a[1],a[0],a[3],a[2],a[1],a[2],a[3]];b(a,a,2);return n.boundingExtentXYs_([a[0],a[2],a[4],a[6]],[a[1],a[3],a[5],a[7]],c)}};k.default=n},{"./asserts.js":31,
"./extent/corner.js":55,"./extent/relationship.js":56}],55:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={BOTTOM_LEFT:"bottom-left",BOTTOM_RIGHT:"bottom-right",TOP_LEFT:"top-left",TOP_RIGHT:"top-right"}},{}],56:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={UNKNOWN:0,INTERSECTING:1,ABOVE:2,RIGHT:4,BELOW:8,LEFT:16}},{}],57:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});
e=a("./asserts.js");var c=d(e);e=a("./events.js");var b=d(e);e=a("./events/eventtype.js");var h=d(e);e=a("./index.js");e=d(e);var n=a("./object.js"),g=d(n);n=a("./geom/geometry.js");var f=d(n);a=a("./style/style.js");var l=d(a),q=function(a){g.default.call(this);this.id_=void 0;this.geometryName_="geometry";this.style_=null;this.styleFunction_=void 0;this.geometryChangeKey_=null;b.default.listen(this,g.default.getChangeEventType(this.geometryName_),this.handleGeometryChanged_,this);void 0!==a&&(a instanceof
f.default||!a?this.setGeometry(a):this.setProperties(a))};e.default.inherits(q,g.default);q.prototype.clone=function(){var a=new q(this.getProperties());a.setGeometryName(this.getGeometryName());var b=this.getGeometry();b&&a.setGeometry(b.clone());(b=this.getStyle())&&a.setStyle(b);return a};q.prototype.getGeometry=function(){return this.get(this.geometryName_)};q.prototype.getId=function(){return this.id_};q.prototype.getGeometryName=function(){return this.geometryName_};q.prototype.getStyle=function(){return this.style_};
q.prototype.getStyleFunction=function(){return this.styleFunction_};q.prototype.handleGeometryChange_=function(){this.changed()};q.prototype.handleGeometryChanged_=function(){this.geometryChangeKey_&&(b.default.unlistenByKey(this.geometryChangeKey_),this.geometryChangeKey_=null);var a=this.getGeometry();a&&(this.geometryChangeKey_=b.default.listen(a,h.default.CHANGE,this.handleGeometryChange_,this));this.changed()};q.prototype.setGeometry=function(a){this.set(this.geometryName_,a)};q.prototype.setStyle=
...
typeof a)var b=2==a.length?function(b){return a(this,b)}:a;else{if(Array.isArray(a))var f=a;else c.default.assert(a instanceof l.default,41),f=[a];b=function(){return f}}return b};k.default=q},{"./asserts.js":31,"./events.js":48,"./events/eventtype.js":52,"./geom/geometry.js":77,"./index.js":89,"./object.js":125,"./style/style.js":234}],58:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");var c=d(e);e=a("./format/formattype.js");
var b=d(e);a=a("./xml.js");var h=d(a),n={loadFeaturesXhr:function(a,f,c,d){return function(e,g,l){var m=new XMLHttpRequest;m.open("GET","function"===typeof a?a(e,g,l):a,!0);f.getType()==b.default.ARRAY_BUFFER&&(m.responseType="arraybuffer");m.onload=function(a){if(!m.status||200<=m.status&&300>m.status){a=f.getType();if(a==b.default.JSON||a==b.default.TEXT)var e=m.responseText;else a==b.default.XML?(e=m.responseXML)||(e=h.default.parse(m.responseText)):a==b.default.ARRAY_BUFFER&&(e=m.response);e?
c.call(this,f.readFeatures(e,{featureProjection:l}),f.readProjection(e),f.getLastExtent()):d.call(this)}else d.call(this)}.bind(this);m.onerror=function(){d.call(this)}.bind(this);m.send()}},xhr:function(a,b){return n.loadFeaturesXhr(a,b,function(a,b){this.addFeatures(a)},c.default.nullFunction)}};k.default=n},{"./format/formattype.js":59,"./index.js":89,"./xml.js":255}],59:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={ARRAY_BUFFER:"arraybuffer",JSON:"json",TEXT:"text",
XML:"xml"}},{}],60:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={TRUE:function(){return!0},FALSE:function(){return!1}}},{}],61:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={linearRing:function(a,b,d,e){for(var c=0,f=a[d-e],l=a[d-e+1];b<d;b+=e){var h=a[b],m=a[b+1];c+=l*h-f*m;f=h;l=m}return c/2},linearRings:function(a,b,e,n){var c=0,f;var l=0;for(f=e.length;l<f;++l){var h=e[l];c+=d.linearRing(a,b,h,n);b=h}return c},linearRingss:function(a,b,
e,n){var c=0,f;var l=0;for(f=e.length;l<f;++l){var h=e[l];c+=d.linearRings(a,b,h,n);b=h[h.length-1]}return c}};k.default=d},{}],62:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("../../math.js"))&&a.__esModule?a:{default:a},c={point:function(a,c,e,g,f,l,q){var b=a[c],p=a[c+1],h=a[e]-b,t=a[e+1]-p;if(0!==h||0!==t)if(l=((f-b)*h+(l-p)*t)/(h*h+t*t),1<l)c=e;else if(0<l){for(f=0;f<g;++f)q[f]=d.default.lerp(a[c+f],a[e+f],l);q.length=g;return}for(f=0;f<g;++f)q[f]=a[c+f];q.length=
g},getMaxSquaredDelta:function(a,c,e,g,f){var b=a[c],h=a[c+1];for(c+=g;c<e;c+=g){var m=a[c],p=a[c+1];b=d.default.squaredDistance(b,h,m,p);b>f&&(f=b);b=m;h=p}return f},getsMaxSquaredDelta:function(a,d,e,g,f){var b;var h=0;for(b=e.length;h<b;++h){var m=e[h];f=c.getMaxSquaredDelta(a,d,m,g,f);d=m}return f},getssMaxSquaredDelta:function(a,d,e,g,f){var b;var h=0;for(b=e.length;h<b;++h){var m=e[h];f=c.getsMaxSquaredDelta(a,d,m,g,f);d=m[m.length-1]}return f},getClosestPoint:function(a,e,n,g,f,l,q,m,p,r,t){if(e==
n)return r;if(0===f){var b=d.default.squaredDistance(q,m,a[e],a[e+1]);if(b<r){for(t=0;t<g;++t)p[t]=a[e+t];p.length=g;return b}return r}for(var h=t?t:[NaN,NaN],w=e+g;w<n;)if(c.point(a,w-g,w,g,q,m,h),b=d.default.squaredDistance(q,m,h[0],h[1]),b<r){r=b;for(t=0;t<g;++t)p[t]=h[t];p.length=g;w+=g}else w+=g*Math.max((Math.sqrt(b)-Math.sqrt(r))/f|0,1);if(l&&(c.point(a,n-g,e,g,q,m,h),b=d.default.squaredDistance(q,m,h[0],h[1]),b<r)){r=b;for(t=0;t<g;++t)p[t]=h[t];p.length=g}return r},getsClosestPoint:function(a,
d,e,g,f,l,q,m,p,r,t){t=t?t:[NaN,NaN];var b;var h=0;for(b=e.length;h<b;++h){var n=e[h];r=c.getClosestPoint(a,d,n,g,f,l,q,m,p,r,t);d=n}return r},getssClosestPoint:function(a,d,e,g,f,l,q,m,p,r,t){t=t?t:[NaN,NaN];var b;var h=0;for(b=e.length;h<b;++h){var n=e[h];r=c.getsClosestPoint(a,d,n,g,f,l,q,m,p,r,t);d=n[n.length-1]}return r}};k.default=c},{"../../math.js":123}],63:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("../../extent.js"))&&a.__esModule?a:{default:a},c={linearRingContainsExtent:function(a,
e,n,g,f){return!d.default.forEachCorner(f,function(b){return!c.linearRingContainsXY(a,e,n,g,b[0],b[1])})},linearRingContainsXY:function(a,c,d,e,f,l){for(var b=0,g=a[d-e],p=a[d-e+1];c<d;c+=e){var h=a[c],t=a[c+1];p<=l?t>l&&0<(h-g)*(l-p)-(f-g)*(t-p)&&b++:t<=l&&0>(h-g)*(l-p)-(f-g)*(t-p)&&b--;g=h;p=t}return 0!==b},linearRingsContainsXY:function(a,d,e,g,f,l){if(0===e.length||!c.linearRingContainsXY(a,d,e[0],g,f,l))return!1;var b;d=1;for(b=e.length;d<b;++d)if(c.linearRingContainsXY(a,e[d-1],e[d],g,f,l))return!1;
return!0},linearRingssContainsXY:function(a,d,e,g,f,l){if(0===e.length)return!1;var b;var m=0;for(b=e.length;m<b;++m){var p=e[m];if(c.linearRingsContainsXY(a,d,p,g,f,l))return!0;d=p[p.length-1]}return!1}};k.default=c},{"../../extent.js":54}],64:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={coordinate:function(a,b,d,e){var c;e=0;for(c=d.length;e<c;++e)a[b++]=d[e];return b},coordinates:function(a,b,d,e){var c;var f=0;for(c=d.length;f<c;++f){var l=d[f],h;for(h=0;h<e;++h)a[b++]=
l[h]}return b},coordinatess:function(a,b,e,n,g){g=g?g:[];var c=0,l;var h=0;for(l=e.length;h<l;++h)b=d.coordinates(a,b,e[h],n),g[c++]=b;g.length=c;return g},coordinatesss:function(a,b,e,n,g){g=g?g:[];var c=0,l;var h=0;for(l=e.length;h<l;++h)b=d.coordinatess(a,b,e[h],n,g[c]),g[c++]=b,b=b[b.length-1];g.length=c;return g}};k.default=d},{}],65:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={coordinates:function(a,b,d,e,g){g=void 0!==g?g:[];for(var c=0;b<d;b+=e)g[c++]=a.slice(b,
b+e);g.length=c;return g},coordinatess:function(a,b,e,n,g){g=void 0!==g?g:[];var c=0,l;var h=0;for(l=e.length;h<l;++h){var m=e[h];g[c++]=d.coordinates(a,b,m,n,g[c]);b=m}g.length=c;return g},coordinatesss:function(a,b,e,n,g){g=void 0!==g?g:[];var c=0,l;var h=0;for(l=e.length;h<l;++h){var m=e[h];g[c++]=d.coordinatess(a,b,m,n,g[c]);b=m[m.length-1]}g.length=c;return g}};k.default=d},{}],66:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(e=a("../../array.js"))&&e.__esModule?e:
{default:e},c=(a=a("../flat/contains.js"))&&a.__esModule?a:{default:a},b={linearRings:function(a,b,e,f,l,q,m){for(var g,h,t,u,n,k=l[q+1],v=[],A=0,B=e.length;A<B;++A){var x=e[A];t=a[x-f];n=a[x-f+1];for(g=b;g<x;g+=f){u=a[g];h=a[g+1];if(k<=n&&h<=k||n<=k&&k<=h)t=(k-n)/(h-n)*(u-t)+t,v.push(t);t=u;n=h}}A=NaN;B=-Infinity;v.sort(d.default.numberSafeCompareFunction);t=v[0];g=1;for(h=v.length;g<h;++g)u=v[g],x=Math.abs(u-t),x>B&&(t=(t+u)/2,c.default.linearRingsContainsXY(a,b,e,f,t,k)&&(A=t,B=x)),t=u;isNaN(A)&&
(A=l[q]);return m?(m.push(A,k,B),m):[A,k,B]},linearRingss:function(a,c,d,f,e){var g=[],l;var p=0;for(l=d.length;p<l;++p){var h=d[p];g=b.linearRings(a,c,h,f,e,2*p,g);c=h[h.length-1]}return g}};k.default=b},{"../../array.js":29,"../flat/contains.js":63}],67:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../../extent.js");var c=d(e);e=a("../flat/contains.js");var b=d(e);a=a("../flat/segments.js");var h=d(a),n={lineString:function(a,
b,d,e,m){var f=c.default.extendFlatCoordinates(c.default.createEmpty(),a,b,d,e);return c.default.intersects(m,f)?c.default.containsExtent(m,f)||f[0]>=m[0]&&f[2]<=m[2]||f[1]>=m[1]&&f[3]<=m[3]?!0:h.default.forEach(a,b,d,e,function(a,b){return c.default.intersectsSegment(m,a,b)}):!1},lineStrings:function(a,b,c,d,e){var f;var g=0;for(f=c.length;g<f;++g){if(n.lineString(a,b,c[g],d,e))return!0;b=c[g]}return!1},linearRing:function(a,c,d,e,m){return n.lineString(a,c,d,e,m)||b.default.linearRingContainsXY(a,
...
b=l[l.length-1]}return!1}};k.default=n},{"../../extent.js":54,"../flat/contains.js":63,"../flat/segments.js":71}],68:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={lineString:function(a,b,d,e){var c=a[b],f=a[b+1],l=0;for(b+=e;b<d;b+=e){var h=a[b],m=a[b+1];l+=Math.sqrt((h-c)*(h-c)+(m-f)*(m-f));c=h;f=m}return l},linearRing:function(a,b,e,n){var c=d.lineString(a,b,e,n),f=a[e-n]-a[b];a=a[e-n+1]-a[b+1];return c+=Math.sqrt(f*f+a*a)}};k.default=d},{}],69:[function(a,e,k){Object.defineProperty(k,
"__esModule",{value:!0});var d=(a=a("../flat/reverse.js"))&&a.__esModule?a:{default:a},c={linearRingIsClockwise:function(a,c,d,e){for(var b=0,g=a[d-e],h=a[d-e+1];c<d;c+=e){var m=a[c],p=a[c+1];b+=(m-g)*(p+h);g=m;h=p}return 0<b},linearRingsAreOriented:function(a,d,e,g,f){f=void 0!==f?f:!1;var b;var h=0;for(b=e.length;h<b;++h){var m=e[h];d=c.linearRingIsClockwise(a,d,m,g);if(0===h){if(f&&d||!f&&!d)return!1}else if(f&&!d||!f&&d)return!1;d=m}return!0},linearRingssAreOriented:function(a,d,e,g,f){var b;
var h=0;for(b=e.length;h<b;++h)if(!c.linearRingsAreOriented(a,d,e[h],g,f))return!1;return!0},orientLinearRings:function(a,e,n,g,f){f=void 0!==f?f:!1;var b;var h=0;for(b=n.length;h<b;++h){var m=n[h],p=c.linearRingIsClockwise(a,e,m,g);(0===h?f&&p||!f&&!p:f&&!p||!f&&p)&&d.default.coordinates(a,e,m,g);e=m}return e},orientLinearRingss:function(a,d,e,g,f){var b;var h=0;for(b=e.length;h<b;++h)d=c.orientLinearRings(a,d,e[h],g,f);return d}};k.default=c},{"../flat/reverse.js":70}],70:[function(a,e,k){Object.defineProperty(k,
"__esModule",{value:!0});k.default={coordinates:function(a,c,b,e){for(;c<b-e;){var d;for(d=0;d<e;++d){var g=a[c+d];a[c+d]=a[b-e+d];a[b-e+d]=g}c+=e;b-=e}}}},{}],71:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={forEach:function(a,c,b,e,n,g){for(var f=[a[c],a[c+1]],d=[],h;c+e<b;c+=e){d[0]=a[c+e];d[1]=a[c+e+1];if(h=n.call(g,f,d))return h;f[0]=d[0];f[1]=d[1]}return!1}}},{}],72:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("../../math.js"))&&
a.__esModule?a:{default:a},c={lineString:function(a,d,e,g,f,l,q){q=void 0!==q?q:[];l||(e=c.radialDistance(a,d,e,g,f,q,0),a=q,d=0,g=2);q.length=c.douglasPeucker(a,d,e,g,f,q,0);return q},douglasPeucker:function(a,c,e,g,f,l,q){var b=(e-c)/g;if(3>b){for(;c<e;c+=g)l[q++]=a[c],l[q++]=a[c+1];return q}var p=Array(b);p[0]=1;p[b-1]=1;e=[c,e-g];for(var h=0,t;0<e.length;){var u=e.pop(),n=e.pop(),k=0,v=a[n],A=a[n+1],B=a[u],x=a[u+1];for(t=n+g;t<u;t+=g){var z=d.default.squaredSegmentDistance(a[t],a[t+1],v,A,B,x);
z>k&&(h=t,k=z)}k>f&&(p[(h-c)/g]=1,n+g<h&&e.push(n,h),h+g<u&&e.push(h,u))}for(t=0;t<b;++t)p[t]&&(l[q++]=a[c+t*g],l[q++]=a[c+t*g+1]);return q},douglasPeuckers:function(a,d,e,g,f,l,q,m){var b;var h=0;for(b=e.length;h<b;++h){var t=e[h];q=c.douglasPeucker(a,d,t,g,f,l,q);m.push(q);d=t}return q},douglasPeuckerss:function(a,d,e,g,f,l,q,m){var b;var h=0;for(b=e.length;h<b;++h){var t=e[h],u=[];q=c.douglasPeuckers(a,d,t,g,f,l,q,u);m.push(u);d=t[t.length-1]}return q},radialDistance:function(a,c,e,g,f,l,q){if(e<=
c+g){for(;c<e;c+=g)l[q++]=a[c],l[q++]=a[c+1];return q}var b=a[c],p=a[c+1];l[q++]=b;l[q++]=p;var h=b,t=p;for(c+=g;c<e;c+=g)h=a[c],t=a[c+1],d.default.squaredDistance(b,p,h,t)>f&&(l[q++]=h,l[q++]=t,b=h,p=t);if(h!=b||t!=p)l[q++]=h,l[q++]=t;return q},snap:function(a,c){return c*Math.round(a/c)},quantize:function(a,d,e,g,f,l,q){if(d==e)return q;var b=c.snap(a[d],f),p=c.snap(a[d+1],f);d+=g;l[q++]=b;l[q++]=p;do{var h=c.snap(a[d],f);var t=c.snap(a[d+1],f);d+=g;if(d==e)return l[q++]=h,l[q++]=t,q}while(h==b&&
t==p);for(;d<e;){var u=c.snap(a[d],f);var n=c.snap(a[d+1],f);d+=g;if(u!=h||n!=t){var k=h-b,v=t-p,A=u-b,B=n-p;k*B==v*A&&(0>k&&A<k||k==A||0<k&&A>k)&&(0>v&&B<v||v==B||0<v&&B>v)||(l[q++]=h,l[q++]=t,b=h,p=t);h=u;t=n}}l[q++]=h;l[q++]=t;return q},quantizes:function(a,d,e,g,f,l,q,m){var b;var h=0;for(b=e.length;h<b;++h){var t=e[h];q=c.quantize(a,d,t,g,f,l,q);m.push(q);d=t}return q},quantizess:function(a,d,e,g,f,l,q,m){var b;var h=0;for(b=e.length;h<b;++h){var t=e[h],u=[];q=c.quantizes(a,d,t,g,f,l,q,u);m.push(u);
d=t[t.length-1]}return q}};k.default=c},{"../../math.js":123}],73:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={lineString:function(a,c,b,e,n){for(var d=b,f=b,l=0,h=0,m=b,p,r,t,u,y,k;b<e;b+=n){var v=c[b],A=c[b+1];void 0!==t&&(t=v-t,u=A-u,r=Math.sqrt(t*t+u*u),void 0!==y&&(h+=p,p=Math.acos((y*t+k*u)/(p*r)),p>a&&(h>l&&(l=h,d=m,f=b),h=0,m=b-n)),p=r,y=t,k=u);t=v;u=A}return h+r>l?[m,b]:[d,f]}}},{}],74:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=
(a=a("../../math.js"))&&a.__esModule?a:{default:a};k.default={lineString:function(a,b,e,n,g,f,l,q){var c=[],p=a[b]>a[e-n],h=g.length,t=a[b],u=a[b+1];b+=n;for(var y=a[b],k=a[b+1],v=0,A=Math.sqrt(Math.pow(y-t,2)+Math.pow(k-u,2)),B="",x=0,z,C,S,I=0;I<h;++I){C=p?h-I-1:I;C=g.charAt(C);B=p?C+B:B+C;var M=f(B)-x;x+=M;for(var H=l+M/2;b<e-n&&v+A<H;)t=y,u=k,b+=n,y=a[b],k=a[b+1],v+=A,A=Math.sqrt(Math.pow(y-t,2)+Math.pow(k-u,2));var J=H-v;H=Math.atan2(k-u,y-t);p&&(H+=0<H?-Math.PI:Math.PI);if(void 0!==S){var D=
H-S;D+=D>Math.PI?-2*Math.PI:D<-Math.PI?2*Math.PI:0;if(Math.abs(D)>q)return null}D=J/A;J=d.default.lerp(t,y,D);D=d.default.lerp(u,k,D);S==H?(p&&(z[0]=J,z[1]=D,z[2]=M/2),z[4]=B):(B=C,x=M,z=[J,D,M/2,H,B],p?c.unshift(z):c.push(z),S=H);l+=M}return c}}},{"../../math.js":123}],75:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("../flat/area.js"))&&a.__esModule?a:{default:a};k.default={lineStringIsClosed:function(a,b,e,n){var c=e-n;return a[b]===a[c]&&a[b+1]===a[c+1]&&3<(e-b)/
n?!!d.default.linearRing(a,b,e,n):!1}}},{"../flat/area.js":61}],76:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={transform2D:function(a,c,b,e,n,g){for(var f=g?g:[],d=0;c<b;c+=e){var h=a[c],m=a[c+1];f[d++]=n[0]*h+n[2]*m+n[4];f[d++]=n[1]*h+n[3]*m+n[5]}g&&f.length!=d&&(f.length=d);return f},rotate:function(a,c,b,e,n,g,f){var d=f?f:[],h=Math.cos(n);n=Math.sin(n);var m=g[0];g=g[1];for(var p=0;c<b;c+=e){var r=a[c]-m,t=a[c+1]-g;d[p++]=m+r*h-t*n;d[p++]=g+r*n+t*h;for(r=c+2;r<
c+e;++r)d[p++]=a[r]}f&&d.length!=p&&(d.length=p);return d},scale:function(a,c,b,e,n,g,f,l){var d=l?l:[],m=f[0];f=f[1];for(var p=0;c<b;c+=e){var h=a[c]-m,t=a[c+1]-f;d[p++]=m+n*h;d[p++]=f+g*t;for(h=c+2;h<c+e;++h)d[p++]=a[h]}l&&d.length!=p&&(d.length=p);return d},translate:function(a,c,b,e,n,g,f){for(var d=f?f:[],h=0,m;c<b;c+=e)for(d[h++]=a[c]+n,d[h++]=a[c+1]+g,m=c+2;m<c+e;++m)d[h++]=a[m];f&&d.length!=h&&(d.length=h);return d}}},{}],77:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}
Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../object.js"),b=d(c);c=a("../extent.js");var h=d(c);c=a("../functions.js");c=d(c);var n=a("../geom/flat/transform.js"),g=d(n);n=a("../proj.js");var f=d(n);n=a("../proj/units.js");var l=d(n);a=a("../transform.js");var q=d(a);a=function(){b.default.call(this);this.extent_=h.default.createEmpty();this.extentRevision_=-1;this.simplifiedGeometryCache={};this.simplifiedGeometryRevision=this.simplifiedGeometryMaxMinSquaredTolerance=
0;this.tmpTransform_=q.default.create()};e.default.inherits(a,b.default);a.prototype.clone=function(){};a.prototype.closestPointXY=function(a,b,c,f){};a.prototype.getClosestPoint=function(a,b){b=b?b:[NaN,NaN];this.closestPointXY(a[0],a[1],b,Infinity);return b};a.prototype.intersectsCoordinate=function(a){return this.containsXY(a[0],a[1])};a.prototype.computeExtent=function(a){};a.prototype.containsXY=c.default.FALSE;a.prototype.getExtent=function(a){this.extentRevision_!=this.getRevision()&&(this.extent_=
this.computeExtent(this.extent_),this.extentRevision_=this.getRevision());return h.default.returnOrUpdate(this.extent_,a)};a.prototype.rotate=function(a,b){};a.prototype.scale=function(a,b,c){};a.prototype.simplify=function(a){return this.getSimplifiedGeometry(a*a)};a.prototype.getSimplifiedGeometry=function(a){};a.prototype.getType=function(){};a.prototype.applyTransform=function(a){};a.prototype.intersectsExtent=function(a){};a.prototype.translate=function(a,b){};a.prototype.transform=function(a,
b){var c=this.tmpTransform_;a=f.default.get(a);var d=a.getUnits()==l.default.TILE_PIXELS?function(d,e,l){var m=a.getExtent(),p=a.getWorldExtent();m=h.default.getHeight(p)/h.default.getHeight(m);q.default.compose(c,p[0],p[3],m,-m,0,0,0);g.default.transform2D(d,0,d.length,l,c,e);return f.default.getTransform(a,b)(d,e,l)}:f.default.getTransform(a,b);this.applyTransform(d);return this};k.default=a},{"../extent.js":54,"../functions.js":60,"../geom/flat/transform.js":76,"../index.js":89,"../object.js":125,
"../proj.js":141,"../proj/units.js":148,"../transform.js":243}],78:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={XY:"XY",XYZ:"XYZ",XYM:"XYM",XYZM:"XYZM"}},{}],79:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={POINT:"Point",LINE_STRING:"LineString",LINEAR_RING:"LinearRing",POLYGON:"Polygon",MULTI_POINT:"MultiPoint",MULTI_LINE_STRING:"MultiLineString",MULTI_POLYGON:"MultiPolygon",GEOMETRY_COLLECTION:"GeometryCollection",CIRCLE:"Circle"}},
{}],80:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../extent.js"),b=d(c);c=a("../geom/geometrylayout.js");var h=d(c);c=a("../geom/geometrytype.js");var n=d(c);c=a("../geom/simplegeometry.js");var g=d(c);c=a("../geom/flat/area.js");var f=d(c);c=a("../geom/flat/closest.js");var l=d(c);c=a("../geom/flat/deflate.js");var q=d(c);c=a("../geom/flat/inflate.js");var m=d(c);a=a("../geom/flat/simplify.js");
var p=d(a),r=function(a,b){g.default.call(this);this.maxDeltaRevision_=this.maxDelta_=-1;this.setCoordinates(a,b)};e.default.inherits(r,g.default);r.prototype.clone=function(){var a=new r(null);a.setFlatCoordinates(this.layout,this.flatCoordinates.slice());return a};r.prototype.closestPointXY=function(a,c,f,d){if(d<b.default.closestSquaredDistanceXY(this.getExtent(),a,c))return d;this.maxDeltaRevision_!=this.getRevision()&&(this.maxDelta_=Math.sqrt(l.default.getMaxSquaredDelta(this.flatCoordinates,
0,this.flatCoordinates.length,this.stride,0)),this.maxDeltaRevision_=this.getRevision());return l.default.getClosestPoint(this.flatCoordinates,0,this.flatCoordinates.length,this.stride,this.maxDelta_,!0,a,c,f,d)};r.prototype.getArea=function(){return f.default.linearRing(this.flatCoordinates,0,this.flatCoordinates.length,this.stride)};r.prototype.getCoordinates=function(){return m.default.coordinates(this.flatCoordinates,0,this.flatCoordinates.length,this.stride)};r.prototype.getSimplifiedGeometryInternal=
function(a){var b=[];b.length=p.default.douglasPeucker(this.flatCoordinates,0,this.flatCoordinates.length,this.stride,a,b,0);a=new r(null);a.setFlatCoordinates(h.default.XY,b);return a};r.prototype.getType=function(){return n.default.LINEAR_RING};r.prototype.intersectsExtent=function(a){};r.prototype.setCoordinates=function(a,b){a?(this.setLayout(b,a,1),this.flatCoordinates||(this.flatCoordinates=[]),this.flatCoordinates.length=q.default.coordinates(this.flatCoordinates,0,a,this.stride),this.changed()):
this.setFlatCoordinates(h.default.XY,null)};r.prototype.setFlatCoordinates=function(a,b){this.setFlatCoordinatesInternal(a,b);this.changed()};k.default=r},{"../extent.js":54,"../geom/flat/area.js":61,"../geom/flat/closest.js":62,"../geom/flat/deflate.js":64,"../geom/flat/inflate.js":65,"../geom/flat/simplify.js":72,"../geom/geometrylayout.js":78,"../geom/geometrytype.js":79,"../geom/simplegeometry.js":83,"../index.js":89}],81:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,
"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../extent.js"),b=d(c);c=a("../geom/geometrylayout.js");var h=d(c);c=a("../geom/geometrytype.js");var n=d(c);c=a("../geom/simplegeometry.js");var g=d(c);c=a("../geom/flat/deflate.js");var f=d(c);a=a("../math.js");var l=d(a),q=function(a,b){g.default.call(this);this.setCoordinates(a,b)};e.default.inherits(q,g.default);q.prototype.clone=function(){var a=new q(null);a.setFlatCoordinates(this.layout,this.flatCoordinates.slice());return a};q.prototype.closestPointXY=
function(a,b,c,f){var d=this.flatCoordinates;a=l.default.squaredDistance(a,b,d[0],d[1]);if(a<f){f=this.stride;for(b=0;b<f;++b)c[b]=d[b];c.length=f;return a}return f};q.prototype.getCoordinates=function(){return this.flatCoordinates?this.flatCoordinates.slice():[]};q.prototype.computeExtent=function(a){return b.default.createOrUpdateFromCoordinate(this.flatCoordinates,a)};q.prototype.getType=function(){return n.default.POINT};q.prototype.intersectsExtent=function(a){return b.default.containsXY(a,this.flatCoordinates[0],
this.flatCoordinates[1])};q.prototype.setCoordinates=function(a,b){a?(this.setLayout(b,a,0),this.flatCoordinates||(this.flatCoordinates=[]),this.flatCoordinates.length=f.default.coordinate(this.flatCoordinates,0,a,this.stride),this.changed()):this.setFlatCoordinates(h.default.XY,null)};q.prototype.setFlatCoordinates=function(a,b){this.setFlatCoordinatesInternal(a,b);this.changed()};k.default=q},{"../extent.js":54,"../geom/flat/deflate.js":64,"../geom/geometrylayout.js":78,"../geom/geometrytype.js":79,
"../geom/simplegeometry.js":83,"../index.js":89,"../math.js":123}],82:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../array.js"),b=d(c);c=a("../extent.js");var h=d(c);c=a("../geom/geometrylayout.js");var n=d(c);c=a("../geom/geometrytype.js");var g=d(c);c=a("../geom/linearring.js");var f=d(c);c=a("../geom/point.js");var l=d(c);c=a("../geom/simplegeometry.js");var q=d(c);c=a("../geom/flat/area.js");
var m=d(c);c=a("../geom/flat/closest.js");var p=d(c);c=a("../geom/flat/contains.js");var r=d(c);c=a("../geom/flat/deflate.js");var t=d(c);c=a("../geom/flat/inflate.js");var u=d(c);c=a("../geom/flat/interiorpoint.js");var y=d(c);c=a("../geom/flat/intersectsextent.js");var w=d(c);c=a("../geom/flat/orient.js");var v=d(c);c=a("../geom/flat/simplify.js");var A=d(c);a=a("../math.js");var B=d(a),x=function(a,b){q.default.call(this);this.ends_=[];this.flatInteriorPointRevision_=-1;this.flatInteriorPoint_=
null;this.orientedRevision_=this.maxDeltaRevision_=this.maxDelta_=-1;this.orientedFlatCoordinates_=null;this.setCoordinates(a,b)};e.default.inherits(x,q.default);x.prototype.appendLinearRing=function(a){this.flatCoordinates?b.default.extend(this.flatCoordinates,a.getFlatCoordinates()):this.flatCoordinates=a.getFlatCoordinates().slice();this.ends_.push(this.flatCoordinates.length);this.changed()};x.prototype.clone=function(){var a=new x(null);a.setFlatCoordinates(this.layout,this.flatCoordinates.slice(),
this.ends_.slice());return a};x.prototype.closestPointXY=function(a,b,c,f){if(f<h.default.closestSquaredDistanceXY(this.getExtent(),a,b))return f;this.maxDeltaRevision_!=this.getRevision()&&(this.maxDelta_=Math.sqrt(p.default.getsMaxSquaredDelta(this.flatCoordinates,0,this.ends_,this.stride,0)),this.maxDeltaRevision_=this.getRevision());return p.default.getsClosestPoint(this.flatCoordinates,0,this.ends_,this.stride,this.maxDelta_,!0,a,b,c,f)};x.prototype.containsXY=function(a,b){return r.default.linearRingsContainsXY(this.getOrientedFlatCoordinates(),
0,this.ends_,this.stride,a,b)};x.prototype.getArea=function(){return m.default.linearRings(this.getOrientedFlatCoordinates(),0,this.ends_,this.stride)};x.prototype.getCoordinates=function(a){if(void 0!==a){var b=this.getOrientedFlatCoordinates().slice();v.default.orientLinearRings(b,0,this.ends_,this.stride,a)}else b=this.flatCoordinates;return u.default.coordinatess(b,0,this.ends_,this.stride)};x.prototype.getEnds=function(){return this.ends_};x.prototype.getFlatInteriorPoint=function(){if(this.flatInteriorPointRevision_!=
this.getRevision()){var a=h.default.getCenter(this.getExtent());this.flatInteriorPoint_=y.default.linearRings(this.getOrientedFlatCoordinates(),0,this.ends_,this.stride,a,0);this.flatInteriorPointRevision_=this.getRevision()}return this.flatInteriorPoint_};x.prototype.getInteriorPoint=function(){return new l.default(this.getFlatInteriorPoint(),n.default.XYM)};x.prototype.getLinearRingCount=function(){return this.ends_.length};x.prototype.getLinearRing=function(a){if(0>a||this.ends_.length<=a)return null;
var b=new f.default(null);b.setFlatCoordinates(this.layout,this.flatCoordinates.slice(0===a?0:this.ends_[a-1],this.ends_[a]));return b};x.prototype.getLinearRings=function(){var a=this.layout,b=this.flatCoordinates,c=this.ends_,d=[],e=0,g;var l=0;for(g=c.length;l<g;++l){var m=c[l],p=new f.default(null);p.setFlatCoordinates(a,b.slice(e,m));d.push(p);e=m}return d};x.prototype.getOrientedFlatCoordinates=function(){if(this.orientedRevision_!=this.getRevision()){var a=this.flatCoordinates;v.default.linearRingsAreOriented(a,
0,this.ends_,this.stride)?this.orientedFlatCoordinates_=a:(this.orientedFlatCoordinates_=a.slice(),this.orientedFlatCoordinates_.length=v.default.orientLinearRings(this.orientedFlatCoordinates_,0,this.ends_,this.stride));this.orientedRevision_=this.getRevision()}return this.orientedFlatCoordinates_};x.prototype.getSimplifiedGeometryInternal=function(a){var b=[],c=[];b.length=A.default.quantizes(this.flatCoordinates,0,this.ends_,this.stride,Math.sqrt(a),b,0,c);a=new x(null);a.setFlatCoordinates(n.default.XY,
b,c);return a};x.prototype.getType=function(){return g.default.POLYGON};x.prototype.intersectsExtent=function(a){return w.default.linearRings(this.getOrientedFlatCoordinates(),0,this.ends_,this.stride,a)};x.prototype.setCoordinates=function(a,b){a?(this.setLayout(b,a,2),this.flatCoordinates||(this.flatCoordinates=[]),a=t.default.coordinatess(this.flatCoordinates,0,a,this.stride,this.ends_),this.flatCoordinates.length=0===a.length?0:a[a.length-1],this.changed()):this.setFlatCoordinates(n.default.XY,
null,this.ends_)};x.prototype.setFlatCoordinates=function(a,b,c){this.setFlatCoordinatesInternal(a,b);this.ends_=c;this.changed()};x.circular=function(a,c,f,d){var e=d?d:32;d=[];var g;for(g=0;g<e;++g)b.default.extend(d,a.offset(c,f,2*Math.PI*g/e));d.push(d[0],d[1]);a=new x(null);a.setFlatCoordinates(n.default.XY,d,[d.length]);return a};x.fromExtent=function(a){var b=a[0],c=a[1],f=a[2];a=a[3];b=[b,c,b,a,f,a,f,c,b,c];c=new x(null);c.setFlatCoordinates(n.default.XY,b,[b.length]);return c};x.fromCircle=
function(a,b,c){var f=b?b:32,d=a.getStride();b=a.getLayout();var e=new x(null,b);f=d*(f+1);d=Array(f);for(var g=0;g<f;g++)d[g]=0;e.setFlatCoordinates(b,d,[d.length]);x.makeRegular(e,a.getCenter(),a.getRadius(),c);return e};x.makeRegular=function(a,b,c,f){var d=a.getFlatCoordinates(),e=a.getLayout(),g=a.getStride(),l=a.getEnds(),m=d.length/g-1;f=f?f:0;for(var p,h,t=0;t<=m;++t)h=t*g,p=f+2*B.default.modulo(t,m)*Math.PI/m,d[h]=b[0]+c*Math.cos(p),d[h+1]=b[1]+c*Math.sin(p);a.setFlatCoordinates(e,d,l)};
k.default=x},{"../array.js":29,"../extent.js":54,"../geom/flat/area.js":61,"../geom/flat/closest.js":62,"../geom/flat/contains.js":63,"../geom/flat/deflate.js":64,"../geom/flat/inflate.js":65,"../geom/flat/interiorpoint.js":66,"../geom/flat/intersectsextent.js":67,"../geom/flat/orient.js":69,"../geom/flat/simplify.js":72,"../geom/geometrylayout.js":78,"../geom/geometrytype.js":79,"../geom/linearring.js":80,"../geom/point.js":81,"../geom/simplegeometry.js":83,"../index.js":89,"../math.js":123}],83:[function(a,
e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../functions.js");c=d(c);var b=a("../extent.js"),h=d(b);b=a("../geom/geometry.js");var n=d(b);b=a("../geom/geometrylayout.js");var g=d(b);b=a("../geom/flat/transform.js");var f=d(b);a=a("../obj.js");var l=d(a),q=function(){n.default.call(this);this.layout=g.default.XY;this.stride=2;this.flatCoordinates=null};e.default.inherits(q,n.default);q.getLayoutForStride_=
function(a){if(2==a)var b=g.default.XY;else 3==a?b=g.default.XYZ:4==a&&(b=g.default.XYZM);return b};q.getStrideForLayout=function(a){var b;a==g.default.XY?b=2:a==g.default.XYZ||a==g.default.XYM?b=3:a==g.default.XYZM&&(b=4);return b};q.prototype.containsXY=c.default.FALSE;q.prototype.computeExtent=function(a){return h.default.createOrUpdateFromFlatCoordinates(this.flatCoordinates,0,this.flatCoordinates.length,this.stride,a)};q.prototype.getCoordinates=function(){};q.prototype.getFirstCoordinate=function(){return this.flatCoordinates.slice(0,
this.stride)};q.prototype.getFlatCoordinates=function(){return this.flatCoordinates};q.prototype.getLastCoordinate=function(){return this.flatCoordinates.slice(this.flatCoordinates.length-this.stride)};q.prototype.getLayout=function(){return this.layout};q.prototype.getSimplifiedGeometry=function(a){this.simplifiedGeometryRevision!=this.getRevision()&&(l.default.clear(this.simplifiedGeometryCache),this.simplifiedGeometryMaxMinSquaredTolerance=0,this.simplifiedGeometryRevision=this.getRevision());
if(0>a||0!==this.simplifiedGeometryMaxMinSquaredTolerance&&a<=this.simplifiedGeometryMaxMinSquaredTolerance)return this;var b=a.toString();if(this.simplifiedGeometryCache.hasOwnProperty(b))return this.simplifiedGeometryCache[b];var c=this.getSimplifiedGeometryInternal(a);if(c.getFlatCoordinates().length<this.flatCoordinates.length)return this.simplifiedGeometryCache[b]=c;this.simplifiedGeometryMaxMinSquaredTolerance=a;return this};q.prototype.getSimplifiedGeometryInternal=function(a){return this};
q.prototype.getStride=function(){return this.stride};q.prototype.setFlatCoordinatesInternal=function(a,b){this.stride=q.getStrideForLayout(a);this.layout=a;this.flatCoordinates=b};q.prototype.setCoordinates=function(a,b){};q.prototype.setLayout=function(a,b,c){if(a)b=q.getStrideForLayout(a);else{for(a=0;a<c;++a){if(0===b.length){this.layout=g.default.XY;this.stride=2;return}b=b[0]}b=b.length;a=q.getLayoutForStride_(b)}this.layout=a;this.stride=b};q.prototype.applyTransform=function(a){this.flatCoordinates&&
(a(this.flatCoordinates,this.flatCoordinates,this.stride),this.changed())};q.prototype.rotate=function(a,b){var c=this.getFlatCoordinates();if(c){var d=this.getStride();f.default.rotate(c,0,c.length,d,a,b,c);this.changed()}};q.prototype.scale=function(a,b,c){void 0===b&&(b=a);c||(c=h.default.getCenter(this.getExtent()));var d=this.getFlatCoordinates();if(d){var e=this.getStride();f.default.scale(d,0,d.length,e,a,b,c,d);this.changed()}};q.prototype.translate=function(a,b){var c=this.getFlatCoordinates();
if(c){var d=this.getStride();f.default.translate(c,0,c.length,d,a,b,c);this.changed()}};q.transform2D=function(a,b,c){var d=a.getFlatCoordinates();return d?(a=a.getStride(),f.default.transform2D(d,0,d.length,a,b,c)):null};k.default=q},{"../extent.js":54,"../functions.js":60,"../geom/flat/transform.js":76,"../geom/geometry.js":77,"../geom/geometrylayout.js":78,"../index.js":89,"../obj.js":124}],84:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(e=a("./index.js"))&&e.__esModule?
e:{default:e},c=(a=a("./webgl.js"))&&a.__esModule?a:{default:a},b={};a="undefined"!==typeof navigator?navigator.userAgent.toLowerCase():"";b.FIREFOX=-1!==a.indexOf("firefox");b.SAFARI=-1!==a.indexOf("safari")&&-1==a.indexOf("chrom");b.WEBKIT=-1!==a.indexOf("webkit")&&-1==a.indexOf("edge");b.MAC=-1!==a.indexOf("macintosh");b.DEVICE_PIXEL_RATIO=window.devicePixelRatio||1;b.CANVAS_LINE_DASH=!1;b.CANVAS=d.default.ENABLE_CANVAS&&function(){if(!("HTMLCanvasElement"in window))return!1;try{var a=document.createElement("CANVAS").getContext("2d");
return a?(void 0!==a.setLineDash&&(b.CANVAS_LINE_DASH=!0),!0):!1}catch(n){return!1}}();b.DEVICE_ORIENTATION="DeviceOrientationEvent"in window;b.GEOLOCATION="geolocation"in navigator;b.TOUCH=d.default.ASSUME_TOUCH||"ontouchstart"in window;b.POINTER="PointerEvent"in window;b.MSPOINTER=!!navigator.msPointerEnabled;b.WEBGL;(function(){if(d.default.ENABLE_WEBGL){var a=!1,e=[];if("WebGLRenderingContext"in window)try{var g=document.createElement("CANVAS"),f=c.default.getContext(g,{failIfMajorPerformanceCaveat:!0});
if(f){a=!0;var l=f.getParameter(f.MAX_TEXTURE_SIZE);e=f.getSupportedExtensions()}}catch(q){}b.WEBGL=a;d.default.WEBGL_EXTENSIONS=e;d.default.WEBGL_MAX_TEXTURE_SIZE=l}})();k.default=b},{"./index.js":89,"./webgl.js":248}],85:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./imagebase.js"),b=d(c);c=a("./imagestate.js");var h=d(c);c=a("./events.js");var n=d(c);c=a("./events/eventtype.js");var g=d(c);
a=a("./extent.js");var f=d(a);a=function(a,c,f,d,e,g){b.default.call(this,a,c,f,h.default.IDLE);this.src_=d;this.image_=new Image;null!==e&&(this.image_.crossOrigin=e);this.imageListenerKeys_=null;this.state=h.default.IDLE;this.imageLoadFunction_=g};e.default.inherits(a,b.default);a.prototype.getImage=function(){return this.image_};a.prototype.handleImageError_=function(){this.state=h.default.ERROR;this.unlistenImage_();this.changed()};a.prototype.handleImageLoad_=function(){void 0===this.resolution&&
(this.resolution=f.default.getHeight(this.extent)/this.image_.height);this.state=h.default.LOADED;this.unlistenImage_();this.changed()};a.prototype.load=function(){if(this.state==h.default.IDLE||this.state==h.default.ERROR)this.state=h.default.LOADING,this.changed(),this.imageListenerKeys_=[n.default.listenOnce(this.image_,g.default.ERROR,this.handleImageError_,this),n.default.listenOnce(this.image_,g.default.LOAD,this.handleImageLoad_,this)],this.imageLoadFunction_(this,this.src_)};a.prototype.setImage=
function(a){this.image_=a};a.prototype.unlistenImage_=function(){this.imageListenerKeys_.forEach(n.default.unlistenByKey);this.imageListenerKeys_=null};k.default=a},{"./events.js":48,"./events/eventtype.js":52,"./extent.js":54,"./imagebase.js":86,"./imagestate.js":88,"./index.js":89}],86:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./events/eventtarget.js"),b=d(c);a=a("./events/eventtype.js");
var h=d(a);a=function(a,c,f,d){b.default.call(this);this.extent=a;this.pixelRatio_=f;this.resolution=c;this.state=d};e.default.inherits(a,b.default);a.prototype.changed=function(){this.dispatchEvent(h.default.CHANGE)};a.prototype.getExtent=function(){return this.extent};a.prototype.getImage=function(){};a.prototype.getPixelRatio=function(){return this.pixelRatio_};a.prototype.getResolution=function(){return this.resolution};a.prototype.getState=function(){return this.state};a.prototype.load=function(){};
k.default=a},{"./events/eventtarget.js":51,"./events/eventtype.js":52,"./index.js":89}],87:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./imagebase.js"),b=d(c);a=a("./imagestate.js");var h=d(a);a=function(a,c,f,d,e){this.loader_=void 0!==e?e:null;b.default.call(this,a,c,f,void 0!==e?h.default.IDLE:h.default.LOADED);this.canvas_=d;this.error_=null};e.default.inherits(a,b.default);a.prototype.getError=
function(){return this.error_};a.prototype.handleLoad_=function(a){a?(this.error_=a,this.state=h.default.ERROR):this.state=h.default.LOADED;this.changed()};a.prototype.load=function(){this.state==h.default.IDLE&&(this.state=h.default.LOADING,this.changed(),this.loader_(this.handleLoad_.bind(this)))};a.prototype.getImage=function(){return this.canvas_};k.default=a},{"./imagebase.js":86,"./imagestate.js":88,"./index.js":89}],88:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default=
{IDLE:0,LOADING:1,LOADED:2,ERROR:3}},{}],89:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d={ASSUME_TOUCH:!1,DEFAULT_MAX_ZOOM:42,DEFAULT_MIN_ZOOM:0,DEFAULT_RASTER_REPROJECTION_ERROR_THRESHOLD:.5,DEFAULT_TILE_SIZE:256,DEFAULT_WMS_VERSION:"1.3.0",ENABLE_CANVAS:!0,ENABLE_PROJ4JS:!0,ENABLE_RASTER_REPROJECTION:!0,ENABLE_WEBGL:!0,DEBUG_WEBGL:!0,INITIAL_ATLAS_SIZE:256,MAX_ATLAS_SIZE:-1,MOUSEWHEELZOOM_MAXDELTA:1,OVERVIEWMAP_MAX_RATIO:.75,OVERVIEWMAP_MIN_RATIO:.1,RASTER_REPROJECTION_MAX_SOURCE_TILES:100,
RASTER_REPROJECTION_MAX_SUBDIVISION:10,RASTER_REPROJECTION_MAX_TRIANGLE_WIDTH:.25,SIMPLIFY_TOLERANCE:.5,WEBGL_TEXTURE_CACHE_HIGH_WATER_MARK:1024,VERSION:"v4.6.4"};d.WEBGL_MAX_TEXTURE_SIZE;d.WEBGL_EXTENSIONS;d.inherits=function(a,b){a.prototype=Object.create(b.prototype);a.prototype.constructor=a};d.nullFunction=function(){};d.getUid=function(a){return a.ol_uid||(a.ol_uid=++d.uidCounter_)};d.uidCounter_=0;k.default=d},{}],90:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,
"__esModule",{value:!0});e=a("./collection.js");var c=d(e);e=a("./kinetic.js");var b=d(e);e=a("./interaction/doubleclickzoom.js");var h=d(e);e=a("./interaction/dragpan.js");var n=d(e);e=a("./interaction/dragrotate.js");var g=d(e);e=a("./interaction/dragzoom.js");var f=d(e);e=a("./interaction/keyboardpan.js");var l=d(e);e=a("./interaction/keyboardzoom.js");var q=d(e);e=a("./interaction/mousewheelzoom.js");var m=d(e);e=a("./interaction/pinchrotate.js");var p=d(e);a=a("./interaction/pinchzoom.js");var r=
d(a);k.default={defaults:function(a){a=a?a:{};var d=new c.default,e=new b.default(-.005,.05,100);(void 0!==a.altShiftDragRotate?a.altShiftDragRotate:1)&&d.push(new g.default);(void 0!==a.doubleClickZoom?a.doubleClickZoom:1)&&d.push(new h.default({delta:a.zoomDelta,duration:a.zoomDuration}));(void 0!==a.dragPan?a.dragPan:1)&&d.push(new n.default({kinetic:e}));(void 0!==a.pinchRotate?a.pinchRotate:1)&&d.push(new p.default);(void 0!==a.pinchZoom?a.pinchZoom:1)&&d.push(new r.default({constrainResolution:a.constrainResolution,
duration:a.zoomDuration}));if(void 0!==a.keyboard?a.keyboard:1)d.push(new l.default),d.push(new q.default({delta:a.zoomDelta,duration:a.zoomDuration}));(void 0!==a.mouseWheelZoom?a.mouseWheelZoom:1)&&d.push(new m.default({constrainResolution:a.constrainResolution,duration:a.zoomDuration}));(void 0!==a.shiftDragZoom?a.shiftDragZoom:1)&&d.push(new f.default({duration:a.zoomDuration}));return d}}},{"./collection.js":34,"./interaction/doubleclickzoom.js":91,"./interaction/dragpan.js":93,"./interaction/dragrotate.js":94,
"./interaction/dragzoom.js":95,"./interaction/keyboardpan.js":97,"./interaction/keyboardzoom.js":98,"./interaction/mousewheelzoom.js":99,"./interaction/pinchrotate.js":100,"./interaction/pinchzoom.js":101,"./kinetic.js":104}],91:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../mapbrowsereventtype.js"),b=d(c);a=a("../interaction/interaction.js");var h=d(a),n=function(a){a=a?a:{};this.delta_=a.delta?
a.delta:1;h.default.call(this,{handleEvent:n.handleEvent});this.duration_=void 0!==a.duration?a.duration:250};e.default.inherits(n,h.default);n.handleEvent=function(a){var c=!1,d=a.originalEvent;if(a.type==b.default.DBLCLICK){c=a.coordinate;d=d.shiftKey?-this.delta_:this.delta_;var e=a.map.getView();h.default.zoomByDelta(e,d,c,this.duration_);a.preventDefault();c=!0}return!c};k.default=n},{"../index.js":89,"../interaction/interaction.js":96,"../mapbrowsereventtype.js":118}],92:[function(a,e,k){function d(a){return a&&
a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../events/event.js");var c=d(e);e=a("../index.js");e=d(e);var b=a("../events/condition.js"),h=d(b);b=a("../interaction/pointer.js");var n=d(b);a=a("../render/box.js");var g=d(a),f=function(a){n.default.call(this,{handleDownEvent:f.handleDownEvent_,handleDragEvent:f.handleDragEvent_,handleUpEvent:f.handleUpEvent_});a=a?a:{};this.box_=new g.default(a.className||"ol-dragbox");this.minArea_=void 0!==a.minArea?a.minArea:64;
this.startPixel_=null;this.condition_=a.condition?a.condition:h.default.always;this.boxEndCondition_=a.boxEndCondition?a.boxEndCondition:f.defaultBoxEndCondition};e.default.inherits(f,n.default);f.defaultBoxEndCondition=function(a,b,c){a=c[0]-b[0];b=c[1]-b[1];return a*a+b*b>=this.minArea_};f.handleDragEvent_=function(a){h.default.mouseOnly(a)&&(this.box_.setPixels(this.startPixel_,a.pixel),this.dispatchEvent(new f.Event(f.EventType_.BOXDRAG,a.coordinate,a)))};f.prototype.getGeometry=function(){return this.box_.getGeometry()};
f.prototype.onBoxEnd=e.default.nullFunction;f.handleUpEvent_=function(a){if(!h.default.mouseOnly(a))return!0;this.box_.setMap(null);this.boxEndCondition_(a,this.startPixel_,a.pixel)&&(this.onBoxEnd(a),this.dispatchEvent(new f.Event(f.EventType_.BOXEND,a.coordinate,a)));return!1};f.handleDownEvent_=function(a){return h.default.mouseOnly(a)&&h.default.mouseActionButton(a)&&this.condition_(a)?(this.startPixel_=a.pixel,this.box_.setMap(a.map),this.box_.setPixels(this.startPixel_,this.startPixel_),this.dispatchEvent(new f.Event(f.EventType_.BOXSTART,
a.coordinate,a)),!0):!1};f.EventType_={BOXSTART:"boxstart",BOXDRAG:"boxdrag",BOXEND:"boxend"};f.Event=function(a,b,f){c.default.call(this,a);this.coordinate=b;this.mapBrowserEvent=f};e.default.inherits(f.Event,c.default);k.default=f},{"../events/condition.js":49,"../events/event.js":50,"../index.js":89,"../interaction/pointer.js":102,"../render/box.js":149}],93:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=
d(e);var c=a("../viewhint.js"),b=d(c);c=a("../coordinate.js");var h=d(c);c=a("../easing.js");var n=d(c);c=a("../events/condition.js");var g=d(c);c=a("../functions.js");c=d(c);a=a("../interaction/pointer.js");var f=d(a),l=function(a){f.default.call(this,{handleDownEvent:l.handleDownEvent_,handleDragEvent:l.handleDragEvent_,handleUpEvent:l.handleUpEvent_});a=a?a:{};this.kinetic_=a.kinetic;this.lastCentroid=null;this.lastPointersCount_;this.condition_=a.condition?a.condition:g.default.noModifierKeys;
this.noKinetic_=!1};e.default.inherits(l,f.default);l.handleDragEvent_=function(a){var b=this.targetPointers,c=f.default.centroid(b);if(b.length==this.lastPointersCount_){if(this.kinetic_&&this.kinetic_.update(c[0],c[1]),this.lastCentroid){var d=this.lastCentroid[0]-c[0],e=c[1]-this.lastCentroid[1];a=a.map.getView();var g=a.getState();d=[d,e];h.default.scale(d,g.resolution);h.default.rotate(d,g.rotation);h.default.add(d,g.center);d=a.constrainCenter(d);a.setCenter(d)}}else this.kinetic_&&this.kinetic_.begin();
this.lastCentroid=c;this.lastPointersCount_=b.length};l.handleUpEvent_=function(a){var c=a.map;a=c.getView();if(0===this.targetPointers.length){if(!this.noKinetic_&&this.kinetic_&&this.kinetic_.end()){var f=this.kinetic_.getDistance(),d=this.kinetic_.getAngle(),e=a.getCenter();e=c.getPixelFromCoordinate(e);c=c.getCoordinateFromPixel([e[0]-f*Math.cos(d),e[1]-f*Math.sin(d)]);a.animate({center:a.constrainCenter(c),duration:500,easing:n.default.easeOut})}a.setHint(b.default.INTERACTING,-1);return!1}this.kinetic_&&
this.kinetic_.begin();this.lastCentroid=null;return!0};l.handleDownEvent_=function(a){if(0<this.targetPointers.length&&this.condition_(a)){var c=a.map.getView();this.lastCentroid=null;this.handlingDownUpSequence||c.setHint(b.default.INTERACTING,1);c.getAnimating()&&c.setCenter(a.frameState.viewState.center);this.kinetic_&&this.kinetic_.begin();this.noKinetic_=1<this.targetPointers.length;return!0}return!1};l.prototype.shouldStopEvent=c.default.FALSE;k.default=l},{"../coordinate.js":43,"../easing.js":47,
"../events/condition.js":49,"../functions.js":60,"../index.js":89,"../interaction/pointer.js":102,"../viewhint.js":246}],94:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../rotationconstraint.js"),b=d(c);c=a("../viewhint.js");var h=d(c);c=a("../events/condition.js");var n=d(c);c=a("../functions.js");c=d(c);var g=a("../interaction/interaction.js"),f=d(g);a=a("../interaction/pointer.js");var l=
d(a),q=function(a){a=a?a:{};l.default.call(this,{handleDownEvent:q.handleDownEvent_,handleDragEvent:q.handleDragEvent_,handleUpEvent:q.handleUpEvent_});this.condition_=a.condition?a.condition:n.default.altShiftKeysOnly;this.lastAngle_=void 0;this.duration_=void 0!==a.duration?a.duration:250};e.default.inherits(q,l.default);q.handleDragEvent_=function(a){if(n.default.mouseOnly(a)){var c=a.map,d=c.getView();if(d.getConstraints().rotation!==b.default.disable){c=c.getSize();a=a.pixel;a=Math.atan2(c[1]/
2-a[1],a[0]-c[0]/2);if(void 0!==this.lastAngle_){c=a-this.lastAngle_;var e=d.getRotation();f.default.rotateWithoutConstraints(d,e-c)}this.lastAngle_=a}}};q.handleUpEvent_=function(a){if(!n.default.mouseOnly(a))return!0;a=a.map.getView();a.setHint(h.default.INTERACTING,-1);var b=a.getRotation();f.default.rotate(a,b,void 0,this.duration_);return!1};q.handleDownEvent_=function(a){return n.default.mouseOnly(a)&&n.default.mouseActionButton(a)&&this.condition_(a)?(a.map.getView().setHint(h.default.INTERACTING,
1),this.lastAngle_=void 0,!0):!1};q.prototype.shouldStopEvent=c.default.FALSE;k.default=q},{"../events/condition.js":49,"../functions.js":60,"../index.js":89,"../interaction/interaction.js":96,"../interaction/pointer.js":102,"../rotationconstraint.js":207,"../viewhint.js":246}],95:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../easing.js"),b=d(c);c=a("../events/condition.js");var h=d(c);c=a("../extent.js");
var n=d(c);a=a("../interaction/dragbox.js");var g=d(a);a=function(a){a=a?a:{};var b=a.condition?a.condition:h.default.shiftKeyOnly;this.duration_=void 0!==a.duration?a.duration:200;this.out_=void 0!==a.out?a.out:!1;g.default.call(this,{condition:b,className:a.className||"ol-dragzoom"})};e.default.inherits(a,g.default);a.prototype.onBoxEnd=function(){var a=this.getMap(),c=a.getView(),d=a.getSize(),e=this.getGeometry().getExtent();if(this.out_){var g=c.calculateExtent(d);e=n.default.createOrUpdateFromCoordinates([a.getPixelFromCoordinate(n.default.getBottomLeft(e)),
a.getPixelFromCoordinate(n.default.getTopRight(e))]);e=c.getResolutionForExtent(e,d);n.default.scaleFromCenter(g,1/e);e=g}d=c.constrainResolution(c.getResolutionForExtent(e,d));g=n.default.getCenter(e);g=c.constrainCenter(g);c.animate({resolution:d,center:g,duration:this.duration_,easing:b.default.easeOut})};k.default=a},{"../easing.js":47,"../events/condition.js":49,"../extent.js":54,"../index.js":89,"../interaction/dragbox.js":92}],96:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}
Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../object.js"),b=d(c);c=a("../easing.js");var h=d(c);c=a("../interaction/property.js");var n=d(c);a=a("../math.js");var g=d(a),f=function(a){b.default.call(this);this.map_=null;this.setActive(!0);this.handleEvent=a.handleEvent};e.default.inherits(f,b.default);f.prototype.getActive=function(){return this.get(n.default.ACTIVE)};f.prototype.getMap=function(){return this.map_};f.prototype.setActive=function(a){this.set(n.default.ACTIVE,
a)};f.prototype.setMap=function(a){this.map_=a};f.pan=function(a,b,c){var f=a.getCenter();f&&(b=a.constrainCenter([f[0]+b[0],f[1]+b[1]]),c?a.animate({duration:c,easing:h.default.linear,center:b}):a.setCenter(b))};f.rotate=function(a,b,c,d){b=a.constrainRotation(b,0);f.rotateWithoutConstraints(a,b,c,d)};f.rotateWithoutConstraints=function(a,b,c,f){if(void 0!==b){var d=a.getRotation(),e=a.getCenter();void 0!==d&&e&&0<f?a.animate({rotation:b,anchor:c,duration:f,easing:h.default.easeOut}):a.rotate(b,
c)}};f.zoom=function(a,b,c,d,e){b=a.constrainResolution(b,0,e);f.zoomWithoutConstraints(a,b,c,d)};f.zoomByDelta=function(a,b,c,d){var e=a.getResolution();b=a.constrainResolution(e,b,0);if(void 0!==b){var l=a.getResolutions();b=g.default.clamp(b,a.getMinResolution()||l[l.length-1],a.getMaxResolution()||l[0])}c&&void 0!==b&&b!==e&&(l=a.getCenter(),c=a.calculateCenterZoom(b,c),c=a.constrainCenter(c),c=[(b*l[0]-e*c[0])/(b-e),(b*l[1]-e*c[1])/(b-e)]);f.zoomWithoutConstraints(a,b,c,d)};f.zoomWithoutConstraints=
function(a,b,c,f){if(b){var d=a.getResolution(),e=a.getCenter();void 0!==d&&e&&b!==d&&f?a.animate({resolution:b,anchor:c,duration:f,easing:h.default.easeOut}):(c&&(c=a.calculateCenterZoom(b,c),a.setCenter(c)),a.setResolution(b))}};k.default=f},{"../easing.js":47,"../index.js":89,"../interaction/property.js":103,"../math.js":123,"../object.js":125}],97:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=
a("../coordinate.js"),b=d(c);c=a("../events/eventtype.js");var h=d(c);c=a("../events/keycode.js");var n=d(c);c=a("../events/condition.js");var g=d(c);a=a("../interaction/interaction.js");var f=d(a),l=function(a){f.default.call(this,{handleEvent:l.handleEvent});a=a||{};this.defaultCondition_=function(a){return g.default.noModifierKeys(a)&&g.default.targetNotEditable(a)};this.condition_=void 0!==a.condition?a.condition:this.defaultCondition_;this.duration_=void 0!==a.duration?a.duration:100;this.pixelDelta_=
void 0!==a.pixelDelta?a.pixelDelta:128};e.default.inherits(l,f.default);l.handleEvent=function(a){var c=!1;if(a.type==h.default.KEYDOWN){var d=a.originalEvent.keyCode;if(this.condition_(a)&&(d==n.default.DOWN||d==n.default.LEFT||d==n.default.RIGHT||d==n.default.UP)){c=a.map.getView();var e=c.getResolution()*this.pixelDelta_,g=0,l=0;d==n.default.DOWN?l=-e:d==n.default.LEFT?g=-e:d==n.default.RIGHT?g=e:l=e;d=[g,l];b.default.rotate(d,c.getRotation());f.default.pan(c,d,this.duration_);a.preventDefault();
c=!0}}return!c};k.default=l},{"../coordinate.js":43,"../events/condition.js":49,"../events/eventtype.js":52,"../events/keycode.js":53,"../index.js":89,"../interaction/interaction.js":96}],98:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../events/eventtype.js"),b=d(c);c=a("../events/condition.js");var h=d(c);a=a("../interaction/interaction.js");var n=d(a),g=function(a){n.default.call(this,{handleEvent:g.handleEvent});
a=a?a:{};this.condition_=a.condition?a.condition:h.default.targetNotEditable;this.delta_=a.delta?a.delta:1;this.duration_=void 0!==a.duration?a.duration:100};e.default.inherits(g,n.default);g.handleEvent=function(a){var c=!1;if(a.type==b.default.KEYDOWN||a.type==b.default.KEYPRESS){var f=a.originalEvent.charCode;!this.condition_(a)||43!=f&&45!=f||(c=43==f?this.delta_:-this.delta_,f=a.map.getView(),n.default.zoomByDelta(f,c,void 0,this.duration_),a.preventDefault(),c=!0)}return!c};k.default=g},{"../events/condition.js":49,
"../events/eventtype.js":52,"../index.js":89,"../interaction/interaction.js":96}],99:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");var c=d(e);e=a("../viewhint.js");var b=d(e);e=a("../easing.js");var h=d(e);e=a("../events/eventtype.js");var n=d(e);e=a("../has.js");var g=d(e);e=a("../interaction/interaction.js");var f=d(e);a=a("../math.js");var l=d(a),q=function(a){f.default.call(this,{handleEvent:q.handleEvent});
a=a||{};this.delta_=0;this.duration_=void 0!==a.duration?a.duration:250;this.timeout_=void 0!==a.timeout?a.timeout:80;this.useAnchor_=void 0!==a.useAnchor?a.useAnchor:!0;this.constrainResolution_=a.constrainResolution||!1;this.lastAnchor_=null;this.mode_=this.timeoutId_=this.startTime_=void 0;this.trackpadEventGap_=400;this.trackpadTimeoutId_=void 0;this.trackpadDeltaPerZoom_=300;this.trackpadZoomBuffer_=1.5};c.default.inherits(q,f.default);q.handleEvent=function(a){var c=a.type;if(c!==n.default.WHEEL&&
c!==n.default.MOUSEWHEEL)return!0;a.preventDefault();c=a.map;var f=a.originalEvent;this.useAnchor_&&(this.lastAnchor_=a.coordinate);if(a.type==n.default.WHEEL){var d=f.deltaY;g.default.FIREFOX&&f.deltaMode===WheelEvent.DOM_DELTA_PIXEL&&(d/=g.default.DEVICE_PIXEL_RATIO);f.deltaMode===WheelEvent.DOM_DELTA_LINE&&(d*=40)}else a.type==n.default.MOUSEWHEEL&&(d=-f.wheelDeltaY,g.default.SAFARI&&(d/=3));if(0===d)return!1;a=Date.now();void 0===this.startTime_&&(this.startTime_=a);if(!this.mode_||a-this.startTime_>
this.trackpadEventGap_)this.mode_=4>Math.abs(d)?q.Mode_.TRACKPAD:q.Mode_.WHEEL;if(this.mode_===q.Mode_.TRACKPAD){c=c.getView();this.trackpadTimeoutId_?clearTimeout(this.trackpadTimeoutId_):c.setHint(b.default.INTERACTING,1);this.trackpadTimeoutId_=setTimeout(this.decrementInteractingHint_.bind(this),this.trackpadEventGap_);f=c.getResolution()*Math.pow(2,d/this.trackpadDeltaPerZoom_);var e=c.getMinResolution(),l=c.getMaxResolution(),m=0;f<e?(f=Math.max(f,e/this.trackpadZoomBuffer_),m=1):f>l&&(f=Math.min(f,
l*this.trackpadZoomBuffer_),m=-1);if(this.lastAnchor_){var k=c.calculateCenterZoom(f,this.lastAnchor_);c.setCenter(c.constrainCenter(k))}c.setResolution(f);0===m&&this.constrainResolution_&&c.animate({resolution:c.constrainResolution(f,0<d?-1:1),easing:h.default.easeOut,anchor:this.lastAnchor_,duration:this.duration_});0<m?c.animate({resolution:e,easing:h.default.easeOut,anchor:this.lastAnchor_,duration:500}):0>m&&c.animate({resolution:l,easing:h.default.easeOut,anchor:this.lastAnchor_,duration:500});
this.startTime_=a;return!1}this.delta_+=d;d=Math.max(this.timeout_-(a-this.startTime_),0);clearTimeout(this.timeoutId_);this.timeoutId_=setTimeout(this.handleWheelZoom_.bind(this,c),d);return!1};q.prototype.decrementInteractingHint_=function(){this.trackpadTimeoutId_=void 0;this.getMap().getView().setHint(b.default.INTERACTING,-1)};q.prototype.handleWheelZoom_=function(a){a=a.getView();a.getAnimating()&&a.cancelAnimations();var b=c.default.MOUSEWHEELZOOM_MAXDELTA;b=l.default.clamp(this.delta_,-b,
b);f.default.zoomByDelta(a,-b,this.lastAnchor_,this.duration_);this.mode_=void 0;this.delta_=0;this.lastAnchor_=null;this.timeoutId_=this.startTime_=void 0};q.prototype.setMouseAnchor=function(a){this.useAnchor_=a;a||(this.lastAnchor_=null)};q.Mode_={TRACKPAD:"trackpad",WHEEL:"wheel"};k.default=q},{"../easing.js":47,"../events/eventtype.js":52,"../has.js":84,"../index.js":89,"../interaction/interaction.js":96,"../math.js":123,"../viewhint.js":246}],100:[function(a,e,k){function d(a){return a&&a.__esModule?
a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../viewhint.js"),b=d(c);c=a("../functions.js");c=d(c);var h=a("../interaction/interaction.js"),n=d(h);h=a("../interaction/pointer.js");var g=d(h);a=a("../rotationconstraint.js");var f=d(a),l=function(a){g.default.call(this,{handleDownEvent:l.handleDownEvent_,handleDragEvent:l.handleDragEvent_,handleUpEvent:l.handleUpEvent_});a=a||{};this.anchor_=null;this.lastAngle_=void 0;this.rotating_=!1;this.rotationDelta_=
0;this.threshold_=void 0!==a.threshold?a.threshold:.3;this.duration_=void 0!==a.duration?a.duration:250};e.default.inherits(l,g.default);l.handleDragEvent_=function(a){var b=0,c=this.targetPointers[0],d=this.targetPointers[1];c=Math.atan2(d.clientY-c.clientY,d.clientX-c.clientX);void 0!==this.lastAngle_&&(b=c-this.lastAngle_,this.rotationDelta_+=b,!this.rotating_&&Math.abs(this.rotationDelta_)>this.threshold_&&(this.rotating_=!0));this.lastAngle_=c;a=a.map;c=a.getView();if(c.getConstraints().rotation!==
f.default.disable){d=a.getViewport().getBoundingClientRect();var e=g.default.centroid(this.targetPointers);e[0]-=d.left;e[1]-=d.top;this.anchor_=a.getCoordinateFromPixel(e);this.rotating_&&(d=c.getRotation(),a.render(),n.default.rotateWithoutConstraints(c,d+b,this.anchor_))}};l.handleUpEvent_=function(a){if(2>this.targetPointers.length){a=a.map.getView();a.setHint(b.default.INTERACTING,-1);if(this.rotating_){var c=a.getRotation();n.default.rotate(a,c,this.anchor_,this.duration_)}return!1}return!0};
l.handleDownEvent_=function(a){return 2<=this.targetPointers.length?(a=a.map,this.anchor_=null,this.lastAngle_=void 0,this.rotating_=!1,this.rotationDelta_=0,this.handlingDownUpSequence||a.getView().setHint(b.default.INTERACTING,1),!0):!1};l.prototype.shouldStopEvent=c.default.FALSE;k.default=l},{"../functions.js":60,"../index.js":89,"../interaction/interaction.js":96,"../interaction/pointer.js":102,"../rotationconstraint.js":207,"../viewhint.js":246}],101:[function(a,e,k){function d(a){return a&&
a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../viewhint.js"),b=d(c);c=a("../functions.js");c=d(c);var h=a("../interaction/interaction.js"),n=d(h);a=a("../interaction/pointer.js");var g=d(a),f=function(a){g.default.call(this,{handleDownEvent:f.handleDownEvent_,handleDragEvent:f.handleDragEvent_,handleUpEvent:f.handleUpEvent_});a=a?a:{};this.constrainResolution_=a.constrainResolution||!1;this.anchor_=null;this.duration_=void 0!==a.duration?
a.duration:400;this.lastDistance_=void 0;this.lastScaleDelta_=1};e.default.inherits(f,g.default);f.handleDragEvent_=function(a){var b=1,c=this.targetPointers[0],f=this.targetPointers[1],d=c.clientX-f.clientX;c=c.clientY-f.clientY;d=Math.sqrt(d*d+c*c);void 0!==this.lastDistance_&&(b=this.lastDistance_/d);this.lastDistance_=d;a=a.map;d=a.getView();f=d.getResolution();var e=d.getMaxResolution(),l=d.getMinResolution();c=f*b;c>e?(b=e/f,c=e):c<l&&(b=l/f,c=l);1!=b&&(this.lastScaleDelta_=b);b=a.getViewport().getBoundingClientRect();
f=g.default.centroid(this.targetPointers);f[0]-=b.left;f[1]-=b.top;this.anchor_=a.getCoordinateFromPixel(f);a.render();n.default.zoomWithoutConstraints(d,c,this.anchor_)};f.handleUpEvent_=function(a){if(2>this.targetPointers.length){a=a.map.getView();a.setHint(b.default.INTERACTING,-1);var c=a.getResolution();(this.constrainResolution_||c<a.getMinResolution()||c>a.getMaxResolution())&&n.default.zoom(a,c,this.anchor_,this.duration_,this.lastScaleDelta_-1);return!1}return!0};f.handleDownEvent_=function(a){return 2<=
this.targetPointers.length?(a=a.map,this.anchor_=null,this.lastDistance_=void 0,this.lastScaleDelta_=1,this.handlingDownUpSequence||a.getView().setHint(b.default.INTERACTING,1),!0):!1};f.prototype.shouldStopEvent=c.default.FALSE;k.default=f},{"../functions.js":60,"../index.js":89,"../interaction/interaction.js":96,"../interaction/pointer.js":102,"../viewhint.js":246}],102:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");
e=d(e);var c=a("../functions.js");c=d(c);var b=a("../mapbrowsereventtype.js"),h=d(b);b=a("../mapbrowserpointerevent.js");var n=d(b);b=a("../interaction/interaction.js");var g=d(b);a=a("../obj.js");var f=d(a),l=function(a){a=a?a:{};g.default.call(this,{handleEvent:a.handleEvent?a.handleEvent:l.handleEvent});this.handleDownEvent_=a.handleDownEvent?a.handleDownEvent:l.handleDownEvent;this.handleDragEvent_=a.handleDragEvent?a.handleDragEvent:l.handleDragEvent;this.handleMoveEvent_=a.handleMoveEvent?a.handleMoveEvent:
l.handleMoveEvent;this.handleUpEvent_=a.handleUpEvent?a.handleUpEvent:l.handleUpEvent;this.handlingDownUpSequence=!1;this.trackedPointers_={};this.targetPointers=[]};e.default.inherits(l,g.default);l.centroid=function(a){for(var b=a.length,c=0,f=0,d=0;d<b;d++)c+=a[d].clientX,f+=a[d].clientY;return[c/b,f/b]};l.prototype.isPointerDraggingEvent_=function(a){a=a.type;return a===h.default.POINTERDOWN||a===h.default.POINTERDRAG||a===h.default.POINTERUP};l.prototype.updateTrackedPointers_=function(a){if(this.isPointerDraggingEvent_(a)){var b=
a.pointerEvent,c=b.pointerId.toString();a.type==h.default.POINTERUP?delete this.trackedPointers_[c]:a.type==h.default.POINTERDOWN?this.trackedPointers_[c]=b:c in this.trackedPointers_&&(this.trackedPointers_[c]=b);this.targetPointers=f.default.getValues(this.trackedPointers_)}};l.handleDragEvent=e.default.nullFunction;l.handleUpEvent=c.default.FALSE;l.handleDownEvent=c.default.FALSE;l.handleMoveEvent=e.default.nullFunction;l.handleEvent=function(a){if(!(a instanceof n.default))return!0;var b=!1;this.updateTrackedPointers_(a);
this.handlingDownUpSequence?a.type==h.default.POINTERDRAG?this.handleDragEvent_(a):a.type==h.default.POINTERUP&&(this.handlingDownUpSequence=this.handleUpEvent_(a)&&0<this.targetPointers.length):a.type==h.default.POINTERDOWN?(this.handlingDownUpSequence=a=this.handleDownEvent_(a),b=this.shouldStopEvent(a)):a.type==h.default.POINTERMOVE&&this.handleMoveEvent_(a);return!b};l.prototype.shouldStopEvent=function(a){return a};k.default=l},{"../functions.js":60,"../index.js":89,"../interaction/interaction.js":96,
"../mapbrowsereventtype.js":118,"../mapbrowserpointerevent.js":119,"../obj.js":124}],103:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={ACTIVE:"active"}},{}],104:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});a=function(a,c,b){this.decay_=a;this.minVelocity_=c;this.delay_=b;this.points_=[];this.initialVelocity_=this.angle_=0};a.prototype.begin=function(){this.initialVelocity_=this.angle_=this.points_.length=0};a.prototype.update=function(a,c){this.points_.push(a,
c,Date.now())};a.prototype.end=function(){if(6>this.points_.length)return!1;var a=Date.now()-this.delay_,c=this.points_.length-3;if(this.points_[c+2]<a)return!1;for(var b=c-3;0<b&&this.points_[b+2]>a;)b-=3;a=this.points_[c+2]-this.points_[b+2];if(a<1E3/60)return!1;var e=this.points_[c]-this.points_[b];c=this.points_[c+1]-this.points_[b+1];this.angle_=Math.atan2(c,e);this.initialVelocity_=Math.sqrt(e*e+c*c)/a;return this.initialVelocity_>this.minVelocity_};a.prototype.getDistance=function(){return(this.minVelocity_-
this.initialVelocity_)/this.decay_};a.prototype.getAngle=function(){return this.angle_};k.default=a},{}],105:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../object.js"),b=d(c);c=a("../layer/property.js");var h=d(c);c=a("../math.js");var n=d(c);a=a("../obj.js");var g=d(a);a=function(a){b.default.call(this);var c=g.default.assign({},a);c[h.default.OPACITY]=void 0!==a.opacity?a.opacity:1;c[h.default.VISIBLE]=
...
a.prototype.getMinResolution=function(){return this.get(h.default.MIN_RESOLUTION)};a.prototype.getOpacity=function(){return this.get(h.default.OPACITY)};a.prototype.getSourceState=function(){};a.prototype.getVisible=function(){return this.get(h.default.VISIBLE)};a.prototype.getZIndex=function(){return this.get(h.default.Z_INDEX)};a.prototype.setExtent=function(a){this.set(h.default.EXTENT,a)};a.prototype.setMaxResolution=function(a){this.set(h.default.MAX_RESOLUTION,a)};a.prototype.setMinResolution=
function(a){this.set(h.default.MIN_RESOLUTION,a)};a.prototype.setOpacity=function(a){this.set(h.default.OPACITY,a)};a.prototype.setVisible=function(a){this.set(h.default.VISIBLE,a)};a.prototype.setZIndex=function(a){this.set(h.default.Z_INDEX,a)};k.default=a},{"../index.js":89,"../layer/property.js":109,"../math.js":123,"../obj.js":124,"../object.js":125}],106:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");var c=
d(e);e=a("../collection.js");var b=d(e);e=a("../collectioneventtype.js");var h=d(e);e=a("../object.js");var n=d(e);e=a("../objecteventtype.js");var g=d(e);e=a("../asserts.js");var f=d(e);e=a("../events.js");var l=d(e);e=a("../events/eventtype.js");var q=d(e);e=a("../extent.js");var m=d(e);e=a("../layer/base.js");var p=d(e);e=a("../obj.js");var r=d(e);a=a("../source/state.js");var t=d(a),u=function(a){var c=a||{};a=r.default.assign({},c);delete a.layers;c=c.layers;p.default.call(this,a);this.layersListenerKeys_=
[];this.listenerKeys_={};l.default.listen(this,n.default.getChangeEventType(u.Property_.LAYERS),this.handleLayersChanged_,this);c?Array.isArray(c)?c=new b.default(c.slice(),{unique:!0}):f.default.assert(c instanceof b.default,43):c=new b.default(void 0,{unique:!0});this.setLayers(c)};c.default.inherits(u,p.default);u.prototype.handleLayerChange_=function(){this.changed()};u.prototype.handleLayersChanged_=function(a){this.layersListenerKeys_.forEach(l.default.unlistenByKey);this.layersListenerKeys_.length=
0;a=this.getLayers();this.layersListenerKeys_.push(l.default.listen(a,h.default.ADD,this.handleLayersAdd_,this),l.default.listen(a,h.default.REMOVE,this.handleLayersRemove_,this));for(var b in this.listenerKeys_)this.listenerKeys_[b].forEach(l.default.unlistenByKey);r.default.clear(this.listenerKeys_);b=a.getArray();var f;a=0;for(f=b.length;a<f;a++){var d=b[a];this.listenerKeys_[c.default.getUid(d).toString()]=[l.default.listen(d,g.default.PROPERTYCHANGE,this.handleLayerChange_,this),l.default.listen(d,
q.default.CHANGE,this.handleLayerChange_,this)]}this.changed()};u.prototype.handleLayersAdd_=function(a){a=a.element;var b=c.default.getUid(a).toString();this.listenerKeys_[b]=[l.default.listen(a,g.default.PROPERTYCHANGE,this.handleLayerChange_,this),l.default.listen(a,q.default.CHANGE,this.handleLayerChange_,this)];this.changed()};u.prototype.handleLayersRemove_=function(a){a=c.default.getUid(a.element).toString();this.listenerKeys_[a].forEach(l.default.unlistenByKey);delete this.listenerKeys_[a];
this.changed()};u.prototype.getLayers=function(){return this.get(u.Property_.LAYERS)};u.prototype.setLayers=function(a){this.set(u.Property_.LAYERS,a)};u.prototype.getLayersArray=function(a){var b=void 0!==a?a:[];this.getLayers().forEach(function(a){a.getLayersArray(b)});return b};u.prototype.getLayerStatesArray=function(a){var b=void 0!==a?a:[],c=b.length;this.getLayers().forEach(function(a){a.getLayerStatesArray(b)});a=this.getLayerState();var f;for(f=b.length;c<f;c++){var d=b[c];d.opacity*=a.opacity;
d.visible=d.visible&&a.visible;d.maxResolution=Math.min(d.maxResolution,a.maxResolution);d.minResolution=Math.max(d.minResolution,a.minResolution);void 0!==a.extent&&(d.extent=void 0!==d.extent?m.default.getIntersection(d.extent,a.extent):a.extent)}return b};u.prototype.getSourceState=function(){return t.default.READY};u.Property_={LAYERS:"layers"};k.default=u},{"../asserts.js":31,"../collection.js":34,"../collectioneventtype.js":35,"../events.js":48,"../events/eventtype.js":52,"../extent.js":54,
"../index.js":89,"../layer/base.js":105,"../obj.js":124,"../object.js":125,"../objecteventtype.js":126,"../source/state.js":212}],107:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../layertype.js"),b=d(c);a=a("../layer/layer.js");var h=d(a);a=function(a){h.default.call(this,a?a:{});this.type=b.default.IMAGE};e.default.inherits(a,h.default);a.prototype.getSource;k.default=a},{"../index.js":89,
"../layer/layer.js":108,"../layertype.js":113}],108:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../events.js");var c=d(e);e=a("../events/eventtype.js");var b=d(e);e=a("../index.js");var h=d(e);e=a("../object.js");var n=d(e);e=a("../layer/base.js");var g=d(e);e=a("../layer/property.js");var f=d(e);e=a("../obj.js");var l=d(e);e=a("../render/eventtype.js");var q=d(e);a=a("../source/state.js");var m=d(a);a=function(a){var b=
l.default.assign({},a);delete b.source;g.default.call(this,b);this.sourceChangeKey_=this.mapRenderKey_=this.mapPrecomposeKey_=null;a.map&&this.setMap(a.map);c.default.listen(this,n.default.getChangeEventType(f.default.SOURCE),this.handleSourcePropertyChange_,this);this.setSource(a.source?a.source:null)};h.default.inherits(a,g.default);a.visibleAtResolution=function(a,b){return a.visible&&b>=a.minResolution&&b<a.maxResolution};a.prototype.getLayersArray=function(a){a=a?a:[];a.push(this);return a};
a.prototype.getLayerStatesArray=function(a){a=a?a:[];a.push(this.getLayerState());return a};a.prototype.getSource=function(){return this.get(f.default.SOURCE)||null};a.prototype.getSourceState=function(){var a=this.getSource();return a?a.getState():m.default.UNDEFINED};a.prototype.handleSourceChange_=function(){this.changed()};a.prototype.handleSourcePropertyChange_=function(){this.sourceChangeKey_&&(c.default.unlistenByKey(this.sourceChangeKey_),this.sourceChangeKey_=null);var a=this.getSource();
a&&(this.sourceChangeKey_=c.default.listen(a,b.default.CHANGE,this.handleSourceChange_,this));this.changed()};a.prototype.setMap=function(a){this.mapPrecomposeKey_&&(c.default.unlistenByKey(this.mapPrecomposeKey_),this.mapPrecomposeKey_=null);a||this.changed();this.mapRenderKey_&&(c.default.unlistenByKey(this.mapRenderKey_),this.mapRenderKey_=null);a&&(this.mapPrecomposeKey_=c.default.listen(a,q.default.PRECOMPOSE,function(a){var b=this.getLayerState();b.managed=!1;b.zIndex=Infinity;a.frameState.layerStatesArray.push(b);
a.frameState.layerStates[h.default.getUid(this)]=b},this),this.mapRenderKey_=c.default.listen(this,b.default.CHANGE,a.render,a),this.changed())};a.prototype.setSource=function(a){this.set(f.default.SOURCE,a)};k.default=a},{"../events.js":48,"../events/eventtype.js":52,"../index.js":89,"../layer/base.js":105,"../layer/property.js":109,"../obj.js":124,"../object.js":125,"../render/eventtype.js":160,"../source/state.js":212}],109:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default=
{OPACITY:"opacity",VISIBLE:"visible",EXTENT:"extent",Z_INDEX:"zIndex",MAX_RESOLUTION:"maxResolution",MIN_RESOLUTION:"minResolution",SOURCE:"source"}},{}],110:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("../index.js");e=d(e);var c=a("../layertype.js"),b=d(c);c=a("../layer/layer.js");var h=d(c);c=a("../layer/vectorrendertype.js");var n=d(c);c=a("../obj.js");var g=d(c);a=a("../style/style.js");var f=d(a),l=function(a){a=a?a:
{};var c=g.default.assign({},a);delete c.style;delete c.renderBuffer;delete c.updateWhileAnimating;delete c.updateWhileInteracting;h.default.call(this,c);this.declutter_=void 0!==a.declutter?a.declutter:!1;this.renderBuffer_=void 0!==a.renderBuffer?a.renderBuffer:100;this.style_=null;this.styleFunction_=void 0;this.setStyle(a.style);this.updateWhileAnimating_=void 0!==a.updateWhileAnimating?a.updateWhileAnimating:!1;this.updateWhileInteracting_=void 0!==a.updateWhileInteracting?a.updateWhileInteracting:
!1;this.renderMode_=a.renderMode||n.default.VECTOR;this.type=b.default.VECTOR};e.default.inherits(l,h.default);l.prototype.getDeclutter=function(){return this.declutter_};l.prototype.setDeclutter=function(a){this.declutter_=a};l.prototype.getRenderBuffer=function(){return this.renderBuffer_};l.prototype.getRenderOrder=function(){return this.get(l.Property_.RENDER_ORDER)};l.prototype.getSource;l.prototype.getStyle=function(){return this.style_};l.prototype.getStyleFunction=function(){return this.styleFunction_};
l.prototype.getUpdateWhileAnimating=function(){return this.updateWhileAnimating_};l.prototype.getUpdateWhileInteracting=function(){return this.updateWhileInteracting_};l.prototype.setRenderOrder=function(a){this.set(l.Property_.RENDER_ORDER,a)};l.prototype.setStyle=function(a){this.style_=void 0!==a?a:f.default.defaultFunction;this.styleFunction_=null===a?void 0:f.default.createFunction(this.style_);this.changed()};l.prototype.getRenderMode=function(){return this.renderMode_};l.Property_={RENDER_ORDER:"renderOrder"};
k.default=l},{"../index.js":89,"../layer/layer.js":108,"../layer/vectorrendertype.js":111,"../layertype.js":113,"../obj.js":124,"../style/style.js":234}],111:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={IMAGE:"image",VECTOR:"vector"}},{}],112:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={IMAGE:"image",HYBRID:"hybrid",VECTOR:"vector"}},{}],113:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={IMAGE:"IMAGE",TILE:"TILE",
VECTOR_TILE:"VECTOR_TILE",VECTOR:"VECTOR"}},{}],114:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={all:function(a,c){return[[-Infinity,-Infinity,Infinity,Infinity]]},bbox:function(a,c){return[a]},tile:function(a){return function(c,b){b=a.getZForResolution(b);c=a.getTileRangeForExtentAndZ(c,b);var d=[];b=[b,0,0];for(b[1]=c.minX;b[1]<=c.maxX;++b[1])for(b[2]=c.minY;b[2]<=c.maxY;++b[2])d.push(a.getTileCoordExtent(b));return d}}}},{}],115:[function(a,e,k){function d(a){return a&&
a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./pluggablemap.js"),b=d(c);c=a("./plugintype.js");c=d(c);var h=a("./control.js"),n=d(h);h=a("./interaction.js");var g=d(h);h=a("./obj.js");var f=d(h);h=a("./plugins.js");h=d(h);var l=a("./renderer/canvas/imagelayer.js");l=d(l);var q=a("./renderer/canvas/map.js");q=d(q);var m=a("./renderer/canvas/tilelayer.js");m=d(m);var p=a("./renderer/canvas/vectorlayer.js");p=d(p);var r=a("./renderer/canvas/vectortilelayer.js");
r=d(r);var t=a("./renderer/webgl/imagelayer.js");t=d(t);var u=a("./renderer/webgl/map.js");u=d(u);var y=a("./renderer/webgl/tilelayer.js");y=d(y);a=a("./renderer/webgl/vectorlayer.js");a=d(a);e.default.ENABLE_CANVAS&&(h.default.register(c.default.MAP_RENDERER,q.default),h.default.registerMultiple(c.default.LAYER_RENDERER,[l.default,m.default,p.default,r.default]));e.default.ENABLE_WEBGL&&(h.default.register(c.default.MAP_RENDERER,u.default),h.default.registerMultiple(c.default.LAYER_RENDERER,[t.default,
y.default,a.default]));a=function(a){a=f.default.assign({},a);a.controls||(a.controls=n.default.defaults());a.interactions||(a.interactions=g.default.defaults());b.default.call(this,a)};e.default.inherits(a,b.default);k.default=a},{"./control.js":38,"./index.js":89,"./interaction.js":90,"./obj.js":124,"./pluggablemap.js":130,"./plugins.js":131,"./plugintype.js":132,"./renderer/canvas/imagelayer.js":183,"./renderer/canvas/map.js":186,"./renderer/canvas/tilelayer.js":187,"./renderer/canvas/vectorlayer.js":188,
"./renderer/canvas/vectortilelayer.js":189,"./renderer/webgl/imagelayer.js":196,"./renderer/webgl/map.js":198,"./renderer/webgl/tilelayer.js":199,"./renderer/webgl/vectorlayer.js":202}],116:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});e=(e=a("./index.js"))&&e.__esModule?e:{default:e};var d=(a=a("./mapevent.js"))&&a.__esModule?a:{default:a};a=function(a,b,e,n,g){d.default.call(this,a,b,g);this.originalEvent=e;this.pixel=b.getEventPixel(e);this.coordinate=b.getCoordinateFromPixel(this.pixel);
this.dragging=void 0!==n?n:!1};e.default.inherits(a,d.default);a.prototype.preventDefault=function(){d.default.prototype.preventDefault.call(this);this.originalEvent.preventDefault()};a.prototype.stopPropagation=function(){d.default.prototype.stopPropagation.call(this);this.originalEvent.stopPropagation()};k.default=a},{"./index.js":89,"./mapevent.js":120}],117:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=
d(e);var c=a("./has.js"),b=d(c);c=a("./mapbrowsereventtype.js");var h=d(c);c=a("./mapbrowserpointerevent.js");var n=d(c);c=a("./events.js");var g=d(c);c=a("./events/eventtarget.js");var f=d(c);c=a("./pointer/eventtype.js");var l=d(c);a=a("./pointer/pointereventhandler.js");var q=d(a);a=function(a,c){f.default.call(this);this.map_=a;this.clickTimeoutId_=0;this.dragging_=!1;this.dragListenerKeys_=[];this.moveTolerance_=c?c*b.default.DEVICE_PIXEL_RATIO:b.default.DEVICE_PIXEL_RATIO;this.down_=null;a=
this.map_.getViewport();this.activePointers_=0;this.trackedTouches_={};this.pointerEventHandler_=new q.default(a);this.documentPointerEventHandler_=null;this.pointerdownListenerKey_=g.default.listen(this.pointerEventHandler_,l.default.POINTERDOWN,this.handlePointerDown_,this);this.relayedListenerKey_=g.default.listen(this.pointerEventHandler_,l.default.POINTERMOVE,this.relayEvent_,this)};e.default.inherits(a,f.default);a.prototype.emulateClick_=function(a){var b=new n.default(h.default.CLICK,this.map_,
a);this.dispatchEvent(b);0!==this.clickTimeoutId_?(clearTimeout(this.clickTimeoutId_),this.clickTimeoutId_=0,b=new n.default(h.default.DBLCLICK,this.map_,a),this.dispatchEvent(b)):this.clickTimeoutId_=setTimeout(function(){this.clickTimeoutId_=0;var b=new n.default(h.default.SINGLECLICK,this.map_,a);this.dispatchEvent(b)}.bind(this),250)};a.prototype.updateActivePointers_=function(a){a.type==h.default.POINTERUP||a.type==h.default.POINTERCANCEL?delete this.trackedTouches_[a.pointerId]:a.type==h.default.POINTERDOWN&&
(this.trackedTouches_[a.pointerId]=!0);this.activePointers_=Object.keys(this.trackedTouches_).length};a.prototype.handlePointerUp_=function(a){this.updateActivePointers_(a);var b=new n.default(h.default.POINTERUP,this.map_,a);this.dispatchEvent(b);b.propagationStopped||this.dragging_||!this.isMouseActionButton_(a)||this.emulateClick_(this.down_);0===this.activePointers_&&(this.dragListenerKeys_.forEach(g.default.unlistenByKey),this.dragListenerKeys_.length=0,this.dragging_=!1,this.down_=null,this.documentPointerEventHandler_.dispose(),
this.documentPointerEventHandler_=null)};a.prototype.isMouseActionButton_=function(a){return 0===a.button};a.prototype.handlePointerDown_=function(a){this.updateActivePointers_(a);var b=new n.default(h.default.POINTERDOWN,this.map_,a);this.dispatchEvent(b);this.down_=a;0===this.dragListenerKeys_.length&&(this.documentPointerEventHandler_=new q.default(document),this.dragListenerKeys_.push(g.default.listen(this.documentPointerEventHandler_,h.default.POINTERMOVE,this.handlePointerMove_,this),g.default.listen(this.documentPointerEventHandler_,
h.default.POINTERUP,this.handlePointerUp_,this),g.default.listen(this.pointerEventHandler_,h.default.POINTERCANCEL,this.handlePointerUp_,this)))};a.prototype.handlePointerMove_=function(a){if(this.isMoving_(a)){this.dragging_=!0;var b=new n.default(h.default.POINTERDRAG,this.map_,a,this.dragging_);this.dispatchEvent(b)}a.preventDefault()};a.prototype.relayEvent_=function(a){var b=!(!this.down_||!this.isMoving_(a));this.dispatchEvent(new n.default(a.type,this.map_,a,b))};a.prototype.isMoving_=function(a){return Math.abs(a.clientX-
this.down_.clientX)>this.moveTolerance_||Math.abs(a.clientY-this.down_.clientY)>this.moveTolerance_};a.prototype.disposeInternal=function(){this.relayedListenerKey_&&(g.default.unlistenByKey(this.relayedListenerKey_),this.relayedListenerKey_=null);this.pointerdownListenerKey_&&(g.default.unlistenByKey(this.pointerdownListenerKey_),this.pointerdownListenerKey_=null);this.dragListenerKeys_.forEach(g.default.unlistenByKey);this.dragListenerKeys_.length=0;this.documentPointerEventHandler_&&(this.documentPointerEventHandler_.dispose(),
this.documentPointerEventHandler_=null);this.pointerEventHandler_&&(this.pointerEventHandler_.dispose(),this.pointerEventHandler_=null);f.default.prototype.disposeInternal.call(this)};k.default=a},{"./events.js":48,"./events/eventtarget.js":51,"./has.js":84,"./index.js":89,"./mapbrowsereventtype.js":118,"./mapbrowserpointerevent.js":119,"./pointer/eventtype.js":134,"./pointer/pointereventhandler.js":139}],118:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});a=(a=a("./events/eventtype.js"))&&
a.__esModule?a:{default:a};k.default={SINGLECLICK:"singleclick",CLICK:a.default.CLICK,DBLCLICK:a.default.DBLCLICK,POINTERDRAG:"pointerdrag",POINTERMOVE:"pointermove",POINTERDOWN:"pointerdown",POINTERUP:"pointerup",POINTEROVER:"pointerover",POINTEROUT:"pointerout",POINTERENTER:"pointerenter",POINTERLEAVE:"pointerleave",POINTERCANCEL:"pointercancel"}},{"./events/eventtype.js":52}],119:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});e=(e=a("./index.js"))&&e.__esModule?e:{default:e};
var d=(a=a("./mapbrowserevent.js"))&&a.__esModule?a:{default:a};a=function(a,b,e,n,g){d.default.call(this,a,b,e.originalEvent,n,g);this.pointerEvent=e};e.default.inherits(a,d.default);k.default=a},{"./index.js":89,"./mapbrowserevent.js":116}],120:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});e=(e=a("./index.js"))&&e.__esModule?e:{default:e};var d=(a=a("./events/event.js"))&&a.__esModule?a:{default:a};a=function(a,b,e){d.default.call(this,a);this.map=b;this.frameState=void 0!==
e?e:null};e.default.inherits(a,d.default);k.default=a},{"./events/event.js":50,"./index.js":89}],121:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={POSTRENDER:"postrender",MOVESTART:"movestart",MOVEEND:"moveend"}},{}],122:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={LAYERGROUP:"layergroup",SIZE:"size",TARGET:"target",VIEW:"view"}},{}],123:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});var d=(a=a("./asserts.js"))&&a.__esModule?
a:{default:a},c={clamp:function(a,c,d){return Math.min(Math.max(a,c),d)}};c.cosh=function(){return"cosh"in Math?Math.cosh:function(a){a=Math.exp(a);return(a+1/a)/2}}();c.roundUpToPowerOfTwo=function(a){d.default.assert(0<a,29);return Math.pow(2,Math.ceil(Math.log(a)/Math.LN2))};c.squaredSegmentDistance=function(a,d,e,g,f,l){var b=f-e,h=l-g;if(0!==b||0!==h){var p=((a-e)*b+(d-g)*h)/(b*b+h*h);1<p?(e=f,g=l):0<p&&(e+=b*p,g+=h*p)}return c.squaredDistance(a,d,e,g)};c.squaredDistance=function(a,c,d,e){a=
d-a;c=e-c;return a*a+c*c};c.solveLinearSystem=function(a){for(var b=a.length,c=0;c<b;c++){for(var d=c,f=Math.abs(a[c][c]),e=c+1;e<b;e++){var k=Math.abs(a[e][c]);k>f&&(f=k,d=e)}if(0===f)return null;f=a[d];a[d]=a[c];a[c]=f;for(d=c+1;d<b;d++)for(f=-a[d][c]/a[c][c],e=c;e<b+1;e++)a[d][e]=c==e?0:a[d][e]+f*a[c][e]}c=Array(b);for(d=b-1;0<=d;d--)for(c[d]=a[d][b]/a[d][d],f=d-1;0<=f;f--)a[f][b]-=a[f][d]*c[d];return c};c.toDegrees=function(a){return 180*a/Math.PI};c.toRadians=function(a){return a*Math.PI/180};
c.modulo=function(a,c){a%=c;return 0>a*c?a+c:a};c.lerp=function(a,c,d){return a+d*(c-a)};k.default=c},{"./asserts.js":31}],124:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});a={};a.assign="function"===typeof Object.assign?Object.assign:function(a,c){if(void 0===a||null===a)throw new TypeError("Cannot convert undefined or null to object");for(var b=Object(a),d=1,e=arguments.length;d<e;++d){var g=arguments[d];if(void 0!==g&&null!==g)for(var f in g)g.hasOwnProperty(f)&&(b[f]=g[f])}return b};
a.clear=function(a){for(var c in a)delete a[c]};a.getValues=function(a){var c=[],b;for(b in a)c.push(a[b]);return c};a.isEmpty=function(a){for(var c in a)return!1;return!c};k.default=a},{}],125:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");var c=d(e);e=a("./objecteventtype.js");var b=d(e);e=a("./observable.js");var h=d(e);e=a("./events/event.js");var n=d(e);a=a("./obj.js");var g=d(a),f=function(a){h.default.call(this);
c.default.getUid(this);this.values_={};void 0!==a&&this.setProperties(a)};c.default.inherits(f,h.default);f.changeEventTypeCache_={};f.getChangeEventType=function(a){return f.changeEventTypeCache_.hasOwnProperty(a)?f.changeEventTypeCache_[a]:f.changeEventTypeCache_[a]="change:"+a};f.prototype.get=function(a){var b;this.values_.hasOwnProperty(a)&&(b=this.values_[a]);return b};f.prototype.getKeys=function(){return Object.keys(this.values_)};f.prototype.getProperties=function(){return g.default.assign({},
this.values_)};f.prototype.notify=function(a,c){var d=f.getChangeEventType(a);this.dispatchEvent(new f.Event(d,a,c));d=b.default.PROPERTYCHANGE;this.dispatchEvent(new f.Event(d,a,c))};f.prototype.set=function(a,b,c){c?this.values_[a]=b:(c=this.values_[a],this.values_[a]=b,c!==b&&this.notify(a,c))};f.prototype.setProperties=function(a,b){for(var c in a)this.set(c,a[c],b)};f.prototype.unset=function(a,b){if(a in this.values_){var c=this.values_[a];delete this.values_[a];b||this.notify(a,c)}};f.Event=
function(a,b,c){n.default.call(this,a);this.key=b;this.oldValue=c};c.default.inherits(f.Event,n.default);k.default=f},{"./events/event.js":50,"./index.js":89,"./obj.js":124,"./objecteventtype.js":126,"./observable.js":127}],126:[function(a,e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={PROPERTYCHANGE:"propertychange"}},{}],127:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./events.js"),
b=d(c);c=a("./events/eventtarget.js");var h=d(c);a=a("./events/eventtype.js");var n=d(a);a=function(){h.default.call(this);this.revision_=0};e.default.inherits(a,h.default);a.unByKey=function(a){if(Array.isArray(a))for(var c=0,d=a.length;c<d;++c)b.default.unlistenByKey(a[c]);else b.default.unlistenByKey(a)};a.prototype.changed=function(){++this.revision_;this.dispatchEvent(n.default.CHANGE)};a.prototype.dispatchEvent;a.prototype.getRevision=function(){return this.revision_};a.prototype.on=function(a,
...
a},{"./events.js":48,"./events/eventtarget.js":51,"./events/eventtype.js":52,"./index.js":89}],128:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");e=d(e);var c=a("./mapeventtype.js"),b=d(c);c=a("./object.js");var h=d(c);c=a("./overlaypositioning.js");var n=d(c);c=a("./css.js");var g=d(c);c=a("./dom.js");var f=d(c);c=a("./events.js");var l=d(c);a=a("./extent.js");var q=d(a),m=function(a){h.default.call(this);this.options=
a;this.id=a.id;this.insertFirst=void 0!==a.insertFirst?a.insertFirst:!0;this.stopEvent=void 0!==a.stopEvent?a.stopEvent:!0;this.element=document.createElement("DIV");this.element.className=void 0!==a.className?a.className:"ol-overlay-container "+g.default.CLASS_SELECTABLE;this.element.style.position="absolute";this.autoPan=void 0!==a.autoPan?a.autoPan:!1;this.autoPanAnimation=a.autoPanAnimation||{};this.autoPanMargin=void 0!==a.autoPanMargin?a.autoPanMargin:20;this.rendered={bottom_:"",left_:"",right_:"",
top_:"",visible:!0};this.mapPostrenderListenerKey=null;l.default.listen(this,h.default.getChangeEventType(m.Property.ELEMENT),this.handleElementChanged,this);l.default.listen(this,h.default.getChangeEventType(m.Property.MAP),this.handleMapChanged,this);l.default.listen(this,h.default.getChangeEventType(m.Property.OFFSET),this.handleOffsetChanged,this);l.default.listen(this,h.default.getChangeEventType(m.Property.POSITION),this.handlePositionChanged,this);l.default.listen(this,h.default.getChangeEventType(m.Property.POSITIONING),
this.handlePositioningChanged,this);void 0!==a.element&&this.setElement(a.element);this.setOffset(void 0!==a.offset?a.offset:[0,0]);this.setPositioning(void 0!==a.positioning?a.positioning:n.default.TOP_LEFT);void 0!==a.position&&this.setPosition(a.position)};e.default.inherits(m,h.default);m.prototype.getElement=function(){return this.get(m.Property.ELEMENT)};m.prototype.getId=function(){return this.id};m.prototype.getMap=function(){return this.get(m.Property.MAP)};m.prototype.getOffset=function(){return this.get(m.Property.OFFSET)};
m.prototype.getPosition=function(){return this.get(m.Property.POSITION)};m.prototype.getPositioning=function(){return this.get(m.Property.POSITIONING)};m.prototype.handleElementChanged=function(){f.default.removeChildren(this.element);var a=this.getElement();a&&this.element.appendChild(a)};m.prototype.handleMapChanged=function(){this.mapPostrenderListenerKey&&(f.default.removeNode(this.element),l.default.unlistenByKey(this.mapPostrenderListenerKey),this.mapPostrenderListenerKey=null);var a=this.getMap();
a&&(this.mapPostrenderListenerKey=l.default.listen(a,b.default.POSTRENDER,this.render,this),this.updatePixelPosition(),a=this.stopEvent?a.getOverlayContainerStopEvent():a.getOverlayContainer(),this.insertFirst?a.insertBefore(this.element,a.childNodes[0]||null):a.appendChild(this.element))};m.prototype.render=function(){this.updatePixelPosition()};m.prototype.handleOffsetChanged=function(){this.updatePixelPosition()};m.prototype.handlePositionChanged=function(){this.updatePixelPosition();this.get(m.Property.POSITION)&&
this.autoPan&&this.panIntoView()};m.prototype.handlePositioningChanged=function(){this.updatePixelPosition()};m.prototype.setElement=function(a){this.set(m.Property.ELEMENT,a)};m.prototype.setMap=function(a){this.set(m.Property.MAP,a)};m.prototype.setOffset=function(a){this.set(m.Property.OFFSET,a)};m.prototype.setPosition=function(a){this.set(m.Property.POSITION,a)};m.prototype.panIntoView=function(){var a=this.getMap();if(a&&a.getTargetElement()){var b=this.getRect(a.getTargetElement(),a.getSize()),
c=this.getElement(),d=this.getRect(c,[f.default.outerWidth(c),f.default.outerHeight(c)]);c=this.autoPanMargin;if(!q.default.containsExtent(b,d)){var e=d[0]-b[0],g=b[2]-d[2],l=d[1]-b[1];d=b[3]-d[3];b=[0,0];0>e?b[0]=e-c:0>g&&(b[0]=Math.abs(g)+c);0>l?b[1]=l-c:0>d&&(b[1]=Math.abs(d)+c);if(0!==b[0]||0!==b[1])c=a.getView().getCenter(),c=a.getPixelFromCoordinate(c),c=[c[0]+b[0],c[1]+b[1]],a.getView().animate({center:a.getCoordinateFromPixel(c),duration:this.autoPanAnimation.duration,easing:this.autoPanAnimation.easing})}}};
m.prototype.getRect=function(a,b){var c=a.getBoundingClientRect();a=c.left+window.pageXOffset;c=c.top+window.pageYOffset;return[a,c,a+b[0],c+b[1]]};m.prototype.setPositioning=function(a){this.set(m.Property.POSITIONING,a)};m.prototype.setVisible=function(a){this.rendered.visible!==a&&(this.element.style.display=a?"":"none",this.rendered.visible=a)};m.prototype.updatePixelPosition=function(){var a=this.getMap(),b=this.getPosition();a&&a.isRendered()&&b?(b=a.getPixelFromCoordinate(b),a=a.getSize(),
this.updateRenderedPosition(b,a)):this.setVisible(!1)};m.prototype.updateRenderedPosition=function(a,b){var c=this.element.style,f=this.getOffset(),d=this.getPositioning();this.setVisible(!0);var e=f[0];f=f[1];if(d==n.default.BOTTOM_RIGHT||d==n.default.CENTER_RIGHT||d==n.default.TOP_RIGHT)""!==this.rendered.left_&&(this.rendered.left_=c.left=""),e=Math.round(b[0]-a[0]-e)+"px",this.rendered.right_!=e&&(this.rendered.right_=c.right=e);else{""!==this.rendered.right_&&(this.rendered.right_=c.right="");
if(d==n.default.BOTTOM_CENTER||d==n.default.CENTER_CENTER||d==n.default.TOP_CENTER)e-=this.element.offsetWidth/2;e=Math.round(a[0]+e)+"px";this.rendered.left_!=e&&(this.rendered.left_=c.left=e)}if(d==n.default.BOTTOM_LEFT||d==n.default.BOTTOM_CENTER||d==n.default.BOTTOM_RIGHT)""!==this.rendered.top_&&(this.rendered.top_=c.top=""),a=Math.round(b[1]-a[1]-f)+"px",this.rendered.bottom_!=a&&(this.rendered.bottom_=c.bottom=a);else{""!==this.rendered.bottom_&&(this.rendered.bottom_=c.bottom="");if(d==n.default.CENTER_LEFT||
d==n.default.CENTER_CENTER||d==n.default.CENTER_RIGHT)f-=this.element.offsetHeight/2;a=Math.round(a[1]+f)+"px";this.rendered.top_!=a&&(this.rendered.top_=c.top=a)}};m.prototype.getOptions=function(){return this.options};m.Property={ELEMENT:"element",MAP:"map",OFFSET:"offset",POSITION:"position",POSITIONING:"positioning"};k.default=m},{"./css.js":44,"./dom.js":46,"./events.js":48,"./extent.js":54,"./index.js":89,"./mapeventtype.js":121,"./object.js":125,"./overlaypositioning.js":129}],129:[function(a,
e,k){Object.defineProperty(k,"__esModule",{value:!0});k.default={BOTTOM_LEFT:"bottom-left",BOTTOM_CENTER:"bottom-center",BOTTOM_RIGHT:"bottom-right",CENTER_LEFT:"center-left",CENTER_CENTER:"center-center",CENTER_RIGHT:"center-right",TOP_LEFT:"top-left",TOP_CENTER:"top-center",TOP_RIGHT:"top-right"}},{}],130:[function(a,e,k){function d(a){return a&&a.__esModule?a:{default:a}}Object.defineProperty(k,"__esModule",{value:!0});e=a("./index.js");var c=d(e);e=a("./collection.js");var b=d(e);e=a("./collectioneventtype.js");
var h=d(e);e=a("./mapbrowserevent.js");var n=d(e);e=a("./mapbrowsereventhandler.js");var g=d(e);e=a("./mapbrowsereventtype.js");var f=d(e);e=a("./mapevent.js");var l=d(e);e=a("./mapeventtype.js");var q=d(e);e=a("./mapproperty.js");var m=d(e);e=a("./object.js");var p=d(e);e=a("./objecteventtype.js");var r=d(e);e=a("./tilequeue.js");var t=d(e);e=a("./view.js");var u=d(e);e=a("./viewhint.js");var y=d(e);e=a("./asserts.js");var w=d(e);e=a("./dom.js");var v=d(e);e=a("./events.js");var A=d(e);e=a("./events/event.js");
var B=d(e);e=a("./events/eventtype.js");var x=d(e);e=a("./extent.js");var z=d(e);e=a("./functions.js");var C=d(e);e=a("./has.js");var S=d(e);e=a("./layer/group.js");var I=d(e);e=a("./obj.js");var M=d(e);e=a("./plugins.js");var H=d(e);e=a("./renderer/type.js");e=d(e);var J=a("./size.js"),D=d(J);J=a("./structs/priorityqueue.js");var T=d(J);a=a("./transform.js");var R=d(a),G=function(a){p.default.call(this);var c=G.createOptionsInternal(a);this.loadTilesWhileAnimating_=void 0!==a.loadTilesWhileAnimating?
a.loadTilesWhileAnimating:!1;this.loadTilesWhileInteracting_=void 0!==a.loadTilesWhileInteracting?a.loadTilesWhileInteracting:!1;this.pixelRatio_=void 0!==a.pixelRatio?a.pixelRatio:S.default.DEVICE_PIXEL_RATIO;this.logos_=c.logos;this.animationDelayKey_;this.animationDelay_=function(){this.animationDelayKey_=void 0;this.renderFrame_.call(this,Date.now())}.bind(this);this.coordinateToPixelTransform_=R.default.create();this.pixelToCoordinateTransform_=R.default.create();this.frameIndex_=0;this.layerGroupPropertyListenerKeys_=
this.viewChangeListenerKey_=this.viewPropertyListenerKey_=this.previousExtent_=this.frameState_=null;this.viewport_=document.createElement("DIV");this.viewport_.className="ol-viewport"+(S.default.TOUCH?" ol-touch":"");this.viewport_.style.position="relative";this.viewport_.style.overflow="hidden";this.viewport_.style.width="100%";this.viewport_.style.height="100%";this.viewport_.style.msTouchAction="none";this.viewport_.style.touchAction="none";this.overlayContainer_=document.createElement("DIV");
this.overlayContainer_.className="ol-overlaycontainer";this.viewport_.appendChild(this.overlayContainer_);this.overlayContainerStopEvent_=document.createElement("DIV");this.overlayContainerStopEvent_.className="ol-overlaycontainer-stopevent";for(var d=[x.default.CLICK,x.default.DBLCLICK,x.default.MOUSEDOWN,x.default.TOUCHSTART,x.default.MSPOINTERDOWN,f.default.POINTERDOWN,x.default.MOUSEWHEEL,x.default.WHEEL],e=0,l=d.length;e<l;++e)A.default.listen(this.overlayContainerStopEvent_,d[e],B.default.stopPropagation);
...
new b.default;this.interactions=c.interactions||new b.default;this.overlays_=c.overlays;this.overlayIdIndex_={};this.renderer_=c.mapRendererPlugin.create(this.viewport_,this);this.handleResize_;this.focus_=null;this.postRenderFunctions_=[];this.tileQueue_=new t.default(this.getTilePriority.bind(this),this.handleTileChange_.bind(this));this.skippedFeatureUids_={};A.default.listen(this,p.default.getChangeEventType(m.default.LAYERGROUP),this.handleLayerGroupChanged_,this);A.default.listen(this,p.default.getChangeEventType(m.default.VIEW),
this.handleViewChanged_,this);A.default.listen(this,p.default.getChangeEventType(m.default.SIZE),this.handleSizeChanged_,this);A.default.listen(this,p.default.getChangeEventType(m.default.TARGET),this.handleTargetChanged_,this);this.setProperties(c.values);this.controls.forEach(function(a){a.setMap(this)},this);A.default.listen(this.controls,h.default.ADD,function(a){a.element.setMap(this)},this);A.default.listen(this.controls,h.default.REMOVE,function(a){a.element.setMap(null)},this);this.interactions.forEach(function(a){a.setMap(this)},
this);A.default.listen(this.interactions,h.default.ADD,function(a){a.element.setMap(this)},this);A.default.listen(this.interactions,h.default.REMOVE,function(a){a.element.setMap(null)},this);this.overlays_.forEach(this.addOverlayInternal_,this);A.default.listen(this.overlays_,h.default.ADD,function(a){this.addOverlayInternal_(a.element)},this);A.default.listen(this.overlays_,h.default.REMOVE,function(a){var b=a.element.getId();void 0!==b&&delete this.overlayIdIndex_[b.toString()];a.element.setMap(null)},
this)};c.default.inherits(G,p.default);G.prototype.addControl=function(a){this.getControls().push(a)};G.prototype.addInteraction=function(a){this.getInteractions().push(a)};G.prototype.addLayer=function(a){this.getLayerGroup().getLayers().push(a)};G.prototype.addOverlay=function(a){this.getOverlays().push(a)};G.prototype.addOverlayInternal_=function(a){var b=a.getId();void 0!==b&&(this.overlayIdIndex_[b.toString()]=a);a.setMap(this)};G.prototype.disposeInternal=function(){this.mapBrowserEventHandler_.dispose();
A.default.unlisten(this.viewport_,x.default.WHEEL,this.handleBrowserEvent,this);A.default.unlisten(this.viewport_,x.default.MOUSEWHEEL,this.handleBrowserEvent,this);void 0!==this.handleResize_&&(window.removeEventListener(x.default.RESIZE,this.handleResize_,!1),this.handleResize_=void 0);this.animationDelayKey_&&(cancelAnimationFrame(this.animationDelayKey_),this.animationDelayKey_=void 0);this.setTarget(null);p.default.prototype.disposeInternal.call(this)};G.prototype.forEachFeatureAtPixel=function(a,
b,c){if(this.frameState_)return a=this.getCoordinateFromPixel(a),c=void 0!==c?c:{},this.renderer_.forEachFeatureAtCoordinate(a,this.frameState_,void 0!==c.hitTolerance?c.hitTolerance*this.frameState_.pixelRatio:0,b,null,void 0!==c.layerFilter?c.layerFilter:C.default.TRUE,null)};G.prototype.getFeaturesAtPixel=function(a,b){var c=null;this.forEachFeatureAtPixel(a,function(a){c||(c=[]);c.push(a)},b);return c};G.prototype.forEachLayerAtPixel=function(a,b,c,f,d){if(this.frameState_)return this.renderer_.forEachLayerAtPixel(a,
this.frameState_,b,void 0!==c?c:null,void 0!==f?f:C.default.TRUE,void 0!==d?d:null)};G.prototype.hasFeatureAtPixel=function(a,b){if(!this.frameState_)return!1;a=this.getCoordinateFromPixel(a);b=void 0!==b?b:{};return this.renderer_.hasFeatureAtCoordinate(a,this.frameState_,void 0!==b.hitTolerance?b.hitTolerance*this.frameState_.pixelRatio:0,void 0!==b.layerFilter?b.layerFilter:C.default.TRUE,null)};G.prototype.getEventCoordinate=function(a){return this.getCoordinateFromPixel(this.getEventPixel(a))};
G.prototype.getEventPixel=function(a){var b=this.viewport_.getBoundingClientRect();a=a.changedTouches?a.changedTouches[0]:a;return[a.clientX-b.left,a.clientY-b.top]};G.prototype.getTarget=function(){return this.get(m.default.TARGET)};G.prototype.getTargetElement=function(){var a=this.getTarget();return void 0!==a?"string"===typeof a?document.getElementById(a):a:null};G.prototype.getCoordinateFromPixel=function(a){var b=this.frameState_;return b?R.default.apply(b.pixelToCoordinateTransform,a.slice()):
null};G.prototype.getControls=function(){return this.controls};G.prototype.getOverlays=function(){return this.overlays_};G.prototype.getOverlayById=function(a){a=this.overlayIdIndex_[a.toString()];return void 0!==a?a:null};G.prototype.getInteractions=function(){return this.interactions};G.prototype.getLayerGroup=function(){return this.get(m.default.LAYERGROUP)};G.prototype.getLayers=function(){return this.getLayerGroup().getLayers()};G.prototype.getPixelFromCoordinate=function(a){var b=this.frameState_;
return b?R.default.apply(b.coordinateToPixelTransform,a.slice(0,2)):null};G.prototype.getRenderer=function(){return this.renderer_};G.prototype.getSize=function(){return this.get(m.default.SIZE)};G.prototype.getView=function(){return this.get(m.default.VIEW)};G.prototype.getViewport=function(){return this.viewport_};G.prototype.getOverlayContainer=function(){return this.overlayContainer_};G.prototype.getOverlayContainerStopEvent=function(){return this.overlayContainerStopEvent_};G.prototype.getTilePriority=
function(a,b,c,f){var d=this.frameState_;if(!(d&&b in d.wantedTiles&&d.wantedTiles[b][a.getKey()]))return T.default.DROP;a=c[0]-d.focus[0];c=c[1]-d.focus[1];return 65536*Math.log(f)+Math.sqrt(a*a+c*c)/f};G.prototype.handleBrowserEvent=function(a,b){a=new n.default(b||a.type,this,a);this.handleMapBrowserEvent(a)};G.prototype.handleMapBrowserEvent=function(a){if(this.frameState_){this.focus_=a.coordinate;a.frameState=this.frameState_;var b=this.getInteractions().getArray(),c;if(!1!==this.dispatchEvent(a))for(c=
b.length-1;0<=c;c--){var f=b[c];if(f.getActive()&&!f.handleEvent(a))break}}};G.prototype.handlePostRender=function(){var a=this.frameState_,b=this.tileQueue_;if(!b.isEmpty()){var c=16,f=c;if(a){var d=a.viewHints;d[y.default.ANIMATING]&&(c=this.loadTilesWhileAnimating_?8:0,f=2);d[y.default.INTERACTING]&&(c=this.loadTilesWhileInteracting_?8:0,f=2)}b.getTilesLoading()<c&&(b.reprioritize(),b.loadMoreTiles(c,f))}b=this.postRenderFunctions_;c=0;for(f=b.length;c<f;++c)b[c](this,a);b.length=0};G.prototype.handleSizeChanged_=
function(){this.render()};G.prototype.handleTargetChanged_=function(){var a;this.getTarget()&&(a=this.getTargetElement());if(this.keyHandlerKeys_){for(var b=0,c=this.keyHandlerKeys_.length;b<c;++b)A.default.unlistenByKey(this.keyHandlerKeys_[b]);this.keyHandlerKeys_=null}a?(a.appendChild(this.viewport_),a=this.keyboardEventTarget_?this.keyboardEventTarget_:a,this.keyHandlerKeys_=[A.default.listen(a,x.default.KEYDOWN,this.handleBrowserEvent,this),A.default.listen(a,x.default.KEYPRESS,this.handleBrowserEvent,
this)],this.handleResize_||(this.handleResize_=this.updateSize.bind(this),window.addEventListener(x.default.RESIZE,this.handleResize_,!1))):(this.renderer_.removeLayerRenderers(),v.default.removeNode(this.viewport_),void 0!==this.handleResize_&&(window.removeEventListener(x.default.RESIZE,this.handleResize_,!1),this.handleResize_=void 0));this.updateSize()};G.prototype.handleTileChange_=function(){this.render()};G.prototype.handleViewPropertyChanged_=function(){this.render()};G.prototype.handleViewChanged_=
function(){this.viewPropertyListenerKey_&&(A.default.unlistenByKey(this.viewPropertyListenerKey_),this.viewPropertyListenerKey_=null);this.viewChangeListenerKey_&&(A.default.unlistenByKey(this.viewChangeListenerKey_),this.viewChangeListenerKey_=null);var a=this.getView();a&&(this.viewport_.setAttribute("data-view",c.default.getUid(a)),this.viewPropertyListenerKey_=A.default.listen(a,r.default.PROPERTYCHANGE,this.handleViewPropertyChanged_,this),this.viewChangeListenerKey_=A.default.listen(a,x.default.CHANGE,
this.handleViewPropertyChanged_,this));this.render()};G.prototype.handleLayerGroupChanged_=function(){this.layerGroupPropertyListenerKeys_&&(this.layerGroupPropertyListenerKeys_.forEach(A.default.unlistenByKey),this.layerGroupPropertyListenerKeys_=null);var a=this.getLayerGroup();a&&(this.layerGroupPropertyListenerKeys_=[A.default.listen(a,r.default.PROPERTYCHANGE,this.render,this),A.default.listen(a,x.default.CHANGE,this.render,this)]);this.render()};G.prototype.isRendered=function(){return!!this.frameState_};
G.prototype.renderSync=function(){this.animationDelayKey_&&cancelAnimationFrame(this.animationDelayKey_);this.animationDelay_()};G.prototype.render=function(){void 0===this.animationDelayKey_&&(this.animationDelayKey_=requestAnimationFrame(this.animationDelay_))};G.prototype.removeControl=function(a){return this.getControls().remove(a)};G.prototype.removeInteraction=function(a){return this.getInteractions().remove(a)};G.prototype.removeLayer=function(a){return this.getLayerGroup().getLayers().remove(a)};
G.prototype.removeOverlay=function(a){return this.getOverlays().remove(a)};G.prototype.renderFrame_=function(a){var b,f=this.getSize(),d=this.getView(),e=z.default.createEmpty(),g=this.frameState_,h=null;if(void 0!==f&&D.default.hasArea(f)&&d&&d.isDef()){h=d.getHints(this.frameState_?this.frameState_.viewHints:void 0);var t=this.getLayerGroup().getLayerStatesArray(),u={};var m=0;for(b=t.length;m<b;++m)u[c.default.getUid(t[m].layer)]=t[m];m=d.getState();d=m.center;b=m.resolution/this.pixelRatio_;d[0]=
Math.round(d[0]/b)*b;d[1]=Math.round(d[1]/b)*b;h={animate:!1,coordinateToPixelTransform:this.coordinateToPixelTransform_,extent:e,focus:this.focus_?this.focus_:d,index:this.frameIndex_++,layerStates:u,layerStatesArray:t,logos:M.default.assign({},this.logos_),pixelRatio:this.pixelRatio_,pixelToCoordinateTransform:this.pixelToCoordinateTransform_,postRenderFunctions:[],size:f,skippedFeatureUids:this.skippedFeatureUids_,tileQueue:this.tileQueue_,time:a,usedTiles:{},viewState:m,viewHints:h,wantedTiles:{}}}h&&
(h.extent=z.default.getForViewAndSize(m.center,m.resolution,m.rotation,h.size,e));this.frameState_=h;this.renderer_.renderFrame(h);h&&(h.animate&&this.render(),Array.prototype.push.apply(this.postRenderFunctions_,h.postRenderFunctions),!g||this.previousExtent_&&(z.default.isEmpty(this.previousExtent_)||z.default.equals(h.extent,this.previousExtent_))||(this.dispatchEvent(new l.default(q.default.MOVESTART,this,g)),this.previousExtent_=z.default.createOrUpdateEmpty(this.previousExtent_)),!this.previousExtent_||
h.viewHints[y.default.ANIMATING]||h.viewHints[y.default.INTERACTING]||z.default.equals(h.extent,this.previousExtent_)||(this.dispatchEvent(new l.default(q.default.MOVEEND,this,h)),z.default.clone(h.extent,this.previousExtent_)));this.dispatchEvent(new l.default(q.default.POSTRENDER,this,h));setTimeout(this.handlePostRender.bind(this),0)};G.prototype.setLayerGroup=function(a){this.set(m.default.LAYERGROUP,a)};G.prototype.setSize=function(a){this.set(m.default.SIZE,a)};G.prototype.setTarget=function(a){this.set(m.default.TARGET,
a)};G.prototype.setView=function(a){this.set(m.default.VIEW,a)};G.prototype.skipFeature=function(a){a=c.default.getUid(a).toString();this.skippedFeatureUids_[a]=!0;this.render()};G.prototype.updateSize=function(){var a=this.getTargetElement();if(a){var b=getComputedStyle(a);this.setSize([a.offsetWidth-parseFloat(b.borderLeftWidth)-parseFloat(b.paddingLeft)-parseFloat(b.paddingRight)-parseFloat(b.borderRightWidth),a.offsetHeight-parseFloat(b.borderTopWidth)-parseFloat(b.paddingTop)-parseFloat(b.paddingBottom)-
parseFloat(b.borderBottomWidth)])}else this.setSize(void 0)};G.prototype.unskipFeature=function(a){a=c.default.getUid(a).toString();delete this.skippedFeatureUids_[a];this.render()};G.DEFAULT_RENDERER_TYPES=[e.default.CANVAS,e.default.WEBGL];G.LOGO_URL="data:image/png;base64,";
...
u.default);a.prototype.replayTextBackground_=function(a,b,c,d,f,e,g){a.beginPath();a.moveTo.apply(a,b);a.lineTo.apply(a,c);a.lineTo.apply(a,d);a.lineTo.apply(a,f);a.lineTo.apply(a,b);e&&(this.fillOrigin_=e[2],this.fill_(a));g&&(this.setStrokeStyle_(a,g),a.stroke())};a.prototype.replayImage_=function(a,b,c,d,f,e,g,h,l,m,p,k,r,u,t,v,q,w){var C=q||w,z=this.tmpLocalTransform_;f*=r;e*=r;b-=f;c-=e;u&&(b=Math.round(b),c=Math.round(c));u=t+m>d.width?d.width-m:t;h=h+p>d.height?d.height-p:h;t=this.tmpExtent_;
var x=v[3]+u*r+v[1],B=v[0]+h*r+v[2],S=b-v[3],I=c-v[0];if(C||0!==k){var M=[S,I];var H=[S+x,I];var D=[S+x,I+B];var J=[S,I+B]}v=null;0!==k?(f=b+f,e=c+e,v=A.default.compose(z,f,e,1,1,k,-f,-e),n.default.createOrUpdateEmpty(t),n.default.extendCoordinate(t,A.default.apply(z,M)),n.default.extendCoordinate(t,A.default.apply(z,H)),n.default.extendCoordinate(t,A.default.apply(z,D)),n.default.extendCoordinate(t,A.default.apply(z,J))):n.default.createOrUpdate(S,I,S+x,I+B,t);k=a.canvas;k=t[0]<=k.width&&0<=t[2]&&
...
[NaN,NaN],p=!0,k;for(k=b+d;k<c;k+=d){m[0]=a[k];m[1]=a[k+1];var z=n.default.coordinateRelationship(l,m);z!==C?(p&&(this.coordinates[h++]=e[0],this.coordinates[h++]=e[1]),this.coordinates[h++]=m[0],this.coordinates[h++]=m[1],p=!1):z===g.default.INTERSECTING?(this.coordinates[h++]=m[0],this.coordinates[h++]=m[1],p=!1):p=!0;e[0]=m[0];e[1]=m[1];var C=z}if(f&&p||k===b+d)this.coordinates[h++]=e[0],this.coordinates[h++]=e[1];return h};a.prototype.drawCustomCoordinates_=function(a,b,c,d,f){for(var e=0,g=c.length;e<
...
Math.min(b[0][0],b[1][0],b[2][0])<this.sourceWorldWidth_/2&&(a.source=b)}},this)}f={}};a.prototype.addTriangle_=function(a,b,c,d,e,h){this.triangles_.push({source:[d,e,h],target:[a,b,c]})};a.prototype.addQuad_=function(a,d,e,k,m,p,n,t,u){var f=b.default.boundingExtent([m,p,n,t]),g=this.sourceWorldWidth_?b.default.getWidth(f)/this.sourceWorldWidth_:null,l=this.sourceWorldWidth_,q=this.sourceProj_.canWrapX()&&.5<g&&1>g,r=!1;if(0<u){if(this.targetProj_.isGlobal()&&this.targetWorldWidth_){var x=b.default.boundingExtent([a,
d,e,k]);x=b.default.getWidth(x)/this.targetWorldWidth_;r|=x>c.default.RASTER_REPROJECTION_MAX_TRIANGLE_WIDTH}!q&&this.sourceProj_.isGlobal()&&g&&(r|=g>c.default.RASTER_REPROJECTION_MAX_TRIANGLE_WIDTH)}if(r||!this.maxSourceExtent_||b.default.intersects(f,this.maxSourceExtent_)){if(!(r||isFinite(m[0])&&isFinite(m[1])&&isFinite(p[0])&&isFinite(p[1])&&isFinite(n[0])&&isFinite(n[1])&&isFinite(t[0])&&isFinite(t[1])))if(0<u)r=!0;else return;if(0<u&&(r||(f=this.transformInv_([(a[0]+e[0])/2,(a[1]+e[1])/2]),
l=q?(h.default.modulo(m[0],l)+h.default.modulo(n[0],l))/2-h.default.modulo(f[0],l):(m[0]+n[0])/2-f[0],f=(m[1]+n[1])/2-f[1],r=l*l+f*f>this.errorThresholdSquared_),r)){Math.abs(a[0]-e[0])<=Math.abs(a[1]-e[1])?(q=[(d[0]+e[0])/2,(d[1]+e[1])/2],l=this.transformInv_(q),f=[(k[0]+a[0])/2,(k[1]+a[1])/2],g=this.transformInv_(f),this.addQuad_(a,d,q,f,m,p,l,g,u-1),this.addQuad_(f,q,e,k,g,l,n,t,u-1)):(q=[(a[0]+d[0])/2,(a[1]+d[1])/2],l=this.transformInv_(q),f=[(e[0]+k[0])/2,(e[1]+k[1])/2],g=this.transformInv_(f),
this.addQuad_(a,q,f,k,m,l,g,t,u-1),this.addQuad_(q,d,e,f,l,p,n,g,u-1));return}if(q){if(!this.canWrapXInSource_)return;this.wrapsXInSource_=!0}this.addTriangle_(a,e,k,m,n,t);this.addTriangle_(a,d,e,m,p,n)}};a.prototype.calculateSourceExtent=function(){var a=b.default.createEmpty();this.triangles_.forEach(function(c,d,e){c=c.source;b.default.extendCoordinate(a,c[0]);b.default.extendCoordinate(a,c[1]);b.default.extendCoordinate(a,c[2])});return a};a.prototype.getTriangles=function(){return this.triangles_};
